function event_say(e)
	...
	if(e.message:findi("hail")) then
		--e.other:Message(15,"Hello my friend, you need some [plat]?");
		e.other:Message(15,"Do you need a [hpbuff] / [manabuff] or [SoW]?");
	...
	elseif(e.message:findi("tradeskills") and e.other:Admin() > 79) then
	...
	elseif(e.message:findi("help") and e.other:Admin() > 79) then
	...
	--RESEARCH
	elseif(e.message:findi("Research") and e.other:Admin() > 79) then
	...
	--22
	elseif(e.message:findi("RS22") and e.other:Admin() > 79) then
		if(e.message:findi("RS22 all") and e.other:Admin() > 79) then
		...
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS22 all") and e.other:Admin() > 79) then --Necro
			e.other:SummonItem(16024,20); --necro   21   Words of Derivation
			e.other:SummonItem(11810,20); --necro   21   Words of Eradication
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS22 all") and e.other:Admin() > 79) then --Wiz
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS22 all") and e.other:Admin() > 79) then --Mage
			e.other:SummonItem(11786,20); --mage   22   Words of the Element
			e.other:SummonItem(11787,20); --mage   22   Words of Tyranny
			e.other:SummonItem(11788,20); --mage   22   Words of Dominion			****NOTE there is a duplicate of this in DB 11828
			e.other:SummonItem(15401,20); --mage   22   Elemental: Earth			****NOTE there is a duplicate of this in DB 16119
			...
			e.other:SummonItem(16584,20); --mage   22   Halas Heater
			e.other:SummonItem(13075,20); --mage   22   Shark Skin					****NOTE there is a duplicate of this in DB 13875
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS22 all") and e.other:Admin() > 79) then --Chanter
			e.other:SummonItem(16068,20); --enchanter   22   Part of Tasarin's Grimoire Pg. 23 (Left)
			e.other:SummonItem(16070,20); --enchanter   22   Part of Tasarin's Grimoire Pg. 24 (Left)
			e.other:SummonItem(16072,20); --enchanter   22   Part of Tasarin's Grimoire Pg. 26 (Left)
			e.other:SummonItem(16069,20); --enchanter   22   Part of Tasarin's Grimoire Pg. 23 (Right)
	...
	--26
	elseif(e.message:findi("RS26") and e.other:Admin() > 79) then
		if(e.message:findi("RS26 all") and e.other:Admin() > 79) then
		...
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS26 all") and e.other:Admin() > 79) then --Necro
			e.other:SummonItem(11817,20); --necro   26   Words of Reviviscence
			e.other:SummonItem(11815,20); --necro   26   Words of Possession
			e.other:SummonItem(11813,20); --necro   26   Words of Materials
			e.other:SummonItem(11811,20); --necro   26   Words of Imitation
			...
			e.other:SummonItem(11814,20); --necro   26   Words of Spirit
			e.other:SummonItem(11843,20); --necro   26   Words of Resolve			****NOTE was given to me as Words of Resolution but doesn't exist here or on PeQ
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS26 all") and e.other:Admin() > 79) then --Wiz
			e.other:SummonItem(11738,20); --wizard   26   Rune of Falhalem
			e.other:SummonItem(16054,20); --wizard   26   Rune of Nagafen
			e.other:SummonItem(11741,20); --wizard   26   Rune of Fulguration		****NOTE there is a duplicate of this in DB 11759
			e.other:SummonItem(11739,20); --wizard   26   Rune of Substance
			e.other:SummonItem(11742,20); --wizard   26   Rune of Proximity			****NOTE there is a duplicate of this in DB 16050
			e.other:SummonItem(11740,20); --wizard   26   Rune of Periphery
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS26 all") and e.other:Admin() > 79) then --Mage
			e.other:Message(13,"Mage".. noMatch);
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS26 all") and e.other:Admin() > 79) then --Chanter
			e.other:Message(13,"Chanter".. noMatch);
		end

	--41
	elseif(e.message:findi("RS41") and e.other:Admin() > 79) then
		if(e.message:findi("RS41 all") and e.other:Admin() > 79) then
		...
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS41 all") and e.other:Admin() > 79) then --Necro
			e.other:SummonItem(11819,20); --necro   41   Words of Refuge
			e.other:SummonItem(11821,20); --necro   41   Words of Enlightenment
			e.other:SummonItem(11811,20); --necro   41   Words of Imitation
			e.other:SummonItem(11825,20); --necro   41   Words of the Extinct
			...
			e.other:SummonItem(11826,20); --necro   41   Words of the Quickening
			e.other:SummonItem(11824,20); --necro   41   Words of Radiance
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS41 all") and e.other:Admin() > 79) then --Wiz
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS41 all") and e.other:Admin() > 79) then --Mage
			e.other:Message(13,"Mage".. noMatch);
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS41 all") and e.other:Admin() > 79) then --Chanter
			e.other:Message(13,"Chanter".. noMatch);
		end

	--42
	elseif(e.message:findi("RS42") and e.other:Admin() > 79) then
		if(e.message:findi("RS42 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS42 all") and e.other:Admin() > 79) then --Necro
			e.other:Message(13,"Necro".. noMatch);
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS42 all") and e.other:Admin() > 79) then --Wiz
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS42 all") and e.other:Admin() > 79) then --Mage
			e.other:SummonItem(11788,20); --mage   42   Words of Dominion			****NOTE there is a duplicate of this in DB 11828
			e.other:SummonItem(15396,20); --mage   42   Minor Summoning: Air		****NOTE there is a duplicate of this in DB 16128
			e.other:SummonItem(15335,20); --mage   42   Minor Summoning: Earth		****NOTE there is a duplicate of this in DB 16125
			e.other:SummonItem(15395,20); --mage   42   Minor Summoning: Fire		****NOTE there is a duplicate of this in DB 16127
			...
			e.other:SummonItem(11790,20); --mage   42   Jade Shard
			e.other:SummonItem(11789,20); --mage   42   Ice of Velious
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS42 all") and e.other:Admin() > 79) then --Chanter
			e.other:SummonItem(16074,20); --enchanter   42   Part of Tasarin's Grimoire Pg. 30 (Left)
			e.other:SummonItem(16075,20); --enchanter   42   Part of Tasarin's Grimoire Pg. 30 (Right)
			e.other:SummonItem(16078,20); --enchanter   42   Part of Tasarin's Grimoire Pg. 375 (Right)
			e.other:SummonItem(16079,20); --enchanter   42   Part of Tasarin's Grimoire Pg. 375 (Left)
	...
	--46
	elseif(e.message:findi("RS46") and e.other:Admin() > 79) then
		if(e.message:findi("RS46 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Mage".. noMatch);
			e.other:Message(13,"Chanter".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS46 all") and e.other:Admin() > 79) then --Necro
			e.other:Message(13,"Necro".. noMatch);
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS46 all") and e.other:Admin() > 79) then --Wiz
			e.other:SummonItem(11746,20); --wizard   46   Rune of Al'Kabor
			e.other:SummonItem(11743,20); --wizard   46   Rune of Neglect
			e.other:SummonItem(11745,20); --wizard   46   Rune of Velious
			e.other:SummonItem(11744,20); --wizard   46   Rune of Oppression
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS46 all") and e.other:Admin() > 79) then --Mage
			e.other:Message(13,"Mage".. noMatch);
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS46 all") and e.other:Admin() > 79) then --Chanter
			e.other:Message(13,"Chanter".. noMatch);
		end

	--62
	elseif(e.message:findi("RS62") and e.other:Admin() > 79) then
		if(e.message:findi("RS62 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS62 all") and e.other:Admin() > 79) then --Necro
			e.other:SummonItem(11823,20); --necro   62   Words of Discernment
			e.other:SummonItem(11831,20); --necro   62   Words of the Sentient (Beza)
			e.other:SummonItem(11833,20); --necro   62   Words of Cloudburst
			e.other:SummonItem(11815,20); --necro   62   Words of Possession
			...
			e.other:SummonItem(16039,20); --necro   62   Words of Cazic-Thule
			e.other:SummonItem(11829,20); --necro   62   Words of Allure
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS62 all") and e.other:Admin() > 79) then --Wiz
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS62 all") and e.other:Admin() > 79) then --Mage
			e.other:SummonItem(11792,20); --mage   62   Words of Transcendence
			e.other:SummonItem(11871,20); --mage   62   Words of Dimension
			e.other:SummonItem(11794,20); --mage   62   Words of Coercion
			e.other:SummonItem(15050,20); --mage   62   Summon Food					****NOTE there is a duplicate of this in DB 16100
			...
			e.other:SummonItem(11790,20); --mage   62   Jade Shard
			e.other:SummonItem(11789,20); --mage   62   Ice of Velious
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS62 all") and e.other:Admin() > 79) then --Chanter
			e.other:SummonItem(16081,20); --enchanter   62   Part of Tasarin's Grimoire Pg. 390 (Left)
			e.other:SummonItem(16080,20); --enchanter   62   Part of Tasarin's Grimoire Pg. 390 (Right)
			e.other:SummonItem(16082,20); --enchanter   62   Velishoul's Tome Pg. 8
			e.other:SummonItem(16085,20); --enchanter   62   Velishoul's Tome Pg. 16 (Faded)
	...
	--71
	elseif(e.message:findi("RS71") and e.other:Admin() > 79) then
		if(e.message:findi("RS71 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Mage".. noMatch);
			e.other:Message(13,"Chanter".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS71 all") and e.other:Admin() > 79) then --Necro
			e.other:Message(13,"Necro".. noMatch);
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS71 all") and e.other:Admin() > 79) then --Wiz
			e.other:SummonItem(11747,20); --wizard   71   Rune of Expulsion
			e.other:SummonItem(11751,20); --wizard   71   Rune of Trauma
			e.other:SummonItem(11750,20); --wizard   71   Rune of Disassociation
			e.other:SummonItem(11753,20); --wizard   71   Rune of Karana			****NOTE there is a duplicate of this in DB 16058
			...
			e.other:SummonItem(11752,20); --wizard   71   Rune of Xegony
			e.other:SummonItem(11749,20); --wizard   71   Rune of Presence
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS71 all") and e.other:Admin() > 79) then --Mage
			e.other:Message(13,"Mage".. noMatch);
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS71 all") and e.other:Admin() > 79) then --Chanter
			e.other:Message(13,"Chanter".. noMatch);
		end

	--82
	elseif(e.message:findi("RS82") and e.other:Admin() > 79) then
		if(e.message:findi("RS82 all") and e.other:Admin() > 79) then
			e.other:Message(13,"Necro".. noMatch);
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS82 all") and e.other:Admin() > 79) then --Necro
			e.other:Message(13,"Necro".. noMatch);
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS82 all") and e.other:Admin() > 79) then --Wiz
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS82 all") and e.other:Admin() > 79) then --Mage
		...
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS82 all") and e.other:Admin() > 79) then --Chanter
	...
	--83
	elseif(e.message:findi("RS83") and e.other:Admin() > 79) then
		if(e.message:findi("RS83 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Mage".. noMatch);
			e.other:Message(13,"Chanter".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS83 all") and e.other:Admin() > 79) then --Necro
			e.other:SummonItem(11838,20); --necro   83   Words of Purification
			e.other:SummonItem(11815,20); --necro   83   Words of Possession
			e.other:SummonItem(11839,20); --necro   83   Words of the Incorporeal
			e.other:SummonItem(11841,20); --necro   83   Words of Dissemination
			e.other:SummonItem(11840,20); --necro   83   Words of Acquisition (Azia)
			e.other:SummonItem(11842,20); --necro   83   Words of Parasitism
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS83 all") and e.other:Admin() > 79) then --Wiz
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS83 all") and e.other:Admin() > 79) then --Mage
			e.other:Message(13,"Mage".. noMatch);
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS83 all") and e.other:Admin() > 79) then --Chanter
			e.other:Message(13,"Chanter".. noMatch);
		end

	--87
	elseif(e.message:findi("RS87") and e.other:Admin() > 79) then
		if(e.message:findi("RS87 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Mage".. noMatch);
			e.other:Message(13,"Chanter".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS87 all") and e.other:Admin() > 79) then --Necro
			e.other:SummonItem(11815,20); --necro   87   Words of Possession
			e.other:SummonItem(11836,20); --necro   87   Words of Haunting
			e.other:SummonItem(11837,20); --necro   87   Words of Rupturing
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS87 all") and e.other:Admin() > 79) then --Wiz
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS87 all") and e.other:Admin() > 79) then --Mage
			e.other:Message(13,"Mage".. noMatch);
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS87 all") and e.other:Admin() > 79) then --Chanter
			e.other:Message(13,"Chanter".. noMatch);
		end

	--96
	elseif(e.message:findi("RS96") and e.other:Admin() > 79) then
		if(e.message:findi("RS96 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Mage".. noMatch);
			e.other:Message(13,"Chanter".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS96 all") and e.other:Admin() > 79) then --Necro
			e.other:Message(13,"Necro".. noMatch);
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS96 all") and e.other:Admin() > 79) then --Wiz
			e.other:SummonItem(11746,20); --wizard   96   Rune of Al'Kabor
			e.other:SummonItem(11762,20); --wizard   96   Rune of Arrest
			e.other:SummonItem(11753,20); --wizard   96   Rune of Karana			****NOTE there is a duplicate of this in DB 16058
			e.other:SummonItem(11754,20); --wizard   96   Rune of The Combine
			...
			e.other:SummonItem(11741,20); --wizard   96   Rune of Fulguration		****NOTE there is a duplicate of this in DB 11759
			e.other:SummonItem(11756,20); --wizard   96   Rune of Regeneration
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS96 all") and e.other:Admin() > 79) then --Mage
			e.other:Message(13,"Mage".. noMatch);
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS96 all") and e.other:Admin() > 79) then --Chanter
			e.other:Message(13,"Chanter".. noMatch);
		end

	--102
	elseif(e.message:findi("RS102") and e.other:Admin() > 79) then
		if(e.message:findi("RS102 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Wizard".. noMatch);
			e.other:Message(13,"Chanter".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS102 all") and e.other:Admin() > 79) then --Necro
			e.other:Message(13,"Necro".. noMatch);
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS102 all") and e.other:Admin() > 79) then --Wiz
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS102 all") and e.other:Admin() > 79) then --Mage
			e.other:SummonItem(11798,20); --mage   102   Words of Detention
			e.other:SummonItem(11799,20); --mage   102   Words of Duress
			e.other:SummonItem(15048,20); --mage   102   Cancel Magic				****NOTE there is duplicates of this in DB 16118, 16207, 16313, 16415
			e.other:SummonItem(15576,20); --mage   102   Greater Summoning: Air
			...
			e.other:SummonItem(11802,20); --mage   102   The Scent of Marr
			e.other:SummonItem(11801,20); --mage   102   Breath of Solusek
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS102 all") and e.other:Admin() > 79) then --Chanter
			e.other:Message(13,"Chanter".. noMatch);
		end

	--116
	elseif(e.message:findi("RS116") and e.other:Admin() > 79) then
		if(e.message:findi("RS116 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Mage".. noMatch);
			e.other:Message(13,"Chanter".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS116 all") and e.other:Admin() > 79) then --Necro
			e.other:SummonItem(11850,20); --necro   116   Words of Dark Paths
			e.other:SummonItem(11836,20); --necro   116   Words of Haunting
			e.other:SummonItem(11851,20); --necro   116   Words of the Suffering
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS116 all") and e.other:Admin() > 79) then --Wiz
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS116 all") and e.other:Admin() > 79) then --Mage
			e.other:Message(13,"Mage".. noMatch);
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS116 all") and e.other:Admin() > 79) then --Chanter
			e.other:Message(13,"Chanter".. noMatch);
		end

	--120
	elseif(e.message:findi("RS120") and e.other:Admin() > 79) then
		if(e.message:findi("RS120 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Mage".. noMatch);
			e.other:Message(13,"Chanter".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS120 all") and e.other:Admin() > 79) then --Necro
			e.other:SummonItem(11845,20); --necro   120   Words of Duration
			e.other:SummonItem(11846,20); --necro   120   Words of Motion
			e.other:SummonItem(11844,20); --necro   120   Words of Quivering
			e.other:SummonItem(11847,20); --necro   120   Words of Neglect
			e.other:SummonItem(11843,20); --necro   120   Words of Resolve
			e.other:SummonItem(11848,20); --necro   120   Words of Endurance
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS120 all") and e.other:Admin() > 79) then --Wiz
			e.other:SummonItem(11764,20); --wizard   120   Rune of Banding
			e.other:SummonItem(11774,20); --wizard   120   Rune of Conception
			e.other:SummonItem(11763,20); --wizard   120   Rune of Concussion
			e.other:SummonItem(11765,20); --wizard   120   Rune of the Catalyst
			...
			e.other:SummonItem(11768,20); --wizard   120   Rune of Howling
			e.other:SummonItem(11766,20); --wizard   120   Rune of Solusek Ro
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS120 all") and e.other:Admin() > 79) then --Mage
			e.other:Message(13,"Mage".. noMatch);
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS120 all") and e.other:Admin() > 79) then --Chanter
			e.other:Message(13,"Chanter".. noMatch);
		end

	--122
	elseif(e.message:findi("RS122") and e.other:Admin() > 79) then
		if(e.message:findi("RS122 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS122 all") and e.other:Admin() > 79) then --Necro
			e.other:SummonItem(16037,20); --necro   122   Words of Abatement
			e.other:SummonItem(16039,20); --necro   122   Words of Cazic-Thule
			e.other:SummonItem(11849,20); --necro   122   Words of Efficacy
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS122 all") and e.other:Admin() > 79) then --Wiz
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS122 all") and e.other:Admin() > 79) then --Mage
			e.other:SummonItem(11803,20); --mage   122   Words of Collection (Azia)
			e.other:SummonItem(11872,20); --mage   122   Words of Convocation
			e.other:SummonItem(7001,20); --mage   122   Dagger
			e.other:SummonItem(10021,20); --mage   122   Star Rose Quartz
			...
			e.other:SummonItem(11796,20); --mage   122   Glove of Rallos Zek
			e.other:SummonItem(11797,20); --mage   122   Flame of Vox
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS122 all") and e.other:Admin() > 79) then --Chanter
			e.other:SummonItem(11704,20); --enchanter   122   Salil's Writ Pg. 60 (Left)
			e.other:SummonItem(11882,20); --enchanter   122   Salil's Writ Pg. 60 (Right)
			e.other:SummonItem(11705,20); --enchanter   122   Salil's Writ Pg. 64 (Left) (Faded)
			e.other:SummonItem(11707,20); --enchanter   122   Salil's Writ Pg. 64 (Right)
	...
	--140
	elseif(e.message:findi("RS140") and e.other:Admin() > 79) then
		if(e.message:findi("RS140 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Mage".. noMatch);
			e.other:Message(13,"Chanter".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS140 all") and e.other:Admin() > 79) then --Necro
			e.other:SummonItem(11852,20); --necro   140   Words of Descrying
			e.other:SummonItem(11855,20); --necro   140   Words of Projection
			e.other:SummonItem(11857,20); --necro   140   Words of Bidding
			e.other:SummonItem(11853,20); --necro   140   Words of Seizure
			...
			e.other:SummonItem(11856,20); --necro   140   Words of the Spectre
			e.other:SummonItem(11858,20); --necro   140   Words of Collection (Beza)
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS140 all") and e.other:Admin() > 79) then --Wiz
			e.other:SummonItem(11746,20); --wizard   140   Rune of Al'Kabor
			e.other:SummonItem(11754,20); --wizard   140   Rune of The Combine
			e.other:SummonItem(11772,20); --wizard   140   Rune of Paralysis
			e.other:SummonItem(11758,20); --wizard   140   Rune of The Helix
			...
			e.other:SummonItem(11773,20); --wizard   140   Rune of Embrace
			e.other:SummonItem(11771,20); --wizard   140   Rune of Tyranny
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS140 all") and e.other:Admin() > 79) then --Mage
			e.other:Message(13,"Mage".. noMatch);
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS140 all") and e.other:Admin() > 79) then --Chanter
			e.other:Message(13,"Chanter".. noMatch);
		end

	--142
	elseif(e.message:findi("RS142") and e.other:Admin() > 79) then
		if(e.message:findi("RS142 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Necro".. noMatch);
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS142 all") and e.other:Admin() > 79) then --Necro
			e.other:Message(13,"Necro".. noMatch);
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS142 all") and e.other:Admin() > 79) then --Wiz
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS142 all") and e.other:Admin() > 79) then --Mage
			e.other:SummonItem(11804,20); --mage   142   Words of Incarceration
			e.other:SummonItem(15627,20); --mage   142   Lesser Conjuration: Air
			e.other:SummonItem(15624,20); --mage   142   Lesser Conjuration: Earth
			e.other:SummonItem(15625,20); --mage   142   Lesser Conjuration: Water
			...
			e.other:SummonItem(11805,20); --mage   142   Essence of Rathe
			e.other:SummonItem(11806,20); --mage   142   Tears of Prexus
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS142 all") and e.other:Admin() > 79) then --Chanter
			e.other:SummonItem(11714); --enchanter   142   Salil's Writ Pg. 174 (Left)
			e.other:SummonItem(11715); --enchanter   142   Salil's Writ Pg. 174 (Right)
			e.other:SummonItem(11718); --enchanter   142   Salil's Writ Pg. 288 (Left)
			e.other:SummonItem(11719); --enchanter   142   Salil's Writ Pg. 288 (Right) (Faded)
	...
	--162
	elseif(e.message:findi("RS162") and e.other:Admin() > 79) then
		if(e.message:findi("RS162 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Wizard".. noMatch);
			e.other:Message(13,"Mage".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS162 all") and e.other:Admin() > 79) then --Necro
			e.other:Message(13,"Necro".. noMatch);
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS162 all") and e.other:Admin() > 79) then --Wiz
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS162 all") and e.other:Admin() > 79) then --Mage
			e.other:Message(13,"Mage".. noMatch);
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS162 all") and e.other:Admin() > 79) then --Chanter
			e.other:SummonItem(11724,20); --enchanter   162   Nilitim's Grimoire Pg. 115
			e.other:SummonItem(11726,20); --enchanter   162   Nilitim's Grimoire Pg. 300
			e.other:SummonItem(11722,20); --enchanter   162   Nilitim's Grimoire Pg. 35
			e.other:SummonItem(11728,20); --enchanter   162   Nilitim's Grimoire Pg. 351
	...
	--166
	elseif(e.message:findi("RS166") and e.other:Admin() > 79) then
		if(e.message:findi("RS166 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Mage".. noMatch);
			e.other:Message(13,"Chanter".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS166 all") and e.other:Admin() > 79) then --Necro
			e.other:SummonItem(11861,20); --necro   166   Words of the Psyche
			e.other:SummonItem(11863,20); --necro   166   Words of Obligation
			e.other:SummonItem(11862,20); --necro   166   Words of Burnishing
			e.other:SummonItem(11864,20); --necro   166   Words of Collection (Caza)
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS166 all") and e.other:Admin() > 79) then --Wiz
			e.other:SummonItem(11748,20); --wizard   166   Rune of Attraction			****NOTE there is a duplicate of this in DB 11777
			e.other:SummonItem(11778,20); --wizard   166   Rune of The Inverse
			e.other:SummonItem(11776,20); --wizard   166   Rune of Rathe
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS166 all") and e.other:Admin() > 79) then --Mage
			e.other:Message(13,"Mage".. noMatch);
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS166 all") and e.other:Admin() > 79) then --Chanter
			e.other:Message(13,"Chanter".. noMatch);
		end

	--182
	elseif(e.message:findi("RS182") and e.other:Admin() > 79) then
		if(e.message:findi("RS182 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Wizard".. noMatch);
			e.other:Message(13,"Chanter".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS182 all") and e.other:Admin() > 79) then --Necro
			e.other:Message(13,"Necro".. noMatch);
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS182 all") and e.other:Admin() > 79) then --Wiz
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS182 all") and e.other:Admin() > 79) then --Mage
			e.other:SummonItem(11807,20); --mage   182   Words of Bondage
			e.other:SummonItem(15631,20); --mage   182   Conjuration: Air
			e.other:SummonItem(15630,20); --mage   182   Conjuration: Fire
			e.other:SummonItem(15629,20); --mage   182   Conjuration: Water
			...
			e.other:SummonItem(11808,20); --mage   182   Breath of Ro
			e.other:SummonItem(11806,20); --mage   182   Tears of Prexus
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS182 all") and e.other:Admin() > 79) then --Chanter
			e.other:Message(13,"Chanter".. noMatch);
		end

	--184
	elseif(e.message:findi("RS184") and e.other:Admin() > 79) then
		if(e.message:findi("RS184 all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Mage".. noMatch);
			e.other:Message(13,"Chanter".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS184 all") and e.other:Admin() > 79) then --Necro
			e.other:SummonItem(11865,20); --necro   184   Words of Requisition
			e.other:SummonItem(11869,20); --necro   184   Words of the Ethereal
			e.other:SummonItem(11870,20); --necro   184   Words of Crippling Force
			e.other:SummonItem(11867,20); --necro   184   Words of Grappling
			e.other:SummonItem(11866,20); --necro   184   Words of Acquisition (Beza)
			e.other:SummonItem(11868,20); --necro   184   Words of Odus
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS184 all") and e.other:Admin() > 79) then --Wiz
			e.other:SummonItem(11779,20); --wizard   184   Rune of Ap'Sagor
			e.other:SummonItem(11781,20); --wizard   184   Rune of the Astral			****NOTE there is a duplicate of this in DB 11881
			e.other:SummonItem(11783,20); --wizard   184   Rune of Crippling
			e.other:SummonItem(11763,20); --wizard   184   Rune of Concussion
			...
			e.other:SummonItem(11782,20); --wizard   184   Rune of Impetus
			e.other:SummonItem(11776,20); --wizard   184   Rune of Rathe
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS184 all") and e.other:Admin() > 79) then --Mage
			e.other:Message(13,"Mage".. noMatch);
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS184 all") and e.other:Admin() > 79) then --Chanter
			e.other:Message(13,"Chanter".. noMatch);
		end

	--no fail
	elseif(e.message:findi("RS no fail") and e.other:Admin() > 79) then
		if(e.message:findi("RS no fail all") and e.other:Admin() > 79) then
			...
			e.other:Message(13,"Wizard".. noMatch);
			e.other:Message(13,"Mage".. noMatch);
		elseif(e.other:Class() == "Necromancer" and not e.message:findi("RS no fail") and e.other:Admin() > 79) then --Necro
			e.other:Message(13,"Necro".. noMatch);
		elseif(e.other:Class() == "Wizard" and not e.message:findi("RS no fail") and e.other:Admin() > 79) then --Wiz
			e.other:Message(13,"Wizard".. noMatch);
		elseif(e.other:Class() == "Magician" and not e.message:findi("RS no fail") and e.other:Admin() > 79) then --Mage
			e.other:Message(13,"Mage".. noMatch);
		elseif(e.other:Class() == "Enchanter" and not e.message:findi("RS no fail") and e.other:Admin() > 79) then --Chanter
			e.other:SummonItem(11736,20); --enchanter   ?   Nilitim's Grimoire Pg. 449
			e.other:SummonItem(11730,20); --enchanter   ?   Nilitim's Grimoire Pg. 378
			e.other:SummonItem(11732,20); --enchanter   ?   Nilitim's Grimoire Pg. 400
			e.other:SummonItem(11734,20); --enchanter   ?   Nilitim's Grimoire Pg. 415
	...
	--ALCHEMY
	elseif(e.message:findi("Alchemy") and e.other:Admin() > 79) then
		e.other:Message(13,notready);
		e.other:Message(15,"What skill range max? [AL31] [AL52] [AL79] [AL106] [AL142]");
		e.other:Message(15,warningRoom);
	--elseif(e.message:findi("AL")) then
		if(e.message:findi("AL31") and e.other:Admin() > 79) then --31 - Distillate of Skinspikes I
		...
		if(e.message:findi("AL52") and e.other:Admin() > 79) then --52 - Distillate of Skinspikes II
		...
		if(e.message:findi("AL79") and e.other:Admin() > 79) then --79 - Distillate of Skinspikes III
		...
		if(e.message:findi("AL106") and e.other:Admin() > 79) then --106 - Distillate of Skinspikes IV
		...
		if(e.message:findi("AL142") and e.other:Admin() > 79) then --142 - Distillate of Skinspikes V
	...
	--BAKING
	elseif(e.message:findi("Baking") and e.other:Admin() > 79) then
		e.other:Message(15,"What skill range max? [BK17] [BK75] [BK83] [BK135] [BK143] [BK152] [BK226]");
		e.other:Message(15,warningRoom);
	elseif(e.message:findi("BK") and e.other:Admin() > 79) then
		if(e.message:findi("BK17") and e.other:Admin() > 79) then --17 - Clump of Dough
		...
		if(e.message:findi("BK75") and e.other:Admin() > 79) then --75 - Creamy Fennel Sauce
			e.other:SummonItem(9726,20); --Cream
			e.other:SummonItem(13193,20); --Cup of Flour								****NOTE there is a duplicate of this in DB 13089
			e.other:SummonItem(14234,20); --Fennel
		end
		if(e.message:findi("BK83") and e.other:Admin() > 79) then --83 - Cream
			e.other:SummonItem(14221,20); --Benzoin
			e.other:SummonItem(13087,20); --Bottle of Milk
		end
		if(e.message:findi("BK135") and e.other:Admin() > 79) then --135 - Fish Rolls
			e.other:SummonItem(13062,20); --Bat Wing
			e.other:SummonItem(13019,20); --Fresh Fish
		end
		if(e.message:findi("BK143") and e.other:Admin() > 79) then --143 - Filleted Bear
			e.other:SummonItem(13404,20); --Bear Meat
		end
		if(e.message:findi("BK152") and e.other:Admin() > 79) then --152 - Bear Filet in Cream
			e.other:SummonItem(9744,20); --Filleted Bear
			e.other:SummonItem(9743,20); --Creamy Fennel Sauce
		end
		if(e.message:findi("BK226") and e.other:Admin() > 79) then --226 - Halas 10 pound meat pie
	...
	--BREWING
	elseif(e.message:findi("Brewing") and e.other:Admin() > 79) then
		e.other:Message(15,"What skill range max? [BR31] [BR62] [BR95] [BR122] [BR151] [BR162] [BR226] [BR248]");
		e.other:Message(15,warningRoom);
	elseif(e.message:findi("BR") and e.other:Admin() > 79) then
		if(e.message:findi("BR31") and e.other:Admin() > 79) then --31 - Short Beer
		...
		if(e.message:findi("BR62") and e.other:Admin() > 79) then --62 - Fish Wine
			e.other:SummonItem(16598,20); --Bottle
			e.other:SummonItem(13019,20); --Fresh Fish
			e.other:SummonItem(16592,20); --Grapes
			e.other:SummonItem(13006,20); --Water Flask
		end
		if(e.message:findi("BR95") and e.other:Admin() > 79) then --95 - Red Wine
			e.other:SummonItem(13045,20); --Berries
			e.other:SummonItem(16598,20); --Bottle
			e.other:SummonItem(16592,20); --Grapes
			e.other:SummonItem(16597,20); --Wine Yeast
		end
		if(e.message:findi("BR122") and e.other:Admin() > 79) then --122 - Fetid Essence
			e.other:SummonItem(13106,20); --Fishing Grubs
			e.other:SummonItem(13006,20); --Water Flask
		end
		if(e.message:findi("BR151") and e.other:Admin() > 79) then --151 - Skull Ale
		...
		if(e.message:findi("BR162") and e.other:Admin() > 79) then --162 - Jumjum Spiced Beer
			e.other:SummonItem(16590,20); --Barley
			e.other:SummonItem(16598,20); --Bottle
			e.other:SummonItem(16591,20); --Hops
			e.other:SummonItem(13425,20); --Spices
		...
		if(e.message:findi("BR226") and e.other:Admin() > 79) then --226 - Qeynos Afternoon Tea
		...
		if(e.message:findi("BR248") and e.other:Admin() > 79) then --248 - Minotaur Hero's Brew
			e.other:SummonItem(16580,20); --Cask
			e.other:SummonItem(16595,20); --Malt
			e.other:SummonItem(13032,20); --Short Beer
			e.other:SummonItem(13006,20); --Water Flask
	...
	--FISHING
	elseif(e.message:findi("Fishing") and e.other:Admin() > 79) then
		e.other:Message(13,notready);

	--FLETCHING
	elseif(e.message:findi("Fletching") and e.other:Admin() > 79) then
		e.other:Message(15,"What skill range max? [FL46] [FL56] [FL68] [FL102] [FL135] [FL182] [FL202]");
		e.other:Message(15,warningRoom);
	elseif(e.message:findi("FL") and e.other:Admin() > 79) then
		if(e.message:findi("FL46") and e.other:Admin() > 79) then --46 - CLASS 2 Wood Point Arrow (large nock)
		...
		if(e.message:findi("FL56") and e.other:Admin() > 79) then --56 - CLASS 2 Wood Point Arrow (small nock)
			e.other:SummonItem(8060,20); --Bundled Wooden Arrow Shafts
			e.other:SummonItem(8055,20); --Field Point Arrowhead
			e.other:SummonItem(8052,20); --Small Groove Nocks
			e.other:SummonItem(8065,20); --Several Parabolic Cut Fletchings
		end
		if(e.message:findi("FL68") and e.other:Admin() > 79) then --68 - CLASS 2 Bone Point Arrow (small nock)
			e.other:SummonItem(8061,20); --Bundled Bone Arrow Shafts
			e.other:SummonItem(8055,20); --Field Point Arrowhead
			e.other:SummonItem(8052,20); --Small Groove Nocks
			e.other:SummonItem(8065,20); --Several Parabolic Cut Fletchings
		end
		if(e.message:findi("FL102") and e.other:Admin() > 79) then --102 - CLASS 2 Bone Hooked Arrow (small nock)
			e.other:SummonItem(8061,20); --Bundled Bone Arrow Shafts
			e.other:SummonItem(8056,20); --Hooked Arrowhead
			e.other:SummonItem(8052,20); --Small Groove Nocks
			e.other:SummonItem(8065,20); --Several Parabolic Cut Fletchings
		end
		if(e.message:findi("FL135") and e.other:Admin() > 79) then --135 - CLASS 2 Ceramic Hooked Arrow (small nock)
			e.other:SummonItem(8062,20); --Bundled Ceramic Arrow Shafts
			e.other:SummonItem(8056,20); --Hooked Arrowhead
			e.other:SummonItem(8052,20); --Small Groove Nocks
			e.other:SummonItem(8065,20); --Several Parabolic Cut Fletchings
		end
		if(e.message:findi("FL182") and e.other:Admin() > 79) then --182 - CLASS 2 Wood Silver Tip Arrow (small nock)
			e.other:SummonItem(8060,20); --Bundled Wooden Arrow Shafts
			e.other:SummonItem(8057,20); --Silver Tipped Arrowheads
			e.other:SummonItem(8052,20); --Small Groove Nocks
			e.other:SummonItem(8065,20); --Several Parabolic Cut Fletchings
		end
		if(e.message:findi("FL202") and e.other:Admin() > 79) then --202 - CLASS 2 Steel Silver Tip Arrow (small nock)
	...
	--JEWELCRAFT
	elseif(e.message:findi("Jewelcraft") and e.other:Admin() > 79) then
		...
		e.other:Message(15,warningRoom);
	elseif(e.message:findi("JC") and e.other:Admin() > 79) then
		if(e.message:findi("JC17") and e.other:Admin() > 79) then --
			e.other:SummonItem(16500,20); --silver bar 17 to 63
			e.other:SummonItem(10015,20); --Malachite
		end
		if(e.message:findi("JC30") and e.other:Admin() > 79) then --
			e.other:SummonItem(16500,20); --silver bar 17 to 63
			e.other:SummonItem(10020,20); --Jasper
		end
		if(e.message:findi("JC40") and e.other:Admin() > 79) then --
			e.other:SummonItem(16500,20); --silver bar 17 to 63
			e.other:SummonItem(10023,20); --Jade
		end
		if(e.message:findi("JC50") and e.other:Admin() > 79) then --
			e.other:SummonItem(16500,20); --silver bar 17 to 63
			e.other:SummonItem(10030,20); --Opal
		end
		if(e.message:findi("JC60") and e.other:Admin() > 79) then --
			e.other:SummonItem(16500,20); --silver bar 17 to 63
			e.other:SummonItem(10034,20); --Sapphire
		end
		if(e.message:findi("JC74") and e.other:Admin() > 79) then --
			e.other:SummonItem(16501,20); --electrum bar 74 to 135
			e.other:SummonItem(10015,20); --Malachite
		end
		if(e.message:findi("JC92") and e.other:Admin() > 79) then --
			e.other:SummonItem(16501,20); --electrum bar 74 to 135
			e.other:SummonItem(10020,20); --Jasper
		end
		if(e.message:findi("JC106") and e.other:Admin() > 79) then --
			e.other:SummonItem(16501,20); --electrum bar 74 to 135
			e.other:SummonItem(10023,20); --Jade
		end
		if(e.message:findi("JC119") and e.other:Admin() > 79) then --
			e.other:SummonItem(16501,20); --electrum bar 74 to 135
			e.other:SummonItem(10030,20); --Opal
		end
		if(e.message:findi("JC132") and e.other:Admin() > 79) then --
			e.other:SummonItem(16501,20); --electrum bar 74 to 135
			e.other:SummonItem(10034,20); --Sapphire
		end
		if(e.message:findi("JC146") and e.other:Admin() > 79) then --
			e.other:SummonItem(16502,20); --gold bar 146 to 207
			e.other:SummonItem(10015,20); --Malachite
		end
		if(e.message:findi("JC164") and e.other:Admin() > 79) then --
			e.other:SummonItem(16502,20); --gold bar 146 to 207
			e.other:SummonItem(10020,20); --Jasper
		end
		if(e.message:findi("JC178") and e.other:Admin() > 79) then --
			e.other:SummonItem(16502,20); --gold bar 146 to 207
			e.other:SummonItem(10023,20); --Jade
		end
		if(e.message:findi("JC191") and e.other:Admin() > 79) then --
			e.other:SummonItem(16502,20); --gold bar 146 to 207
			e.other:SummonItem(10030,20); --Opal
		end
		if(e.message:findi("JC204") and e.other:Admin() > 79) then --
			e.other:SummonItem(16502,20); --gold bar 146 to 207
			e.other:SummonItem(10034,20); --Sapphire
		end
		if(e.message:findi("JC218") and e.other:Admin() > 79) then --
			e.other:SummonItem(16503,20); --platinum bar 218 to 279
			e.other:SummonItem(10015,20); --Malachite
		end
		if(e.message:findi("JC236") and e.other:Admin() > 79) then --
			e.other:SummonItem(16503,20); --platinum bar 218 to 279
			e.other:SummonItem(10020,20); --Jasper
		end
		if(e.message:findi("JC250") and e.other:Admin() > 79) then --
			e.other:SummonItem(16503,20); --platinum bar 218 to 279
			e.other:SummonItem(10023,20); --Jade
		end

	--POISON
	elseif(e.message:findi("Poison") and e.other:Admin() > 79) then
		e.other:Message(13,notready);

	--POTTERY
	elseif(e.message:findi("Pottery") and e.other:Admin() > 79) then
		e.other:Message(13,notready);

	--SMITHING
	elseif(e.message:findi("Smithing") and e.other:Admin() > 79) then
		e.other:Message(13,notready);

	--TAILORING
	elseif(e.message:findi("Tailoring") and e.other:Admin() > 79) then
		e.other:Message(15,"What skill range max? [TR15] [TR26] [TR31] [TR36] [TR56] [TR82] [TR88] [TR108] [TR135] [TR151] [TR158] [TR229] [TR295]");
		e.other:Message(15,warningRoom);
	elseif(e.message:findi("TR") and e.other:Admin() > 79) then
		if(e.message:findi("TR15") and e.other:Admin() > 79) then --15 - silk swatches
			e.other:SummonItem(13041,20); --spider silk
		end
		if(e.message:findi("TR26") and e.other:Admin() > 79) then --26 - Tattered mask
			e.other:SummonItem(13782,20); --Ruined wolf pelt
			e.other:SummonItem(13802,20); --mask pattern
		end
		if(e.message:findi("TR31") and e.other:Admin() > 79) then --31 - Leather padding
			e.other:SummonItem(16486,20); --silk thread
			e.other:SummonItem(13753,20); --low quality wolf skin
		end
		if(e.message:findi("TR36") and e.other:Admin() > 79) then --36 - Raw silk mask
			e.other:SummonItem(16482,20); --silk swatch
			e.other:SummonItem(13802,20); --mask pattern
		end
		if(e.message:findi("TR56") and e.other:Admin() > 79) then --56 - Studded mask
			e.other:SummonItem(13754,20); --medium quality wolf skin
			e.other:SummonItem(12072,20); --studs
			e.other:SummonItem(13802,20); --mask pattern
		end
		if(e.message:findi("TR82") and e.other:Admin() > 79) then --82 - Cured silk mask
			e.other:SummonItem(16482,20); --silk swatch
			e.other:SummonItem(16480,20); --heady kiola
			e.other:SummonItem(13802,20); --mask pattern
		end
		if(e.message:findi("TR88") and e.other:Admin() > 79) then --88 - Tailored backpack
			e.other:SummonItem(13752,20); --high quality bear skin
			e.other:SummonItem(12089,20); --backpack pattern
		end
		if(e.message:findi("TR108") and e.other:Admin() > 79) then --108 - Reinforced mask
			e.other:SummonItem(13755,20); --high quality wolf skin
			e.other:SummonItem(12073,20); --steel boning
			e.other:SummonItem(13802,20); --mask pattern
		end
		if(e.message:findi("TR135") and e.other:Admin() > 79) then --135 - Wu's fighting mask
			e.other:SummonItem(16482,20); --silk swatch
			e.other:SummonItem(16480,20); --heady kiola
			e.other:SummonItem(10250,20); --vial of viscous mana
			e.other:SummonItem(13802,20); --mask pattern
		end
		if(e.message:findi("TR151") and e.other:Admin() > 79) then --151 - Wu's fighting sleeves
			e.other:SummonItem(16482,20); --silk swatch
			e.other:SummonItem(16480,20); --heady kiola
			e.other:SummonItem(10250,20); --vial of viscous mana
			e.other:SummonItem(13808,20); --sleeve pattern
		end
		if(e.message:findi("TR158") and e.other:Admin() > 79) then --158 - Wu's fighting shirt
			e.other:SummonItem(16482,20); --silk swatch
			e.other:SummonItem(16480,20); --heady kiola
			e.other:SummonItem(10250,20); --vial of viscous mana
			e.other:SummonItem(13804,20); --tunic pattern
		end
		if(e.message:findi("TR229") and e.other:Admin() > 79) then --229 - Tae Ew Leather Gloves
			e.other:SummonItem(27761,2); --hardened lizard hide
			e.other:SummonItem(13810,2); --glove pattern
		end
		if(e.message:findi("TR295") and e.other:Admin() > 79) then --295 - Tae Ew Leather Pants
			e.other:SummonItem(27761,2); --hardened lizard hide
			e.other:SummonItem(13811,2); --pant pattern
		end

	--TINKERING
	elseif(e.message:findi("Tinkering") and e.other:Admin() > 79) then
		e.other:Message(15,"What skill range max? [TK68] [TK95] [TK102] [TK122] [TK148] [TK175]");
		e.other:Message(15,warningRoom);
	elseif(e.message:findi("TK") and e.other:Admin() > 79) then
		if(e.message:findi("TK68") and e.other:Admin() > 79) then --68 - Flameless Lantern
			e.other:SummonItem(13004,20); --Large Lantern
			e.other:SummonItem(16857,20); --Metal Twine
			e.other:SummonItem(16881,20); --Firewater
		end
		if(e.message:findi("TK95") and e.other:Admin() > 79) then --95 - Spyglass
		...
		if(e.message:findi("TK102") and e.other:Admin() > 79) then --102 - Stalking Probes
			e.other:SummonItem(16858,20); --Gears
			e.other:SummonItem(16598,20); --Bottle
			e.other:SummonItem(16850,20); --Metal Rod
			e.other:SummonItem(16881,20); --Firewater
		end
		if(e.message:findi("TK122") and e.other:Admin() > 79) then --122 - Power Gloves
			e.other:SummonItem(16858,20); --Gears
			e.other:SummonItem(16881,20); --Firewater
			e.other:SummonItem(16857,20); --Metal Twine
		...
		if(e.message:findi("TK148") and e.other:Admin() > 79) then --148 - Aqualung
		...
		if(e.message:findi("TK175") and e.other:Admin() > 79) then --175 - Rebreathers
	...
	--PLAT
	elseif(e.message:findi("plat") and e.other:Admin() > 79) then
