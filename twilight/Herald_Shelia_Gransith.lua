...
function event_say(e)
	...
	elseif(e.message:findi("i know some songs")) then
	...
	elseif(e.message:findi("i would like to earn some armor")) then
	...
	elseif(e.message:findi("what breastplate")) then
	...
	elseif(e.message:findi("what vambracers")) then
