...
function event_say(e)
	...
	elseif(e.message:findi("holy knoght")) then
...
local item_lib = require('items');
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 4490, item2 = 5891, item3 = 5892, item4 = 5983})) then
		e.self:Emote("smiles.");
		e.self:Say("Here is what I promised, ".. e.other:GetName() .. ".");
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 4494, item2 = 5900, item3 = 5901})) then
		e.self:Emote("smiles.");
		e.self:Say("Here is what I promised, ".. e.other:GetName() .. ".");
		e.other:QuestReward(e.self,0,0,0,0,3976,10000); --
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 4488, item2 = 5894, item3 = 5895, item4 = 5896})) then
		e.self:Emote("smiles.");
		e.self:Say("Here is what I promised, ".. e.other:GetName() .. ".");
