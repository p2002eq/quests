...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 19030})) then--Crate of Teir`Dal Provisions
		e.self:Say("Finally!! We have been in dire need of these supplies for quite some time, " .. e.other:GetName() .. "!  Here is the receipt for the shipment. The last shipment never made it here and there is an item of great importance stored in the lost crate. Before you return to Neriak, your services are needed to retrieve our [" .. eq.say_link("missing shipment") .. "]. I command your obedience as is my right as a dragoon of Naythox Thex's personal regime.");
