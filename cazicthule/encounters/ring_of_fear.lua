...
function event_timer(e)
	if(e.timer == "aoe") then
		...
		--eq.spawn2(48181,0,0,586,1055,-96.97,132):TempName("An_explosion_of_fear");
		eq.spawn2(48181,0,0,586,1055,-96.97,132);
		eq.signal(48181,1);
	...
	elseif(e.timer == "aoe2") then
		...
		eq.stop_timer("aoe2");	
		-- spawn invis mob to cast aoe spell then depop
		--eq.spawn2(48181,0,0,586,1090,-90,132):TempName("An explosion of fear");
		eq.spawn2(48181,0,0,586,1090,-90,132);
		eq.signal(48181,2);
