...
function event_waypoint_arrive(e)
	if e.wp == 1 then	
		if wave == 6 then
			...
			inactive(eq.unique_spawn(48384, 0, 0, 651, 1130, -90,340.0); -- Avatar of Dread
			inactive(eq.unique_spawn(48385, 0, 0, 523, 1130, -90,170.0); -- Avatar of Fright
			inactive(eq.unique_spawn(48386, 0, 0, 595, 1005, -90,0.0); -- Avatar of Terror
			spawn_wave();
		elseif wave == 12 then
...
function spawn_wave()
	...
	for i=1,math.random(3,6) do
		eq.spawn2(this_mob, 0, 0, math.random(520, 655), math.random(1050,1135.0, -90, math.random(255));
	end
end
