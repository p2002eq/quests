...
function event_spawn(e)
	...
	eq.unique_spawn(48057, 0, 0, 587, 1090, -98, 0):SetAppearance(3); -- Tahia Felwah
	inactive(eq.spawn2(48001, 0, 0, 587, 1055, -95, 0)); -- a Tae Ew Justicar
	inactive(eq.spawn2(48001, 0, 0, 587, 1128, -95, 128)); -- a Tae Ew Justicar
	inactive(eq.spawn2(48001, 0, 0, 550, 1090, -95, 64)); -- a Tae Ew Justicar
	inactive(eq.spawn2(48001, 0, 0, 625, 1090, -95, 192)); -- a Tae Ew Justicar
end
...
function event_death_complete(e)
	...
	eq.unique_spawn(48388, 0, 0, 587, 1090, -98, 0); -- Tahia Felwah -- spawn standing Tahia
end
