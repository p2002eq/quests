...
function event_timer(e)
	if(e.timer == "Phase1Water") then
		...
		eq.spawn2(223104,0,0,68,867,495,371.0);
		eq.spawn2(eq.ChooseRandom(223092,223093),0,0,68,877,495.0,185.5);
		eq.spawn2(eq.ChooseRandom(223092,223093),0,0,68,857,495.0,185.5);
