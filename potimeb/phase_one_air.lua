...
function event_signal(e)
	...
	if (e.signal == 1) then
		...
		if (event_counter == 4) then
			eq.spawn2(223120,0,0,68,1355,494.8,371.0); -- Neimon_of_Air
			eq.spawn2(223111,0,0,68,1365,494.8,371.0); -- Servitor_of_Xegony
			eq.spawn2(223111,0,0,68,1375,494.8,371.0); -- Servitor_of_Xegony
			eq.spawn2(223111,0,0,68,1345,494.8,371.0); -- Servitor_of_Xegony
			eq.spawn2(223111,0,0,68,1335,494.8,371.0); -- Servitor_of_Xegony
			event_counter = 0;
		end
