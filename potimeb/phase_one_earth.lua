...
function event_timer(e)
	if(e.timer == "Phase1Earth") then
		...
		eq.spawn2(223106,0,0,70.3,1644.5,493.7,371.0);
		eq.spawn2(223106,0,0,70.3,1654.5,493.7,371.0);
		eq.spawn2(223106,0,0,70.3,1634.5,493.7,371.0);
...
function event_signal(e)
	...
	if (e.signal == 1) then
		...
		if (event_counter == 9) then
			eq.spawn2(223119,0,0,70.3,1644.5,493.7,371.0); 
			event_counter = 0;
		end
