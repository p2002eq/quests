...
function event_hp(e)
	if (e.hp_event == 91) then
		...
		eq.spawn2(eq.ChooseRandom(223079,223081,223080,223082),0,0,-438.0,344,348,128);
		eq.spawn2(eq.ChooseRandom(223079,223081,223080,223082),0,0,-438.0,277,348,128);
		eq.spawn2(eq.ChooseRandom(223079,223081,223080,223082),0,0,-694.0,210,348,64);
		eq.spawn2(eq.ChooseRandom(223079,223081,223080,223082),0,0,-592.0,210,348,64);
