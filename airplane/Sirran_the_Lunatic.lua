...
function event_say(e)
	...
	elseif(e.message:findi("citanul eht narris, liah") and sirran == 6) then 	--island6
		e.self:Say("Lortap llaw taerg eht fo lahsram, Narris lahsram ma I. Flesym ecudortni ot em wolla. Sgniteerg");
	elseif(e.message:findi("llaw eht htiw eno I ma") and sirran == 6) then 		--island6
	...
	elseif(e.message:findi("traverse this plane") and sirran == 1) then
