function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("looks down at you. 'What is it you want, $name? Why do you speak to the great Knight Clrakk Blackfist?'");
...
local item_lib = require('items');
	...
	if (item_lib.check_turn_in(e.self, e.trade, {item1 = 25115})) then
		e.self:Say("You truly are a bringer of strife, $name. Take this. I hope it will assist you. Use it in our war against the Coldain scum.");
