function event_say(e)
	if (e.message:findi("hail")) then
		e.self:Say("You obviously have no idea where you have trespassed so I will generously allow you to live. I suggest you leave immediately before my generosity runs out however......Unless, you're [" .. eq.say_link("looking for work") .. "].");
	elseif (e.message:findi("looking for work")) then	
		e.self:Say("Well, you might do. Out in the deepest scar, known as the Wakening Land we have deployed several mercenaries to harass the local annoying population. They are in need of constant supplies so we hire those we can trust to deliver those supplies to the mercenaries wandering out in the field. Are you [" .. eq.say_link("I am interested",false,"interested") .. "], "..e.other:Race().."?");
