...
local QUEST_ITEMS = {
	...
	quest_helper:melee_breastplate(KAEL_ARMOR.Chain_Tunic, 25364), -- Breastplate
	quest_helper:melee_armplate(KAEL_ARMOR.Chain_Sleeves, 25365), -- Arms
	quest_helper:melee_bracer(KAEL_ARMOR.Chain_Bracer, 25366), --Bracer
	quest_helper:melee_gauntlets(KAEL_ARMOR.Chain_Gauntlets, 25367), --gloves
