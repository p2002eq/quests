...
function event_say(e)
	...
	if (e.other:GetFaction(e.self) < 6) then --Indifferent or lower
		...
		elseif (e.message:findi("prove myself")) then	
			e.self:Say("Leave this place then and return when you have waged war upon the Coldain. Remove their heads from their bodies and return them to me. I will spread the word of your deeds amongst my people if you do so, $name.");
...
function event_trade(e)
	...
	if (e.other:GetFaction(e.self) < 6) then --Indifferent or lower 
		if (item_lib.check_turn_in(e.self, e.trade, {item1 = 30081})) then
			e.self:Say("Very good, $name. Slay more of the beasts and your name will be known by all of the Kromrif!");
			e.other:AddEXP(500);
