...
function event_timer(e)
	if(e.timer == "spawns") then
		eq.spawn2(13120.0,4,0,-1839,829,18,0); 
		eq.spawn2(13120.0,4,0,-2149,10351,18,0);
		eq.spawn2(13120.0,4,0,-1713,1075,17,0);
		eq.spawn2(13120.0,4,0,-1690,363,-7,0);
		eq.spawn2(13120.0,4,0,-2604,222,-44,0);
	end
end
