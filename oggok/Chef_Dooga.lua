function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Welcome you. You look all skin 'n bones. Eat you must do. Chef Dooga can fix up goodies for you. Try [" .. eq.say_link("HEHE meat") .. "].");
	elseif(e.message:findi("hehe meat")) then
		e.self:Say("It is a secret ground meat made with high elf, human, and Erudite Flesh. Mmmm. It good stuff. Dooga make it and [" .. eq.say_link("the Gobbler") .. "] make it. If you find any of those meats in the swamps bring to me and I pay you.");
	elseif(e.message:findi("gobbler")) then
		e.self:Say("You no hear of the Gobbler!! Him great butcher. Have all kinds of meat. Him am low on froglok legs. Dooga supply him. Dooga need someone to [" .. eq.say_link("deliver froglok legs") .. "].");
