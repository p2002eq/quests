function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Welcome to intelligence, young " .. e.other:GetName() .. "! Did you think all ogres were inept? Ha!! I hope you show the glimmer. We shamans need more within our ranks. Our race needs to evolve!! So, are you one of the [" .. eq.say_link("smart ogres") .. "] or have I spoken too many syllables?");
