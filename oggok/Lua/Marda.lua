function event_say(e)
	...
	if(e.message:findi("smart ogre")) then
	...
	if(e.message:findi("secret mission")) then
		...
		eq.spawn2(49127,0,0,383,-205.3,66.1,0);
	end
end

function event_trade(e)
	local item_lib = require("items");
	if(item_lib.check_turn_in(e.trade, {item1 = 18884})) then
		...
		e.other:Faction(295,20);
		e.other:SummonItem(eq.ChooseRandom(15270,15226,15279,15211));
	end
	if(item_lib.check_turn_in(e.trade, {item1 = 17929})) then
