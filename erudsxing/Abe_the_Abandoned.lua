...
function event_timer(e)
	...
	if (counting == 1) then
		e.self:Say("Shaman? My time will soon be at hand and I fear I will never see our friends again. But the arrow must be given, our holy [" .. eq.say_link("broken arrow") .. "]. Shaman, will you bear our obligation and [" .. eq.say_link("give them the arrow") .. "]? You will know who to give it to when it is time.");
	elseif (counting == 2) then
		e.self:Emote("suddenly gasps and says, 'I have found it! I know the answer! Come with me and I will tell you. Eyes are everywhere and this knowledge is not for everyone. Finally my centuries of waiting are over hahahaha! Follow me Shaman!");  
		eq.start(4);
