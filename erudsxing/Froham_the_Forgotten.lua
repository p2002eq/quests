function event_spawn(e)
	eq.set_timer("FrohamDepart",360000);
	eq.set_timer("AbeSpawn",660000);
	eq.set_timer("FrohamDepop",661000);
end
...
function event_timer(e)
	...
	elseif (e.timer == "AbeSpawn") then
		eq.spawn2(98050,0,0,4209.4,-1575.5,-289.4,181);
		eq.stop_timer("AbeSpawn");
	elseif (e.timer == "FrohamDepop") then
		eq.depop();
		eq.stop_timer("FrohamDepop");
	end
end
