...
function event_say(e)
    if(e.message:findi("hail")) then
        e.self:Say("It is a pleasure to meet you. " .. e.other:GetName() .. ". I am the residing High Priest of the House of Stout. Many have come to seek my guidance for I have seen many a foe in my fighting days. If you are interested in [" .. eq.say_link("lending a hand") .. "] to the House of Stout. I may have some tasks for you to complete.");
    elseif(e.message:findi("lending a hand")) then
        e.self:Say("Aye. its good to hear that! We need all the help we can get with all the dern [" .. eq.say_link("smugglers") .. "].");
    elseif(e.message:findi("smugglers")) then
        e.self:Say("Well the smugglers are a threat to all that we have accomplished here they steal stolen goods and turn around to sell them and undercut all the merchants of our quarter. There is not much we can do about them now but in time I may need your help. For the time being however. if you wish to assist us there are other [" .. eq.say_link("tasks") .. "] which i need to be completed.");
