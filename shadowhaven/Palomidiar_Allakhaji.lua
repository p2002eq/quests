...
function event_trade(e)
    ...
    if(item_lib.check_turn_in(e.self, e.trade, {item1 = 4768})) then -- A Pulsating Rock
        e.self:Say("This is it, this is what I am looking for to continue my studies. It is generating the same if not more energy then the rock before it! Excellent work, " .. e.other:GetName() .. ". You have my sincere thanks. Should you collect further samples in the future please bring them to me directly.");
