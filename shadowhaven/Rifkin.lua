function event_say(e)
    ...
    elseif(e.message:findi("marais")) then
        e.self:Say("Do you have my ring? No? Then quit your yammering.");
    end
end

function event_trade(e)
    local item_lib = require("items");
    if(item_lib.check_turn_in(e.self, e.trade, {item1 = 29849})) then -- Promise Ring
        ...
        e.other:QuestReward(e.self,0,0,0,0,29850,5000); -- Rifkin's Diary - sealed
    end
