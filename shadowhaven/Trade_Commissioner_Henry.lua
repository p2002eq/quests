...
function event_trade(e)
    ...
    if(item_lib.check_turn_in(e.self, e.trade, {item1 = 26056})) then -- Sateals Economy Report
        ...
        e.other:QuestReward(e.self,0,0,0,0,26057,1000); -- Book of Sales Secrets
    elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 26058})) then -- Thars Sales Report
        e.self:Say("Excellent work " .. e.other:GetName() .. ", I knew that you were someone that I could trust to get the job done. The trader's union of Shadowhaven will hear of your solid work ethic. Perhaps a courier job is in your future, I couldn't have expected anyone to make these deliveries as fast as you did! Please take this amulet as a symbol of your dedication to Shadowhaven's booming economy. While wearing this you are sure to get all the greatest deals from the merchants of the Haven both here and in the bazaar. It was a pleasure meeting, you and thanks for all of your help.");
        e.other:Faction(338, 200); -- Traders of the Haven
        e.other:Faction(152, 20); -- House of Fordel
        e.other:Faction(153, 20); -- House of Midst
        e.other:Faction(154, 20); -- House of Stout
        e.other:QuestReward(e.self,0,0,0,0,26054,1000); -- Amulet of the Haven
    end
