...
function event_trade(e)
    ...
    if(item_lib.check_turn_in(e.self, e.trade, {item1 = 4761})) then -- Journal of Broansas
        ...
        e.other:Faction(152,30); -- house of fordel
        e.other:Faction(140,30); -- haven defenders
        e.other:Faction(338,3); -- traders of the haven
