function event_say(e)
	if(e.other:GetFaction(e.self) == 1) then -- CoV Ally
	    if(e.message:findi("hail")) then
		    e.self:Say("test4 Hello, " .. e.other:GetName() .. ". It is not very often that I see adventurers back in this cave unless they have intentions of hurting the kind wurms here. I can only hope that for your sake that your intentions are good.");
