function event_say(e)
	if(e.other:GetFaction(e.self) == 1) then -- CoV Ally
	    if(e.message:findi("hail")) then
		    e.self:Say("test3 Hello, " .. e.other:GetName() .. ". It is not very often that I see adventurers back in this cave unless they have intentions of hurting the kind wurms here. I can only hope that for your sake that your intentions are good.");
...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) == 1) then -- CoV Ally    
	    if(item_lib.check_turn_in(e.self, e.trade, {item1 = 1861, item2 = 1862})) then
			...
			eq.set_global("CircletFalinkan", "1", 7, "Y1"); 
	    end    
    end
