...
function Conversation()
	...
	eq.unique_spawn(118354, 0, 0, -110, -545, 77,446.0);
...
function ShoutingMatch1()
	eq.unique_spawn(118345,0.0, 0, -5000, -5000, 0, 0);
...
function PreSetup()
	...
	eq.unique_spawn(118351, 0, 0, -125, -530, 77,180.0);
...
function GroupSpawn(num)
	...
	elseif num == 1 then
		-- Garadain
		eq.unique_spawn(118334, 0, 0, -125, -563, 75,10.0);
	elseif num == 2 then
		-- Dobbin
		eq.unique_spawn(118332, 0, 0, -110, -558, 75,480.0);
	elseif num == 3 then
		-- Corbin
		eq.unique_spawn(118331, 0, 0, -98, -545, 75,430.0);
	elseif num == 4 then
		-- Kargin
		eq.unique_spawn(118337, 0, 0, -90, -530, 75,386.0);
	elseif num == 5 then
		-- Churn
		eq.unique_spawn(118329, 0, 0, -90, -515, 75,340.0);
	elseif num == 6 then
		...
		eq.unique_spawn(118332, 0, 0, -10, -1070, 25,256.0);
		eq.signal(118332, 6);
	elseif num == 7 then
		...
		eq.unique_spawn(118334, 0, 0, -1800, -570, 75,256.0);
		eq.signal(118334, 7);
	elseif num == 8 then
		...
		eq.unique_spawn(118329, 0, 0, 1600, -1030, 330,256.0);
		eq.signal(118329, 8);
	elseif num == 9 then
		...
		eq.unique_spawn(118331,0.0, 0, 200, -2885, -150, 0);
		eq.signal(118331, 9);
	elseif num == 10 then
		-- Archers with Kargin
		spawn_Mobs(118347, 950, -1250, 170, 950, -1450, 170, 190, 12, 0);
		-- Kargin
		eq.unique_spawn(118337, 0, 0, 935, -1350, 160,380.0);
		-- assign static 'path'
		eq.signal(118337, 0);
		eq.signal(118347, 0);
	elseif num == 11 then
		...
		-- eq.unique_spawn(118351, 0, 0, -113, 0, 100,256.0);
		-- Aldikar archers
...
function WarEnd(end_type)
	...
	eq.repop_zone();
	local controller = eq.unique_spawn(118361,0.0, 0, -5000, -5000, 0, 0);
	if end_type < 1 then
		local defeat_mobs = {};
		table.insert(defeat_mobs, eq.spawn2(118342, 0, 0, -130, -250,200.0, 100));
		table.insert(defeat_mobs, eq.spawn2(118342, 0, 0, -130, -212,200.0, 100));
		table.insert(defeat_mobs, eq.spawn2(118342, 0, 0, -130, -174,200.0, 100));
		table.insert(defeat_mobs, eq.spawn2(118342, 0, 0, -130, -136,200.0, 100));
		table.insert(defeat_mobs, eq.spawn2(118342, 0, 0, -130, -98,200.0, 100));
		table.insert(defeat_mobs, eq.spawn2(118342, 0, 0, -130, -60,200.0, 100));
		table.insert(defeat_mobs, eq.spawn2(118342, 0, 0, -70, -250,200.0, 160));
		table.insert(defeat_mobs, eq.spawn2(118342, 0, 0, -72, -212,200.0, 160));
		table.insert(defeat_mobs, eq.spawn2(118342, 0, 0, -74, -174,200.0, 160));
		table.insert(defeat_mobs, eq.spawn2(118342, 0, 0, -76, -136,200.0, 160));
		table.insert(defeat_mobs, eq.spawn2(118342, 0, 0, -78, -98,200.0, 160));
		table.insert(defeat_mobs, eq.spawn2(118342, 0, 0, -80, -60,200.0, 160));
		table.insert(defeat_mobs, eq.spawn2(118343, 0, 0, -90, 5,196.0, 192));
		table.insert(defeat_mobs, eq.spawn2(118343, 0, 0, -135, 5,196.0, 64));
...
function WarTimers(e)
	...
	elseif e.timer == "Narandi" then
		...
		depop_except(combo);
		PostSetup();
		eq.unique_spawn(118345, 150,0.0, 250, -2300, -80, 0);
...
function AllSpawn(e)
	...
	-- else depop anything that not on the list except pets     **omitted code since did not seem needed and resulted in Alkidar being despawned once a horse was summoned
	--[[else
