function event_say(e)
	...
	elseif(e.message:findi("instance") and e.self:GetGM()) then
		...
		if(qglobals["KAEL-" .. tostring(guildid)] == nil) then
			...
			e.self:Message(string.format("Kael instance has been created, Guild Name = %s, GuildID = %s, InstanceID = %s!",guildname,guildid,instance_id_kael));
		...
		if(qglobals["TOV-" .. tostring(guildid)] == nil) then
			...
			e.self:Message(string.format("TOV instance has been created, Guild Name = %s, GuildID = %s, InstanceID = %s!",guildname,guildid,instance_id_kael));
		...
		if(qglobals["SLEEPER-" .. tostring(guildid)] == nil) then
			...
			e.self:Message(string.format("SLEEPER instance has been created, Guild Name = %s, GuildID = %s, InstanceID = %s!",guildname,guildid,instance_id_kael));
		...
		if(qglobals["SSRA-" .. tostring(guildid)] == nil) then
			...
			e.self:Message(string.format("SSRA instance has been created, Guild Name = %s, GuildID = %s, InstanceID = %s!",guildname,guildid,instance_id_kael));
		...
		if(qglobals["SSERU-" .. tostring(guildid)] == nil) then
			...
			e.self:Message(string.format("SSERU instance has been created, Guild Name = %s, GuildID = %s, InstanceID = %s!",guildname,guildid,instance_id_kael));
		...
		if(qglobals["VEXTHAL-" .. tostring(guildid)] == nil) then
			...
			e.self:Message(string.format("VEXTHAL instance has been created, Guild Name = %s, GuildID = %s, InstanceID = %s!",guildname,guildid,instance_id_kael));
		...
		if(qglobals["AKHEVA-" .. tostring(guildid)] == nil) then
			...
			e.self:Message(string.format("AKHEVA instance has been created, Guild Name = %s, GuildID = %s, InstanceID = %s!",guildname,guildid,instance_id_kael));
