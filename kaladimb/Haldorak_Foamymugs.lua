function event_say(e)
	...
	elseif(e.message:findi("recipes")) then
		e.self:Say("Now yer talking " .. e.other:GetName() .. ", I be glad to see yer ready to begin crafting yer honor and heed yer calling as a servant o Brell! I have the armor material recipes and molds for Brells Blessed Platemail [Helm], [Bracer], [Armguards], [Boots], [Greaves], [Gauntlets], and [Breastplate]. All ye must do is simply tell me what armor piece ye want to craft and I will gladly present ye with the material recipe and armor mold necessary fer craftin it.");
		-- Holy Assembly Kit
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 28062, item2 = 28062, item3 = 28061, item4 = 28061})) then
