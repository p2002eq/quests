function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Welcome to the Church of Underfoot. Please open your soul to the greatness of Brell Serilis. May he guide you in all your future eavors. And may your soles long for the [" .. eq.say_link("Soil of Underfoot") .. "].");
	...
	elseif(e.message:findi("candle")) then
		e.self:Say("The Candle of Bravery is used for temple ceremonies here in Kaladim. When the candle burns out, I must venture to the frigid village of Halas far to the north of the continent of Antonica. There I will take the candlestick and the [" .. eq.say_link("soil of Underfoot") .. "] to Dok. He must create the candle in the very ornate candlestick.");
	end
end
