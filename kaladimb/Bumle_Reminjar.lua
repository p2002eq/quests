function event_say(e)
	...
	if(e.message:findi("hail")) then
		e.self:Say("Welcome, " .. e.other:GetName() .. ". The Cathedral of Underfoot welcomes all good persons. May you find peace from the dangers of Butcherblock within these walls. The paladins of this holy place are very much aware of the evils outside Kaladim. The threat of goblins and [" .. eq.say_link("birdmen") .. "] has increased.");
	elseif(e.message:findi("birdmen")) then
		e.self:Say("The birdmen I speak of are the aviak krags. These vile creatures have desecrated our land. They have dared to perch upon our great statue. The king has instructed all noble paladins in this order to [" .. eq.say_link("destroy the krag chicks") .. "].");
...
function event_trade(e)
	...
	if((e.other:GetFaction(e.self) < 5) and (item_lib.check_turn_in(e.self, e.trade, {item1 = 12157, item2 = 12157, item3 = 12157, item4 = 12157}))) then
		e.self:Say("You have done well. Your deeds shall be recorded within our journals. Here, then, is your reward. May you strive to serve us to the full extent of your powers. The [" .. eq.say_link("elders") .. "] must also die.");
