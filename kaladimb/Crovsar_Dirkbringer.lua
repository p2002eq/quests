function event_say(e)
	...
	elseif(e.message:findi("assignment")) then
		e.self:Say("Well da assignment is simple " .. e.other:GetName() .. ". I jess simply need ye to fetch me some items that I need to create a minin pick dat I plan on distributing to all da new miners around dese parts dat pass my exercises, much like yerself. If you would like to help me [collect] the items I need I could perhaps fix ye up one of dese first minin picks. Whatta ya say dere " .. e.other:GetName() .. "?");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 28067, item2 = 28068, item3 = 28068})) then
