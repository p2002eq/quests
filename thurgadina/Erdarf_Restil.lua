...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 30269})) then --Sceptre of Coldain Ancients
		e.self:Emote("smirks at you.");
		e.self:Say("Hrm, you again eh? Did you come back to bother me with more...Wait a minute, let me see that. This is... This must be, yes it is. This is one of the ancient coldain priests sceptres of channeling. This is too good to be true. Haha! Oh, what I can do with this. Here, take this gem from the sceptre. If ancient lore proves right it will allow you to persuade beasts of many kinds.");
		e.other:QuestReward(e.self,0,0,0,0, 30270, 25000); --Gem of Persuasion 
		eq.depop_with_timer();
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 30271})) then --Bottle of Karsic Acid
