function event_say(e)
	if(e.message:findi("velium vapors")) then	
		e.self:Say("Ahh, you come seeking my family recipe? After all you've done for our people it's the least I can do. First you must fashion a [" .. eq.say_link("velium vial") .. "], then combine the vial with two small pieces of velium in this jar. That's all there is to it. Please keep the recipe a secret.");
