...
function event_say(e)
	if (e.message:findi("burin")) then
		e.self:Say("You'll need a fletching kit and a fair bit of skill for this one, $name. Round up a tooth from a swordfish and attatch it to an Ulthork tusk wrapped in a Molkor hide.");
	end
