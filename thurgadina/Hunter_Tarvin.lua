function event_say(e)
	if(e.message:findi("hail")) then	
		e.self:Say("Good day, stranger. I would love to sit and chat with you but I don't much like gabbing it up with total strangers. I have other [" .. eq.say_link("things") .. "] to think on, Good day.");
