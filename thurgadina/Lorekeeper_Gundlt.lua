function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Ahem....yes, hail. I suppose that would suffice in this case. Well, then, hail to you, sir. I am Lorekeeper Gundlt, master keeper of etiquette. It is my duty, as ordained by the Grand Historian, to keep all records and rules on all [" .. eq.say_link("royal") .. "] audiences and dealings.");
	elseif(e.message:findi("royal")) then		
		e.self:Say("Why, Frostreaver IV, of course! All who wish an audience must first consult with me to be educated on the proper way to address our great Dain. Do you wish an audience with the [" .. eq.say_link("crown") .. "]?");
