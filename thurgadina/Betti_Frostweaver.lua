function event_say(e)
	...
	elseif(e.message:findi("embroidered prayer shawl")) then	
		e.self:Say("It will be an honor to assist you in fashioning an [" .. eq.say_link("embroidered shawl") .. "]. It is a very demanding product and I can see from the look in your eyes that you desire to burn your sewing kit in our furnace, but if you persevere, your efforts will be richly rewarded. When you are ready you must carefully weave a spool of sacred Coldain thread. Take the thread, this pattern, and the silk shawl and carefully embroider the pattern. The result will be most exquisite. Please show me if you manage to create one.");
		e.other:SummonItem(1833);
	elseif(e.message:findi("embroidered shawl")) then
		e.self:Say("It will be an honor to assist you in fashioning an embroidered shawl. It is a very demanding product and I can see from the look in your eyes that you desire to burn your sewing kit in our furnace, but if you persevere, your efforts will be richly rewarded. When you are ready you must carefully weave a spool of [" .. eq.say_link("sacred Coldain thread") .. "]. Take the thread, this pattern, and the silk shawl and carefully embroider the pattern. The result will be most exquisite. Please show me if you manage to create one.");
		e.other:SummonItem(1833);
