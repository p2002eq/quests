...
function event_waypoint_arrive(e)
	if (e.wp == 15) then
		...
		eq.signal(115104, 1); --Unknown NPC
		eq.signal(115206, 1); 
		eq.signal(115105, 1); --Unknown NPC
		eq.signal(115207, 1);
		eq.signal(115107, 1); --Unknown NPC
		eq.signal(115208, 1);
		eq.signal(115109, 1);
		eq.signal(115110, 1); --Unknown NPC
		eq.signal(115209, 1);
		eq.signal(115112, 1);
		eq.signal(115113, 1); --Unknown NPC
	end
end
