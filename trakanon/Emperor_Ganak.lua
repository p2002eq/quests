function event_say(e)
	...
	elseif(e.message:findi("veeshan's peak")) then
		e.self:Say("You wish to know of Veeshans Peak?! You are either very brave or very foolish! There is nothing there for the uninvited but a fiery death. I have been away from this plane of existence for a long time yet still I feel the presence of the ancient wurms. I am sure they sense my presence as well, being as I hold the only [" .. eq.say_link("key to the chambers") .. "] of the Ring of Scale.");
	elseif(e.message:findi("key to the chambers")) then
		e.self:Say("I am not so quick to grant someone the key to their death! If you truly wish your doom to fall upon you so soon then bring me the three medallions of the fallen Iksar tribes, Kylong, Obulus, and Jarsath. The tribes were long ago crushed by the warriors of the Kunzar and their remains lie buried beneath ages of rubble. Finding the lost medallions of my people will not be enough to prove yourself worthy of entry into the fortress of the great wurms -- there is another [" .. eq.say_link("task") .. "] that you must complete before you return the [" .. eq.say_link("medallions") .. "].");
	...
	elseif(e.message:findi("glowing orb")) then
		e.self:Say("The glowing orb is activated by a special key, an idol crafted in the likeness of the dread Trakanon, Reaver of Sebilis. I have this idol and will give it to you, but only if you give me two [" .. eq.say_link("medallions") .. "] representing the Iksar tribes of old.");
	elseif(e.message:findi("Sebilis")) then
		e.self:Say("An adventurer that wishes to enter the inner city of Sebilis you say?? There are only two ways in, either the [" .. eq.say_link("glowing orb") .. "] in the heart of the ruins in the outer city, or via one of the tortured souls that wanders the jungles nearby.");
	end
end
