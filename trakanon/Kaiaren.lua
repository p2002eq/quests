...
function event_trade(e)
	...
	if((item_lib.check_turn_in(e.trade, {item1 = 1684}))) then --Charred Scale
	...
	if((item_lib.check_turn_in(e.trade, {item1 = 1688, item2 = 1689}))) then --Demon Fangs and Book of Celestial Fists
