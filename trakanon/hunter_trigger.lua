...
function event_signal(e)
    ...
    if(e.signal == 1) then --mob died
	   ...
	   local getnewmobid = eq.ChooseRandom(95163, 95164, 95165, 95166, 95167, 95168, 95169, 95170, 95171, 95172, 95173, 95174, 95175, 95176, 95000, 95000, 95000, 95000, 95000, 95000, 95000, 95000, 95000, 95000, 95000);
