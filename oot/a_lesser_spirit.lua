...
function event_say(e)
	...
	elseif(e.message:findi("yes")) then --Part of Shaman Epic 1.0
		e.self:Say("Why have you taken this person's life, " .. e.other:GetName() .. "? Did he [" .. eq.say_link("he threatened my life",false,"threaten your life") .. "]? Did you dislike him? Or was his death a profit to you in some way?");
	...
	elseif(e.message:findi("what are you")) then --Part of Shaman Epic 1.0
		e.self:Say("What, or who, I am isn't as important as what, or who, WE are. Do you wish to [" .. eq.say_link("know more") .. "], shaman?");
