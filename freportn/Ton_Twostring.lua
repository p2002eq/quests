...
function event_say(e)
	...
	elseif(e.message:findi("mail") and not e.message:findi("deliver") and not e.message:findi("Kelethin") and not e.message:findi("Highpass") and not e.message:findi("Qeynos")) then
