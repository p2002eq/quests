...
function event_say(e)
	if(e.message:findi("hail")) then -- Part of Shaman Epic 1.0
		e.self:Say("Greetings, shaman. Tell me, do you follow [" .. eq.say_link("I follow Justice",false,"Justice") .. "], [" .. eq.say_link("I follow War",false,"War") .. "], [" .. eq.say_link("I follow Honor",false,"Honor") .. "], [" .. eq.say_link("I follow fear",false,"Fear") .. "], or [" .. eq.say_link("I follow Hate",false,"Hate") .. "]?");
