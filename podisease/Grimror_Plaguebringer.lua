...
function event_trade(e)
    ...
    if not e.other:IsRaidGrouped() and item_lib.check_turn_in(e.self, e.trade, {item1 = 9290, item2 = 9291, item3 = 9292, item4 = 9293}) then  --Sengien Larvae Flesh, Generian Larvae Flesh, Scaevian Larvae Flesh, Harrion Larvae Flesh
		...
		e.other:SummonItem(9294);  --Bangle of Disease Warding only to person who completes hand-in
		...
		elseif qglobals.pop_alt_access_codecay == nil then
