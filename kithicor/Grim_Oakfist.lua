...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 12341, item2 = 12342, item3 = 12343})) then
		...
		e.other:Faction(184,10); -- Knights of Truth Faction ID-184
		e.other:Faction(300,10); -- Silent Fist Clan Faction ID-300
		e.other:QuestReward(e.self,0,0,0,0,12367,1000); -- Collar of Neshika ID-12367
	end
