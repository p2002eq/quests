...
function event_say(e)
    ...
    elseif(e.message:findi("interested") and tonumber(qglobals.qeynos_badge2) == 6) then
        e.self:Say("Still interested? Very well then " .. e.other:GetName() .. ", you look rather intelligent. As a show of your commitment to this task, please turn in your [" .. eq.say_link("Interrogator's Badge") .. "]");
