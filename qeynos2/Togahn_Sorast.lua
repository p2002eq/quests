...
function event_say(e)
	...
	if(e.message:findi("hail")) then
		e.self:Say("Greetings.. I am Second Master Togahn Sorast. I am here to teach the ways of our guild. For our more advanced members, I will give out [" .. eq.say_link("headbands") .. "] as a reward for their contribution to the clan.");
	elseif(e.message:findi("headbands")) then
		e.self:Say("The Silent Fist Clan gives out colored Headbands for various deeds completed by our students. Phin gives out the White, Yellow, and Orange Headbands.. and I give out the [" .. eq.say_link("Red Headbands",false,"Red") .. "], [" .. eq.say_link("Purple Headbands",false,"Purple") .. "], and [" .. eq.say_link("Blue Headbands",false,"Blue") .. "] Headbands.");
	...
	elseif(fac <= 3) then
		...
		elseif(e.message:findi("black headband")) then
			e.self:Say("The black headband is one of the highest honors of our guild.. [" .. eq.say_link("Lu'Sun") .. "] only gives those out for great acts of heroism and devotion to the clan.");
		end
	else
