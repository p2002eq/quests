...
function event_say(e)
	...
	if(e.message:findi("Hail")) then
			e.self:Say("Hey, hey, hey! Welcome to the Fool's Gold. Don't bet more than you can afford to lose, pal! You don't want to end up like ol' [" .. eq.say_link("Kevlin") .. "]. If you're looking for something to do after you have a drink, you may be interested in a [task].");
	elseif(e.message:findi("kevlin")) then
		e.self:Say("Kevlin Diggs. His family sells armor here in Rivervale. He has a nice shop right across from us here. But he owes us Deeppockets some [" .. eq.say_link("gold") .. "] that we need to collect. We can't rough him up because he is a friend of Mayor Gubbin. We need someone to steal it.");
