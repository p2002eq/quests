...
function event_death_complete(e)
	...
	eq.unique_spawn(162193, 0, 0, 561, -235, 138,256.0);  -- guard
	eq.unique_spawn(162194, 0, 0, 660, -309, 146,436.0);  -- guard
	eq.unique_spawn(162195, 0, 0, 660, -246, 146,330.0);  -- guard
	eq.unique_spawn(162196,0.0, 0, 561, -323, 138, 0);  -- guard
