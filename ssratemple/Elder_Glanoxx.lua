-- Elder Glanoxx (162144) in Ssratemple for Emp key quest
...
function event_trade(e)
	...
	if item_lib.check_turn_in(e.self, e.trade, { item1 = 13006 }) then
		e.self:Say("Are you here for them... are you here to [" .. eq.say_link("release") .. "] us?");
	end
