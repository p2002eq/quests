function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("I am Tibrinn Ember, forest friend and Unkempt Druid. Aid us in our [" .. eq.say_link("conflict") .. "] against the polluters of nature and I will reward you.");
