function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Welcome to our camp.  We are paladins gathered from many lands. We have been called to this land by our deities.  Ours is a crusade of righteousness.  Have you happened upon us by chance or do you [" .. eq.say_link("seek the sacred molds") .. "]?");
	...
	elseif(e.message:findi("seek the sacred molds")) then
		e.self:Say("Many of us carry the sacred molds of the holy paladin armor.  We will release it only to those who have proven themselves to each of our deities.  If you seek it, speak up!! Tell us which part you seek.  I carry the secret of the [" .. eq.say_link("Helm of Ro") .. "].  The others carry those of vambraces, breastplates, bracers, gauntlets, greaves and boots of Ro.");
	elseif(e.message:findi("Lord Searfire")) then
		e.self:Say("Lord Searfire is a great forge master.  He was called forth to the land of fire lakes.  It is said that he now toils in the name of Solusek Ro within a hidden temple of that land.  He and he alone knows how to obtain [" .. eq.say_link("ronium") .. "], a needed component for forging the sacred Armor of Ro.");
...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) < 5) then  -- amiable or better to get mold
		if(item_lib.check_turn_in(e.self, e.trade, {item1 = 12308, item2 = 12308})) then
			e.self:Say("You have proven yourself to Karana.  I grant you the mold of the Ro Helm.  May the winds of Karana blow in your favor.  Now you must seek out Lord Searfire and  ask him for [" .. eq.say_link("ronium") .. "] to complete the second and only other component needed to be fashioned by a master blacksmith.");
