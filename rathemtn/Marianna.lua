function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Rodcet Nife welcomes you into our noble camp.  I am the keeper of the [" .. eq.say_link("Vambraces of Ro") .. "].");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 12310, item2 = 12310}) and e.other:GetFaction(e.self) < 5) then
		e.self:Say("You now own a mold for the Vambracers of Ro.  Go and ask Thomas of [" .. eq.say_link("Lord Searfire") .. "] for the final component.");
