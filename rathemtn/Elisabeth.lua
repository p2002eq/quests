function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Very good to meet you. " .. e.other:GetName() .. ".  I am the keeper of the [" .. eq.say_link("Greaves of Ro") .. "].  Please feel free to rest and recuperate here.  We shall see that you are safe from the evils of the Rathe Mountains.");
...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) < 5) then
		if(item_lib.check_turn_in(e.self, e.trade, {item1 = 12313})) then
			e.self:Say("You have done well.  These giants shall soon be purged from the Commonlands and the inns will be filled once again.  Here is the mold for the Ro Greaves.  For the final component, go and ask Thomas of [" .. eq.say_link("Lord Searfire") .. "].");
