...
function event_waypoint_arrive(e)
	...
	elseif e.wp == 9 and not ambush then
		...
		eq.pause(3000);
		for n = 1,4 do
			grimling = eq.spawn2(167679,0,0,-707 + math.random(-10, 10),-239 + math.random(-10, 10), 25, 84);
	...
	elseif e.wp == 11 then
			eq.get_entity_list():GetMobByNpcTypeID(veteran):GMMove(-874,250,47,282,true);	--moves Veteran to ambush site (he should be popped based on prior wp)
	elseif e.wp == 12 then
