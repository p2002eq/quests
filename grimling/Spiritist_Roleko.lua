...
function event_trade(e)
    ...
    elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 10777, item2 = 10778, item3 = 10779, item4 = 10915})) then -- Amulet of Golden Rays, Black Flame Charcoal, Thought Leech Brain & Rakshasa Materialization Ritual
