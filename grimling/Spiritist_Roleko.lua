...
function event_trade(e)
    ...
    if(item_lib.check_turn_in(e.self, e.trade, {item1 = 31839, item2 = 31841})) then -- Resealed Runed Iron Bound Chest & Roshawnas Report of Occurrences
        ...
        eq.spawn2(167685,0,0,-975.17,-825.20,6.74,260); -- A possesed griming -- needs_heading_validation
        eq.spawn2(167687,0,0,-958.44,-834.88,6.74,260); -- A Reanmiated Grimling -- needs_heading_validation
        eq.spawn2(167687,0,0,-979.17,-839.41,1.14,260); -- A Reanmiated Grimling -- needs_heading_validation
        eq.spawn2(167687,0,0,-967.86,-838.92,4.63,260); -- A Reanmiated Grimling -- needs_heading_validation
    ...
    elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 10777, item2 = 10778, item3 = 10779, item4 = 10915}) and tonumber(qglobals.Rakshasa) ~= 1) then -- Amulet of Golden Rays, Black Flame Charcoal, Thought Leech Brain & Rakshasa Materialization Ritual
        ...
        eq.spawn2(167713,0,0,-975.17,-825.20,6.74,40); -- Rakshasa Karwoaro
