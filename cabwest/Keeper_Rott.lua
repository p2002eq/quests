function event_say(e)
	...
	elseif(e.message:findi("additional mission")) then
		...
		e.self:Say("All these notes are useless to me without the first four note pages! While I ventured through the fields of the drixies, I was assaulted by a band of gobs. They were shamans. I heard them calling spirits. They took the first two pages before I escaped. Then I lost the [" .. eq.say_link("second two pages") .. "] the next day!! Blast!!");
