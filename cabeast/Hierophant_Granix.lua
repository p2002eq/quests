...
function event_say(e)
	...
	elseif(e.message:findi("What Visions?") and (e.other:GetFaction(e.self) < 3)) then
	...
	elseif(e.message:findi("What dreams cloud your mind?") and (e.other:GetFaction(e.self) < 3)) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 30984}) and (e.other:GetFaction(e.self) < 3))  then
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 30986}) and (e.other:GetFaction(e.self) < 3)) then
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 30988, item2 = 5146}) and (e.other:GetFaction(e.self) < 3)) then
