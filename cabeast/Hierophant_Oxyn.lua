...
function event_say(e)
	...
	elseif((e.message:findi("temple tasks")) and (e.other:GetFaction(e.self) < 3) and (e.other:Class() == "Shaman")) then
	...
	elseif((e.message:findi("daily tasks")) and (e.other:GetFaction(e.self) < 3) and (e.other:Class() == "Shaman")) then
	...
	elseif((e.message:findi("lost skulls")) and (e.other:GetFaction(e.self) < 3)) then
...
function event_trade(e)
	...
	if((item_lib.check_turn_in(e.trade, {item1 = 12721, item2 = 12722, item3 = 12723, item4 = 5140})) and (e.other:GetFaction(e.self) < 3)) then
	...
	if((item_lib.check_turn_in(e.trade, {item1 = 12724, item2 = 12725, item3 = 5141})) and (e.other:GetFaction(e.self) < 3)) then
