...
function event_say(e)
	...
	elseif((e.message:findi("iron cudgel")) and (e.other:GetFaction(e.self) > 6)) then
	...
	elseif((e.message:findi("other skulls")) and (e.other:GetFaction(e.self) < 6)) then
	...
	elseif((e.message:findi("damaged")) and (e.other:GetFaction(e.self) < 6)) then
...
function event_trade(e)
	...
	if((item_lib.check_turn_in(e.trade, {item1 = 12721, item2 = 12722, item3 = 12723, item4 = 5140})) and (e.other:GetFaction(e.self) > 6)) then
