...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3887})) then -- The History of the Greenmist
		...
		e.other:QuestReward(e.self,0,0,0,0,3895,5000); -- A note to Oxyn
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 3893})) then -- Note to Librarian Zimor
		...
		e.other:Faction(62,20); -- Crusaders of Greenmist
		e.other:Faction(193,10); -- Legion of Cabilis
		e.other:QuestReward(e.self,0,0,0,0,18320,5000); -- Notes from the Greenmist Tome
	end
