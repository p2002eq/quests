...
function event_say(e)
	...
	elseif((e.other:GetFaction(e.self) <= 4) and (tonumber(qglobals.shmskullquest) >= 7)) then
		if(e.message:findi("Di Nozok sent me")) then
			e.self:Emote("drops the egg he was holding. Egg yolk splatters on your foot. His eyes roll back into his head. He speaks, but his voice is that of a female. 'I await you, Cradossk . My sisters and I yearn for the return of our skulls. We are the [" .. eq.say_link("Sisters of Scale") .. "]. Find us and bring to this hierophant our skulls and your iron cudgel of the Channeler. Go.'");
		elseif(e.message:findi("Sisters")) then
			e.self:Emote("wipes egg yolk from his clothing. 'My, what a mess!! Hmmph!! What did you say? Sisters of Scale? They were a legendary trio of mystics. We once had their skulls sealed within this temple, but now they are lost. I sent a channeler to retrieve them. His name was [" .. eq.say_link("Vagnar") .. "]. I am sure he shall find them.'");
