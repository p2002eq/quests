...
function event_say(e)
	...
	elseif(e.message:findi("Zand") and (e.other:GetFaction(e.self) < 3)) then
	...
	elseif(e.message:findi("Sisters") and (e.other:GetFaction(e.self) < 3)) then
	...
	elseif(e.message:findi("vagnar") and (e.other:GetFaction(e.self) < 3)) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 5145, item2 = 12748, item3 = 12750, item4 = 12749}) and (e.other:GetFaction(e.self) < 3)) then
