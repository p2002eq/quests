...
function event_say(e)
	...
	elseif(e.message:findi("Sisters of Scale") and tonumber(qglobals.shmskullquest) >= 9 and faction < 6) then
	...
	elseif(e.message:findi("What memory of Sebilis?")) then
		...
		e.self:Say("Puhh...lease!! That's the little trophy the War Baron brought back from Sebilis. He got it stolen from him by some thieves!! I say it was the [" .. eq.say_link("What steelhead gang?",false,"Steelhead gang") .. "]. They were waltzing in and out of Cabilis like it was a blasted public vomitorium!!");
