...
function event_say(e)
	...
	elseif(e.message:findi("hehe meat")) then
		e.self:Say("HEHE meat!! What dat stand for? Mes need some of dis HEHE meat!! Gos and get me some. Cagrek not just want some. Cagrek want more dan twenny!! Cagrek want three HEHE meat and mes want HEHE recipe. You get and me makes $name honeraree carver. Me gives you Grobb Cleaver. It cuts skins like dey butter!!");
	end
end
