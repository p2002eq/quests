function event_say(e)
	...
	if(e.message:findi("sorcerous arts")) then
	...
	if(e.message:findi("outfit and robe")) then
	...
	if(e.message:findi("staff of the bloodsabers")) then
