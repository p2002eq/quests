function event_say(e)
	...
	if(e.message:findi("training as a shadowknight")) then
	...
	if(e.message:findi("suit of armor")) then
	...
	if(e.message:findi("pressing matter")) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 20186})) then
