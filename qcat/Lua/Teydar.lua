...
function event_say(e)
	...
	-- [FLAG: Possible incorrect client target: e.self:Class() ==] if(e.message:findi("hail") and e.self:Class() == "Shadowknight") then 
	if(e.message:findi("hail") and e.other:GetClass() == 5) then
	...
	if(e.message:findi("decrepit sheath") and e.other:GetFaction(e.self) < 4) then
...
function event_trade(e)
	...
	-- e.other:GetFaction(e.self) = e.self:GetCharacterFactionLevel(342);
	if(e.other:GetFaction(e.self) < 4 and item_lib.check_turn_in(e.trade, {item1 = 14372, item2 = 14371, item3 = 16507})) then
