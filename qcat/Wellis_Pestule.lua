...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 20206})) then
		e.self:Say("Welcome to the Bloodsabers young Scourge Knight. I will help prepare you for your spreading of the disease. You must use this Mail Assembly Kit to construct the pieces of your armor. Each piece will require different materials for its construction. Will you craft [" .. eq.say_link("Gauntlets of the Scourge Knight") .. "], [" .. eq.say_link("Boots of the Scourge Knight") .. "], a [" .. eq.say_link("Bracer of the Scourge Knight") .. "], a [" .. eq.say_link("Helm of the Scourge Knight") .. "], [" .. eq.say_link("Greaves of the Scourge Knight") .. "], [" .. eq.say_link("Vambraces of the Scourge Knight") .. "], or a [" .. eq.say_link("Breastplate of the Scourge Knight") .. "]?");
