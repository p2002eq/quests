function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hail " .. e.other:GetName() .. ". I am Bruax Grengar, master necromancer of the Bloodsabers. I assist not only young necromancers with their training but also aid all those Bloodsabers who have chosen to practice the [" .. eq.say_link("sorcerous arts") .. "]. If you a practitioner of a sorcerous art I can give you instructions to obtain an [" .. eq.say_link("outfit and robe") .. "] that will assist you in your work. Once you have been properly outfitted I will also assist you in acquiring a [Staff of the Bloodsabers].");
	...
	elseif(e.message:findi("outfit and robe")) then
		e.self:Say("I have prepared this special curing kit for the crafting of an outfit and robe. The materials required for each article of clothing vary. Do you desire to craft a [" .. eq.say_link("scourge sorcerer cap") .. "], [" .. eq.say_link("scourge sorcerer wristband") .. "], [" .. eq.say_link("scourge sorcerer gloves") .. "], [" .. eq.say_link("scourge sorcerer boots") .. "], [" .. eq.say_link("scourge sorcerer sleeves") .. "], [" .. eq.say_link("scourge sorcerer pantaloons") .. "], or [" .. eq.say_link("scourge sorcerer robe") .. "]?");
