...
function event_say(e)
    if(e.message:findi("valdanov") and (eq.get_qglobals()["vampyre_vahshir_combat"] == 1)) then
    ...
    elseif(e.message:findi("abilities") and (eq.get_qglobals()["vampyre_vahshir_combat"] == 1)) then
        ...
        eq.spawn2(172001,0,0,e.self:GetX(),e.self:GetY(),e.self:GetZ(),e.self:GetHeading());
        eq.spawn2(172001,0,0,e.self:GetX(),e.self:GetY(),e.self:GetZ(),e.self:GetHeading());
        eq.spawn2(172001,0,0,e.self:GetX(),e.self:GetY(),e.self:GetZ(),e.self:GetHeading());
        eq.spawn2(172001,0,0,e.self:GetX(),e.self:GetY(),e.self:GetZ(),e.self:GetHeading());
