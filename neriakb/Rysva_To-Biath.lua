...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 13846,item2 = 18201})) then--Dark Elf Decapitated Head
		e.self:Say("Take this book and be gone with you.");
		e.other:Faction(87, 10);--Dreadguard Inner
		e.other:Faction(88, 10);--Dreadguard Outer
		e.other:Faction(69, 10);--Dark Bargainers
		e.other:QuestReward(e.self,0,0,0,0,18202,72900); --Book of Turmoil
	elseif(item_lib.check_turn_in(e.trade, {item1 = 19071,item2 = 19070,platinum = 1000})) then
