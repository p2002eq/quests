...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 12807})) then--Halfling Druid Master's Head
		...
		e.other:SummonItem(2284);--Skinned Halfling Face Mask
		e.other:Faction(322, -30);--The Dead
		e.other:Faction(331, 10);--The Spurned
	
	elseif(item_lib.check_turn_in(e.trade, {item1 = 18957})) then--Leatherfoot Raider Orders
