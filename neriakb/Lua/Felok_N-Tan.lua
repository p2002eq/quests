function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Welcome to my shop, " .. e.other:GetName() .. ". I am Felok N'Tan, master smith of steel and [adamantite plate] armors. I am also the creator of the [dragoon shields] favored by members of the Indigo Brotherhood.");
	end
	if(e.message:findi("what adamantite plate")) then
	...
	if(e.message:findi("what dragoon shields")) then
		e.self:Say("Dragoon shields can only be crafted in our unique Teir'Dal forge here in Neriak. If you desire to craft one, you will require a kite shield mold, two sheets of adamantite, a Teir'Dal smithy hammer, and some shadow temper. If you are a proud follower of our Lord of Hate you may wish to attempt to create a magical dragoon shield. In order to do so, you will need to forge a sapphire, imbued by a cleric, into the shield at the time of its creation."); end
	end
end
