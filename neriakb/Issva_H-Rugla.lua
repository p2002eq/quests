...
function event_say(e)
	...
	elseif(e.message:findi("materials")) then
		e.self:Say("Many species of dangerous creatures, the walking dead, and invading Deathfist Orcs inhabit the Nektulos Forest. You must defeat these creatures and undead in order to obtain the materials. The materials you seek depend on the piece of armor you desire. Do you desire to craft [" .. eq.say_link("gauntlets") .. "], [" .. eq.say_link("boots") .. "], a [" .. eq.say_link("bracer") .. "], a [" .. eq.say_link("helm") .. "], [" .. eq.say_link("greaves") .. "], [" .. eq.say_link("vambraces") .. "], or a [" .. eq.say_link("breastplate") .. "]?");
