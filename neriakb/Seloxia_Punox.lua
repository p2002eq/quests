function event_say(e)
	...
	elseif(e.message:findi("mistress")) then
		e.self:Emote("maintains her imposing posture as she indifferently eyes " .. e.other:GetName() .. ", 'You stand now in the Cauldron of Hate -- the Indigo Brotherhood. We are an organization of Neriak's finest warriors whom remain dedicated to Neriak, the Dark Father, and our founder -- his majesty, King Naythox Thex. I am Seloxia Punox, second to only his majesty in command of the Brotherhood. From the Cauldron of Hate, we maintain the protection of the city both within our city walls and beyond in the forest of Nektulos. Perhaps you would wish to prove yourself worthy of our ranks and perform a [" .. eq.say_link("little test") .. "] of your skills and dedication?'");
	elseif(e.message:findi("little test")) then
		e.self:Say("My little test is this. I desire a report from Ambassador K'Rynn in the Ogre city of Oggok. You shall run to him. I will not wait until you raise your fighting skills. Combat is not your test. Overcoming the odds is. Fast agile warriors are we. We desire nothing less. Will you [" .. eq.say_link("venture to Oggok") .. "]?");
