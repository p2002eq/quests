...
function event_hate_list(e)
	if(e.other:IsClient() and e.other:GetLevel() > 52 and e.joined == true) then --and (e.other:Admin() < 80)) then
		eq.zone_emote(0, "I will not fight you, but I will banish you!");
		--e.other:CastToClient():MovePC(27, -64, 262, -93.96, 0);
		e.other:MovePC(27, -64, 262, -93.96, 0);
	end
end
