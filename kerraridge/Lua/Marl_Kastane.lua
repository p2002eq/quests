...
function event_say(e)
	...
	if(e.message:findi("will of Innoruuk")) then
	...
	if(e.message:findi("prophecy") and e.other:GetFaction(e.self) >= 42 and e.other:GetFaction(e.self) < 44) then
	...
	if(e.message:findi("prophecy") and e.other:GetFaction(e.self) >= 44) then
	...
	if(e.message:findi("Lhranc") and e.other:GetFaction(e.self) >= 44) then
	...
	if(e.message:findi("one") and e.other:GetFaction(e.self) >= 44) then
	...
	if(e.message:findi("curse") and e.other:GetFaction(e.self) >= 44) then
	...
	if(e.message:findi("prediction") and e.other:GetFaction(e.self) >= 44) then
	...
	if(e.message:findi("secret plan") and e.other:GetFaction(e.self) >= 44) then
	...
	if(e.message:findi("I will complete the ritual") and e.other:GetFaction(e.self) >= 44) then
...
function event_trade(e)
	...
	e.other:GetFaction(e.self) = e.self:GetCharacterFactionLevel(342);
	-- [FLAG: Manual conversion needed: $item] if($itemcount {14376} == 1 && e.other:GetFaction(e.self) >= 43) then {
	...
	-- [FLAG: Manual conversion needed: $item] if($itemcount {14381} == 1 && e.other:GetFaction(e.self) >= 51) then {
	...
	-- [FLAG: Manual conversion needed: $item] if($itemcount {14379} == 1 && e.other:GetFaction(e.self) >= 58) then {
