function event_say(e)
	...
	if(e.message:findi("what stories")) then
	...
	if(e.message:findi("i want to listen")) then
	...
	if(e.message:findi("what legends")) then
	...
	if(e.message:findi("what golden time")) then
	...
	if(e.message:findi("what united")) then
	...
	if(e.message:findi("what destroyed")) then
	...
	if(e.message:findi("what old customs and traditions")) then
	...
	if(e.message:findi("what males")) then
