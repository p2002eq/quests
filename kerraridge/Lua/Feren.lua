...
function event_say(e)
	...
	if(e.message:findi("what razortooth")) then
...
function event_trade(e)
	...
	-- [FLAG: Manual conversion needed: $itemcount{] if(($itemcount{6348} == 1)) then{ --Razor Tooth
		e.self:Say("Rarr, Feren not haunted by Razortooth no more. Feren grateful and give you this possession.");
		e.other:SummonItem(1062); --Kerran Fishingpole
