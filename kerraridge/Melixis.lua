function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hello, hairrrrless one.  Welcome to the ourrrrr island. As you browse my wares please tell me if you would like to see my [" .. eq.say_link("shiny tings") .. "] that I have gathered from all over the world.");
	elseif(e.message:findi("shiny tings")) then
		e.self:Say("I thought you looked like one who is would be interested in them.  I have a [" .. eq.say_link("dull ring") .. "], a [" .. eq.say_link("kinda shiny ring") .. "] and a [" .. eq.say_link("really shiny ring") .. "].  These are just a few of the items that I have collected in my jourrrrneies, but I would be willing to parrrrt with them for a prrrrice");
