function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("What?  What do you want. furless?  My tseq. Graalf. lies sick and you waste time with talk when you [" .. eq.say_link("cannot help") .. "].");
	elseif(e.message:findi("cannot help")) then
		e.self:Say("The shamans. they have said I need [" .. eq.say_link("talismans") .. "] to ward the sickness from Graalf.");
