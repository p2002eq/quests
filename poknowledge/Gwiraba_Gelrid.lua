--Gwiraba_Gelrid (202043)
--Zone:  Plane of Knowledge
--Advanced Combat Manual

function event_say(e)
	if(e.message:findi("Hail")) and e.other:HasItem(28790) then	--Requires Intermediate Combat Manual
	...
	elseif(e.message:findi("Hail")) then
		e.self:Say("Good day to you, " .. e.other:GetName() .. ".  Are you new to this city or have you been a long time resident?  I'm afraid I do not get to run about and explore like I used to, as my studies keep me quite busy.  If you have the time and inclination, I would suggest you explore the land some more.  Then perhaps one day when you return, you will be ready to learn what I have to teach you.");
	end
end
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 22503, item2 = 26697, item3 = 9421, item4 = 28790})) then--Blue Diamond, Rage Filled Gem, Sandstorm Gem, Intermediate Combat Manual
		...
		e.other:QuestReward(e.self,0,0,0,0,28791,500000); --Advanced Combat Manual
	end
