...
function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Greetings, " .. e.other:GetName() .. ". Have you come to see my exhibit? I am honored but also sad to say it is incomplete. Mine will be the finest presentation of musical history you will find, once I finish assembling my display. If you have some free time, perhaps you could help me collect some still missing [pieces]?");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 28080})) then--Collection of Instruments
