...
function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Greetings, " .. e.other:GetName() .. ". Have you come to see my exhibit? I am honored but also sad to say it is incomplete. Mine will be the finest presentation of musical history you will find, once I finish assembling my display. If you have some free time, perhaps you could help me collect some still missing [" .. eq.say_link("pieces") .. "]?");
	elseif(e.message:findi("pieces")) then
		e.self:Say("'I need you to bring me a Minotaur Horn, Tambourine of Rituals, Orcish Lute of Singing, and a Stretched Skin Drum. If you could find these for me, I would be most overjoyed. You will need to get a Collector's Box from [" .. eq.say_link("Merri") .. "] to keep them in. Close the box up tightly and return it to me once you have placed the instruments inside. Hurry back and we shall have a grand festival!");
