function event_say(e)
	if(e.message:findi("Hail")) then
		...
		e.self:Say("'Would you like to be ported to the [" .. eq.say_link("Arena") .. "], [" .. eq.say_link("Jaggedpine") .. "] or the [" .. eq.say_link("Plane of Mischief") .. "]? I can also [" .. eq.say_link("Trust is my god and he will bless me with buffs",false,"Buff you") .. "]");
		e.self:Say("Also please stop leaving your [" .. eq.say_link("corpses") .. "] around.");
