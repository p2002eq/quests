...
[7] = {"What company developed and released classic everquest?","SONY / VERANT"},
[8] = {"What is the BEST MMORPG?","EVERQUEST"},
[9] = {"What is the shortest playable race in everquest?","GNOME / HALFLING"},
[10] = {"How many years has P2002 been around?","3"},
[11] = {"Ruins of ...?","KUNARK"},
[12] = {"What was the 2nd expansion of everquest called?","SCARS OF VELIOUS / SOV"},
[13] = {"Shadows of ...?","LUCLIN"},
[14] = {"What was the 4th expansion of everquest called?","PLANES OF POWER / POP"},
...
[18] = {"Which newbie zone has a giant chess board?","BUTCHERBLOCK / BB"},
[19] = {"How many coppers does it take to match a platinum?","1000"},
[20] = {"What zone would you go to if you were trying to obtain Baby Joseph Sayer ","BLACKBURROW / BB"},
[21] = {"Who rules Karnor's Castle","VENRIL / VS"},
...
[26] = {"What p2002 player is most OBSESSED with food?","GREENGROCER / GG"},
[27] = {"What staff member gets a thrill out of illusioning others?","CHUNKY"},
[28] = {"What is the name of Venril Sathir's wife?","DRUSELLA"},
[29] = {"What is also commonly referred to as Ranger Gate?","DYING / DEATH / DIE / DIED"},
...
[39] = {"What God is known as The Warlord?","RALLOS ZEK / RZ"},
[40] = {"What does Xegony stand for?","OXYGEN"},
[41] = {"What player on p2002 had the first epic?","UTINEN"},
[42] = {"What God is known as The Plaguebringer","BERTOX / BERT"},
[43] = {"Who is The Mother of All?","TUNARE"},
[44] = {"Who is the King of Thieves?","BRISTLEBANE / BB"},
[45] = {"Finish the Pattern.  Gorenaire, Trakonaon, Talendor...","SEVERILOUS / SEV"},
	...
	elseif(e.message:findi("ready")) then
		...
		if (players[playerId] ~= nil) then
			...
			for k, v in pairs(questions) do
				if (string.match(v[2],e.message:upper())) then
					if (string.match(players[playerId][3], e.message:upper())) then
						correct = true;
