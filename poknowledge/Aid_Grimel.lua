...
function event_say(e)
	...
	if(e.message:findi("hail")) then
		...
		if(tonumber(qglobals.pop_cod_final) == 1 and tonumber(qglobals.pop_cod_final) == 1) then --Must have killed Bertox and rescued Mylik and Adler
			if(e.message:findi("master of trades")) then
			...
			if(e.message:findi("brewing skill") and e.other:HasItem(16249)) then --Hardened Leather Signet
			...
			if(e.message:findi("jewel craft skills to the test") and e.other:HasItem(16250)) then --Clay Signet
			...
			if(e.message:findi("skilled with the needle") and e.other:HasItem(16252)) then --Metal Signet
			...
			if(e.message:findi("fletching knife") and e.other:HasItem(1079)) then --Marked Signet
