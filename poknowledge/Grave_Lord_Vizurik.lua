...
function event_trade(e)
	...
	if((item_lib.check_turn_in(e.self, e.trade, {item1 = 5166})) or (item_lib.check_turn_in(e.self, e.trade, {item1 = 5167})) or (item_lib.check_turn_in(e.self, e.trade, {item1 = 5168})) or (item_lib.check_turn_in(e.self, e.trade, {item1 = 5169})) or (item_lib.check_turn_in(e.self, e.trade, {item1 = 5171})) or (item_lib.check_turn_in(e.self, e.trade, {item1 = 5172})) or (item_lib.check_turn_in(e.self, e.trade, {item1 = 5173}))) then --Greenmist Armor
