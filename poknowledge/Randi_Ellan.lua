...
function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("And a good morning to you as well, " .. e.other:GetName() .. ". I can see by the gleam in your eye you are interested in learning more about the flowers of Norrath. Sadly my exhibit is not much to speak of. I require new [specimens] to help build my collection.");
