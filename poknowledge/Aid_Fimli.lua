...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings " .. e.other:GetName() .. "! I wish I had time to chatter but my [" .. eq.say_link("duties") .. "] to the list and the Grand Librarian keep me extremely busy.");
	elseif(e.message:findi("duties")) then
		e.self:Say("I am the aid for the Grand Librarian and he has me cataloging tomes on the master list. I spend so much time working on the list I haven't had time to go collect these items from the planes my uncle in Ak'Anon keeps pestering me over. He wants to upgrade his scrapyard back in Ak'Anon, and says only these items will do. Would you be willing to do me a [" .. eq.say_link("favor") .. "]?");
