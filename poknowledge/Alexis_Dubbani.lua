...
function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Why hello there. " .. e.other:GetName() .. ".  I'm so glad you could take the time to see my exhibit.  I am a collector of [" .. eq.say_link("books") .. "]. and I seek many more volumes of strange and wonderful texts.  Perhaps I could hire your services to help me find some more?");
	elseif(e.message:findi("books")) then
		e.self:Say("I am still looking for the following. Please locate a Black Tome with Silver Runes, Tome of the Eternal, Codex of the Warrior, and a Book of Inspiration. Please store them inside a Collector's Box you can get from [" .. eq.say_link("Merri") .. "] for safekeeping. After you find all the books, be sure to close the box and return it to me. I appreciate your help.");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 28078})) then
