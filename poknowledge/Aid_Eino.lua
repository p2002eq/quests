function event_say(e)
	...
	if(qglobals["AidEinoDone"] ~= nil and (qglobals["AidEinoDone"] == 1)) then
		...
		if(e.message:findi("hail")) then
			e.self:Say("Greetings " .. e.other:GetName() .. "! I am Eino, Monk of Quellious and Aid to Councilwoman Kerasha! I spend my time as protector to the councilwoman as well as taking small jaunts to the planes to obtain items for her magic research. If you be a hearty individual with some allies you may be able to [" .. eq.say_link("help") .. "] me.");
		end
