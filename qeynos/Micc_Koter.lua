...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13034})) then
		e.self:Say("Oh yes. Now I remember.. Ha ha.. He said he was going into the Plains of Karana to look for some gnoll lover by the name of Caninel. He said Caninel knew something about the location of the [" .. eq.say_link("Paw of Opolla") .. "]. It sounds like a bunch of rat crap to me , I never heard of no one named Caninel. But off he went.. Heck , finding one person in the Plains of Karana without a [" .. eq.say_link(" ranger ") .. "] to guide you is like looking for a clean spot on ol'Klieb here. Ha ha!!");
	end
...
function event_signal(e)
	...
	elseif(e.signal == 2) then
		e.self:Say("Lighten up, will ya, Klieb? You act like a dang [" .. eq.say_link("gnoll") .. "] sometimes..");
	end
end