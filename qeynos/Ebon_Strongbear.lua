function event_say(e)
	...
	elseif(e.message:findi("I want to craft Bracers")) then
	...
	elseif(e.message:findi("I want to craft Armguards")) then
	...
	elseif(e.message:findi("I want to craft Boots")) then
	...
	elseif(e.message:findi("I want to craft Greaves")) then
	...
	elseif(e.message:findi("I want to craft Gauntlets")) then
