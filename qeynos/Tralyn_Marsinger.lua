...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 18150}) or item_lib.check_turn_in(e.trade, {item1 = 18151}) or item_lib.check_turn_in(e.trade, {item1 = 18153}) or item_lib.check_turn_in(e.trade, {item1 = 18154})) then
