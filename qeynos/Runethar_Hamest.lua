...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Welcome to the Temple of Thunder. We are home to paladins and clerics who follow the ways of Karana. Do you [" .. eq.say_link("need guidance") .. "] or are you [" .. eq.say_link("already a follower of Karana") .. "]?");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18710})) then
		...
		e.other:AddEXP(100);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 18809,item2 = 6357})) then
		e.self:Say("Antonius Bayle will be pleased. The Temple is also pleased. Here is the enchanted staff we call Bonethunder. Should you find the enchantment gone, just ask Kasine to [" .. eq.say_link("enchant Bonethunder") .. "]. We need more disciples like you! Go forth to tell the world of the Rainkeeper.");
