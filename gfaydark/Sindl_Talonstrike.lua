function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings.  Is not Kelethin the most glorious city you have seen?  A part of the forest itself. it is.  The forest is our life force.  It shelters us and we feed from its vegetation.  The [" .. eq.say_link("Soldiers of Tunare") .. "] have [" .. eq.say_link("harvesters") .. "] upon the grounds at all times.  We have our hunters.");
