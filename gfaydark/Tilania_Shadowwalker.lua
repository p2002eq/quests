function event_say(e)
	...
	elseif(e.message:findi("i am a rogue of tunare")) then
		e.self:Say("Excellent " .. e.other:GetName() .. ". let us get started then. Your training will test your fighting and gathering skills respectively. because of the items you will be required to gather all over the Faydark for [magical armor materials].");
