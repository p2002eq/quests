...
function event_say(e)
	...
	elseif(e.message:findi("acquisition")) then
	...
	elseif(e.message:findi("obligation")) then
	...
	elseif(e.message:findi("possession") or e.message:findi("detachment") or e.message:findi("rupturing") or e.message:findi("haunting") or e.message:findi("suffering") or e.message:findi("collection") or e.message:findi("requisition")) then
