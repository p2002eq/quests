...
function event_say(e)
	...
	elseif(e.message:findi("veltar")) then
		e.self:Emote("'s soiled face shines with a glint of hope. 'You know my name? Who has [" .. eq.say_link("Master Rinmark sent me",false,"sent") .. "] you to find me?'");
	elseif(e.message:findi("master rinmark sent")) then
		e.self:Say("Then word has gotten to him!! If you be a monk of the third rung I will accept your aid. You must find the [" .. eq.say_link("coppernickel key") .. "]. It is required to release me from this goblin shackle. I have no reward to offer other than the shackle of steel. Give me both your shackles of the third rung along with the key and I shall reward you the first shackle of the fourth rung.");
