...
-- Flags Used: pop_poj_mavuin, pop_poj_tribunal, pop_poj_lashing
--
-- Event NPCS:
...
local trial_z           = 1;
local trial_h           = 60;
local trial_mobs		= { 201460, 201455, 201463, 201465, 201457, 201458, 201461, 201459 };
...
function event_say(e)
   ...
   if (qglobals["pop_poj_mavuin"] ~= nil) then -- Have talked to Mavuin
      if (e.message:findi("hail")) then 
         e.self:Emote("fixes you with a dark, peircing gaze. 'What do you want, mortal? Are you [" .. eq.say_link("prepared") .. "]?");
