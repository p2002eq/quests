...
function spawn_spirits()
   ...
   eq.spawn2( 201458, 0, 0, 1350, -1127, 2, 124); -- #A_Scourge_of_Honor
end

function spawn_mobs(wave)
   if (wave < 5) then
      eq.spawn2( eq.ChooseRandom( 201463, 201456, 201457, 201460 ), 0, 0, 1395, -1169, 1, 128 );
      eq.spawn2( eq.ChooseRandom( 201463, 201456, 201457, 201460 ), 0, 0, 1378, -1169, 1, 128 );
      eq.spawn2( eq.ChooseRandom( 201463, 201456, 201457, 201460 ), 0, 0, 1395, -1070, 1, 128 );
      eq.spawn2( eq.ChooseRandom( 201463, 201456, 201457, 201460 ), 0, 0, 1378, -1070, 1, 128 );
...
function spawn_prisoners()
   -- a tortured prisoner
   eq.spawn2(201455, 0, 0, 1417, -1168, 1, 392); -- #a_tormented_prisoner
   eq.spawn2(201455, 0, 0, 1417, -1120, 1, 392); -- #a_tormented_prisoner
   eq.spawn2(201455, 0, 0, 1417, -1072, 1, 392); -- #a_tormented_prisoner
end
