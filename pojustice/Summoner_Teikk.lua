...
function event_say(e)
    if(e.message:findi("Hail")) then
        e.self:Emote("crosses his arms and regards you down the length of his nose.  'Wood Elf, it is well.  We of the upright caste have been having increasing difficulty in managing relations with the menagerie of aberrations to the [" .. eq.say_link("south") .. "].");
