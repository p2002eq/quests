...
function event_say(e)
    if(e.message:findi("Hail")) then
        e.self:Emote("looks down, his dark eyes burrowing into yours.  'My prison is not one for casual visits, Wood Elf.  What is your business here?  Do you seek an [" .. eq.say_link("audience with the Tribunal") .. "]?'");
