...
function spawn_spirit(spirit_id)
	...
	-- Spawn the Mob
	eq.spawn2( spirit_id, 0, 0, (490 + spirit_x[steps]), -1139, 73,250.0);
...
function spawn_mobs()
	...
	eq.spawn2( eq.ChooseRandom( 201456, 201457, 201458, 201459),  0, 0,440.0, -1093, 73, 124 );
	eq.spawn2( eq.ChooseRandom( 201456, 201457, 201458, 201459),  0, 0,536.0, -1093, 73, 124 );
end

function spawn_boss()
	-- Spawn the Gallows Master Teion
	eq.spawn2( 201461, 0, 0, 488, -1068, 73,250.0);
...
function spawn_prisoners()
	...
	eq.spawn2( 201471, 0, 0, 440, -1175, 80,510.0);
	eq.spawn2( 201472, 0, 0, 490, -1175, 80,510.0);
	eq.spawn2( 201473, 0, 0, 540, -1175, 80,510.0);
end
