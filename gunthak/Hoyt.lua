...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 359500})) then -- Small White Drum
		e.other:SummonItem(321820); -- Bag of Platinum Pieces
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 359501})) then -- White Drum
		e.other:SummonItem(321821); -- Heavy Bag of Platinum
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 359502})) then -- Large White Drum
		e.other:SummonItem(321822); -- Big Bag of Platinum
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 359503})) then -- Giant White Drum
