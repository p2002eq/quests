...
function event_trade(e)
    ...
    if(item_lib.check_turn_in(e.self, e.trade, {item1 = 358001, item2 = 358002}) and e.other:GetClass() == 13) then -- Flicker of Lava, Flicker of Sea
    ...
    elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 358004}) and e.other:GetClass() == 13) then -- Note to Vera
        ...
        e.other:QuestReward(e.self,0,0,0,0,359017,150000); -- Spell: Primal Remedy, ~2% exp at lvl 44

    elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 358005, item2 = 358005, item3 = 358005}) and e.other:GetClass() == 13 ) then -- 3x Strength of Lava
    ...
    elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 358006}) and e.other:GetClass() == 13) then -- Scribed Runes
        ...
        e.other:QuestReward(e.self,0,0,0,0,359018,500000); -- Spell: Elemental Empathy, ~2% exp at lvl 52
    end
