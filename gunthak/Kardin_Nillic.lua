...
function event_say(e)
    if(e.other:GetClass() == 8) then -- Bard
...
function event_trade(e)
    ...
    if(e.other:GetClass() == 8 and item_lib.check_turn_in(e.self, e.trade, {item1 = 359022})) then -- Faded, Watermarked Book
        ...
        e.other:SummonItem(359023) -- Faded Songbook;
    ...
    elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 359024})) then -- Transcribed Songbook
        ...
        e.other:QuestReward(e.self,0,0,0,0,359002,eq.ExpHelper(51)); -- Song: Aria of Asceticism
    end
