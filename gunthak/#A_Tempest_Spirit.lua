...
function event_trade(e)
    ...
    if(item_lib.check_turn_in(e.self, e.trade, {item1 = 359041}) and e.other:GetClass() == 4) then -- Cracked Zraxthril Amulet
        ...
        e.other:QuestReward(e.self,0,0,0,0,359008,500000); -- Spell: Icewind, ~2% exp at lvl 52
        eq.depop();
    end
