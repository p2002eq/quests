...
function event_trade(e)
    ...
    if(item_lib.check_turn_in(e.self, e.trade, {item1 = 359061, item2 = 359062})) then -- Golden Emblem (Symbol of Tunare) and Golden Emblem (Symbol of Karana)
        e.self:Emote("gasps as you hand him the two symbols. 'I am in your debt, $name. There is nothing I can ever do to repay you, but I can at least teach you of the healing water that Tunare has shown me how to control. Take this scroll, I pray to Tunare that it will serve you well.' ");
        e.other:QuestReward(e.self,0,0,0,0,359014,1000); -- Spell: Healing Water
    end
