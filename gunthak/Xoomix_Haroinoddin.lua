...
function event_trade(e)
	...
	elseif(qglobals["Helping_Xoomix"] == "1" and item_lib.check_turn_in(e.self, e.trade, {item1 = 321980, item2 = 321981, item3 = 321982, item4 = 321983})) then -- Xoomix's Quarterstaff, Metallic Oil, Silvered Micro Servos, Xoomix's Toolbox
    ...
    elseif(qglobals["Helping_Xoomix"] == "1" and item_lib.check_turn_in(e.self, e.trade, {item1 = 321985})) then -- Xoomix's Gearbox
