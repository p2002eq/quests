...
function event_say(e)
    ...
    elseif(e.message:findi("Enchanter")) then
        if (e.other:GetClass() == 14 and e.other:GetSkill(58) > 100) then -- Enchanter
    ...
    elseif(e.message:findi("Wizard")) then
        if (e.other:GetClass() == 12 and e.other:GetSkill(58) > 100) then -- Wizard
    ...
    elseif(e.message:findi("Magician")) then
        if (e.other:GetClass() == 13 and e.other:GetSkill(58) > 100) then -- Magician
    ...
    elseif(e.message:findi("Necromancer")) then
        if (e.other:GetClass() == 11 and e.other:GetSkill(58) > 100) then -- Necromancer
