function event_say(e)
	if(e.message:findi("what realm of heroes")) then
		e.self:Say("Me dund 'xactly know wat dat is. but me kno' me part o'it. Me hero 'cause [" .. eq.say_link("Cazic") .. "] sed so.  Der many heroes from Norrath in it.  Me not as smart as [" .. eq.say_link("Kizrak the Tyrant") .. "] but me jus' as strong.  Me 'pose to find heroes like me dat like to bash dorfs an' dund like gud things.");
	...
	elseif(e.message:findi("kizrak the tyrant")) then
