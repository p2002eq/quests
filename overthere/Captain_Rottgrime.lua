...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 12982, item2 = 12982, item3 = 12982, item4 = 12982})) then
		...
		e.other:QuestReward(e.self,0,0,1,0,12981,112000); --Guard of the Marines
	end
