...
function event_say(e)
	...
	elseif(e.message:findi("Curse")) then
		e.self:Emote("twists his face into a frown and says, 'You read what's written, Iksar. It's clear enough so we won't bother to explain the details. We can only stand our guard and hope for [redemption].");
