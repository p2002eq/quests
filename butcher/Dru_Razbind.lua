function event_say(e)
	...
	elseif(e.message:findi("important task")) then
		e.self:Say("I was ordered by Lord Nightseer to carry the [" .. eq.say_link("Chalice of Conquest") .. "] to a noble band of paladins in the mountains of Rathe. While there, the entire camp was overtaken by a band of orcs. During the battle there was a [strange occurrence].");
