...
function event_say(e)
	...
	if(e.message:findi("battle")) then
	...
	if(e.message:findi("courage")) then
	...
	if(e.message:findi("Ambreen")) then
	...
	if(e.message:findi("snowstorm")) then
	...
	if(e.message:findi("shelter")) then
	...
	if(e.message:findi("slumber")) then
	...
	if(e.message:findi("strange image")) then
