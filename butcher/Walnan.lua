...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 28036, item2 = 28037, item3 = 28038, item4 = 28039})) then -- Power of Fire, Power of Wind, Power of Earth and Power of Water
		...
		e.other:QuestReward(e.self,0,0,0,0,28031,500); -- Power of the Elements
	end
