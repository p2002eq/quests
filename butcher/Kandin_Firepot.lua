function event_say(e)
	...
	if(defined qglobalswizepicKend) then
...
function event_trade(e)
	...
	elseif(defined qglobalswizepicKend and item_lib.check_turn_in(e.trade, {item1 = 14349})) then
	...
	elseif(defined qglobalswizepicKend and item_lib.check_turn_in(e.trade, {item1 = 14333, item2 = 14332})) then
		e.other:SummonItem(14339); --Staff of Gabstik
		...
		eq.delete_global("wizepicK");
		e.other:Faction(342, 30); --Truespirit
	elseif(defined qglobalswizepicKend and item_lib.check_turn_in(e.trade, {item1 = 14332, item2 = 14332})) then
