...
function event_say(e)
	if(e.message:findi("hail") and shmskullquest >= 8) then
	...
	if(e.message:findi("Give me the skull of the sisters of scale") and shmskullquest >= 8) then
	...
	if(e.message:findi("I will help you obtain the skull") and shmskullquest >= 8) then
...
function event_trade(e)
	...
	y = e.self:GetY();
	z = e.self:GetZ();
	if(item_lib.check_turn_in(e.trade, {item1 = 12764}) and shmskullquest >= 8) then
		...
		eq.unique_spawn(87154,0,0,x + 5,y,z);
