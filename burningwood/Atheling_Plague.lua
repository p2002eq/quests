...
function event_say(e)
	...
	if(qglobals["shmskullquest"] ~= nil) then
		if(e.message:findi("hail") and tonumber(qglobals["shmskullquest"]) > 7) then
		...
		elseif(e.message:findi("Give me the skull of the sisters of scale") and tonumber(qglobals["shmskullquest"]) > 7) then
		...
		elseif(e.message:findi("I will help you obtain the skull") and tonumber(qglobals["shmskullquest"]) > 7) then
