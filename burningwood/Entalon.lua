function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Emote("smiles at you with a wide grin.");
		e.self:Say("You are quite brave to approach me and speak. On any other day, I would not give you the opportunity. Fortunately for you, I am preoccupied with my master's [quest].");
	end
	if(e.message:findi("quest")) then
