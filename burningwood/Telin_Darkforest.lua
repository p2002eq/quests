	...
	if(e.other:GetFaction(e.self) <= 4) then
		...
		elseif(e.message:findi("action")) then
			if(e.other:GetLevel() > 45) then
				...
				e.other:SummonItem(20472); -- Worn Note
			else
...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) <= 4) then
		if(item_lib.check_turn_in(e.self, e.trade, {item1 = 20447})) then -- Dark Metal Coin
			...
			e.other:QuestReward(e.self,0,0,0,0,20448,100); -- Worn Dark Metal Coin
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 20468})) then -- Warmly Glowing Stone
			...
			e.other:QuestReward(e.self,0,0,0,0,20477,1000000); -- Ancient Longsword
		elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 20481})) then -- Refined Ancient Sword
			...
			eq.spawn2(54237,0,0,2852,3239,-155,219); -- Faelin Bloodbriar
		end
	end
