...
function event_say(e)
	if(faction < 4) then
		...
		if(e.message:findi("what are you doing")) then
		...
		if(e.message:findi("answers")) then
		...
		if(e.message:findi("suspect")) then
		...
		if(e.message:findi("innoruuk")) then
		...
		if(e.message:findi("action")) then
