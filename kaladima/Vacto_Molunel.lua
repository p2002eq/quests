function event_say(e)
	...
	elseif(e.message:findi("what rare talent")) then
	...
	elseif(e.message:findi("what scarab helms")) then
	...
	elseif(e.message:findi("what scarab breastplates")) then
	...
	elseif(e.message:findi("what scarab boots")) then
