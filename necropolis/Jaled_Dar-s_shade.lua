...
function event_trade(e)
	...
	if(item_lib.check_turn_in((e.self, e.trade, {item1 = 9296}) or (e.self, e.trade, {item1 = 27255}) or (e.self, e.trade, {item1 = 27256}) or (e.self, e.trade, {item1 = 27258}) or (e.self, e.trade, {item1 = 27259}) or (e.self, e.trade, {item1 = 27266}))) then -- Sack of Hay
