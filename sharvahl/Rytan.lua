...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 2877})) then
		...
		e.other:QuestReward(e.self,0,0,0,0,17231);
	end
	if(item_lib.check_turn_in(e.trade, {item1 = 3461})) then
		...
		e.other:SummonItem(3463,2);
		e.other:QuestReward(e.self,0,0,0,0,3464);
	end
	if(item_lib.check_turn_in(e.trade, {item1 = 3464, item2 = 3464, item3 = 3464, item4 = 3464})) then
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 3467})) then
		...
		e.other:SummonItem(3467);
		e.other:QuestReward(e.self,0,0,0,0,3471);
	end
	if(item_lib.check_turn_in(e.trade, {item1 = 3472})) then --Grimling Dart Crafting Tool
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 3474})) then
		...
		e.other:SummonItem(3474);
		e.other:QuestReward(e.self,0,0,0,0,3477);
	end
