...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 7285})) then -- Claw of the High Grimling
		e.other:Faction(132,2); -- Guardians of Shar Vahl
		e.other:QuestReward(e.self,0,0,0,0,7286,500); -- Claw of the Grimling Slayer
	end
	if(item_lib.check_turn_in(e.trade, {item1 = 7295})) then -- Dirk of the High Grimling
		e.other:Faction(132,2); -- Guardians of Shar Vahl
		e.other:QuestReward(e.self,0,0,0,0,7296,500); -- Dirk of Grimling Slaying
	end
	if(item_lib.check_turn_in(e.trade, {item1 = 7289})) then -- Great Sword of the High Grimling
		e.other:Faction(132,2); -- Guardians of Shar Vahl
		e.other:QuestReward(e.self,0,0,0,0,7290,500); -- Great Sword of Grimling Slayer
	end
	if(item_lib.check_turn_in(e.trade, {item1 = 7291})) then -- Hammer of the High Grimling
		e.other:Faction(132,2); -- Guardians of Shar Vahl
		e.other:QuestReward(e.self,0,0,0,0,7292,500); -- Hammer of Grimling Slayer
	end
	if(item_lib.check_turn_in(e.trade, {item1 = 7287})) then -- Short Sword of the High Grimling
		e.other:Faction(132,2); -- Guardians of Shar Vahl
		e.other:QuestReward(e.self,0,0,0,0,7288,500); -- Short Sword of Grimling Slayer
	end
	if(item_lib.check_turn_in(e.trade, {item1 = 7293})) then -- Staff of the High Grimling
		e.other:Faction(132,2); -- Guardians of Shar Vahl
