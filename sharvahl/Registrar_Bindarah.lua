...
function event_say(e)
	...
	if(e.message:findi("certificate") and tonumber(qglobals.Shar_Vahl_Cit) == 2) then
		...
		e.other:SummonItem(2874); -- Certificate of Taxability
	elseif(e.message:findi("note") and tonumber(qglobals.Shar_Vahl_Cit) == 4) then
		...
		e.other:SummonItem(18299); -- Note to King Raja
	elseif(e.message:findi("application") and tonumber(qglobals.Shar_Vahl_Cit) == 6) then
		...
		e.other:SummonItem(2897); -- Notarized Application
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 2873})) then -- Application for Citizenship
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 2875, item2 = 2876})) then -- Stamped Certificate of Taxability & Acrylia Slate
		...
		e.other:QuestReward(e.self,0,0,0,0,18299,500); -- Note to King Raja
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 18304})) then -- Note from King Raja
		...
		e.other:Faction(483,400); -- Citizens of Sharvahl
		e.other:QuestReward(e.self,0,0,0,0,2897,500); -- Notarized Application
	end
