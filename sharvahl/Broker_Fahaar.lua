...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hello " .. e.other:GetName() .. ", if you know any citizens looking for work please tell them to show me their acrylia slate.");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 2877})) then -- Acrylia Slate of Shar Vahl
		...
		e.other:SummonItem(17236); -- Young Hopperhide Sack
		e.other:QuestReward(e.self,0,0,0,0,2877); -- Acrylia Slate of Shar Vahl
	end
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3661})) then -- Full Hopperhide Sack
		e.self:Say("Very nice. I thank you " .. e.other:GetName() .. ". Here is the stretched hide I promised and a leather cord I made from the scraps. If you have no need for the hide itself, any merchant will purchase it from you. If you desire to become my apprentice, save four of the cords that you earn from me and return them when you desire to learn more. May the spirits guide and protect you!");
		e.other:SummonItem(3655); -- Stretched Hopperhide
		e.other:QuestReward(e.self,0,0,0,0,3656,500); -- Leather Cord
	end
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3656, item2 = 3656, item3 = 3656, item4 = 3656})) then -- Leather Cord x 4
		e.self:Say("So you wish to learn the way of the Vah Shir tailors, do you? I assure you it is among the most difficult to master of any of the great Vah Shir disciplines, but one of the most rewarding as well. If you truly wish to learn how to manipulate fabrics and materials of all types you'll have to start with a basic task. Take this Vah Shir skinning knife and use it to cut a [" .. eq.say_link("belt strap") .. "]. Once you feel that you've mastered that task, bring me an example of your work and the Vah Shir skinning knife I gave you and we'll start you on some needle work.");
		e.other:QuestReward(e.self,0,0,0,0,3913,500); -- Vah Shir Skinning Knife
	end
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3922})) then -- Rough Belt Strap
		e.self:Emote("briefly glances at the strap and throws it over his shoulder. He then says");
		e.self:Say("I can tell it's hurried work, but it will do. I suppose you're ready to learn some needlework. The needlework really makes the belt. Here, this needle set will allow you to learn the basics of our trade. You'll want to practice on some [" .. eq.say_link("Black Chitin Belts") .. "] and some [Bone Beaded Belts]. Bring me one example of each of these and your needle set to show me that you've mastered the basics of this sort of needlework. If your work is good enough you might be able to sell a piece or two as well.");
		e.other:QuestReward(e.self,0,0,0,0,3914,500); -- Vah Shir Needle Set
	end
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3914, item2 = 3924, item3 = 3925})) then -- Vah Shir Needle Set, Bone Beaded Belt & Black Chitin Belt
		e.self:Say("You're getting better, " .. e.other:GetName() .. ", these are very well done. I believe you're ready to take the acrylia needle that is so necessary to our work. With this needle you'll be able to pierce even the toughest hides almost effortlessly, as well as to stitch the most delicate fabrics without tearing them. The first thing you should work on with this needle are some [" .. eq.say_link("Owlbear feathered leggings") .. "]. When you have managed to fashion a set of these, bring them to me with your acrylia needle and I'll provide the final tool for your journey toward master tailor.");
		e.other:QuestReward(e.self,0,0,0,0,3915,500); -- Acrylia Needle
	end
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3915, item2 = 3926})) then --Acrylia Needle, Owlbear Feathered Leggings
		e.self:Say("Well done, " .. e.other:GetName() .. ". These leggings are truly the work of an aspiring master tailor. I have just received word from the palace that the king is planning a celebration in the near future, and he wishes the guards to have new uniforms. Take this case and fill it with [" .. eq.say_link("owlbear hide tunics") .. "] and take it to Elder Hymnist Hortitosh on the roof of the palace. I'm sure the king will be pleased with your work.");
		e.other:SummonItem(3916); -- Acrylia Thimble and Needle Set
		e.other:QuestReward(e.self,0,0,0,0,17109,500); -- Clothing Case
	end
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3921})) then -- Order Receipt
		e.self:Say("Well done, " .. e.other:GetName() .. ". You have done very well and the king is pleased. You have been a great help to me filling that order for the king. Here, take this jerkin and wear it with pride. All who see it will know that you are an accomplished tailor and a friend of Fahaar!");
		e.other:QuestReward(e.self,0,0,0,0,3927,1000); -- Sleek Sonic Wolf Hide Jerkin
	end
