...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 3661})) then --Full Hopperhide Sack
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 3656, item2 = 3656, item3 = 3656, item4 = 3656})) then --Leather Cord x 4
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 3922})) then --Rough Belt Strap
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 3914, item2 = 3924, item3 = 3925})) then --Vah Shir Needle Set, Bone Beaded Belt, Black Chitin Belt
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 3915, item2 = 3926})) then --Acrylia Needle, Owlbear Feathered Leggings
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 3921})) then --Order Receipt
