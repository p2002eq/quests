...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 5574, item2 = 5575})) then -- Reinforced Khati Sha Claw (Primary) &  Reinforced Khati Sha Claw (Secondary)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 6182})) then -- Small Bag of Teeth
		...
		e.other:Faction(423,3); -- Khati Sha
		e.other:QuestReward(e.self,0,0,0,0,6145,1000); -- Reinforced Claw Mounts
	end
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 5580, item2 = 6185, item3 = 6186})) then -- Cloak of the Khati Sha Apprentice, Sonic Wolf Bane Claw & Sonic Wolf Bane Claw
		...
		e.other:Faction(423,5); -- Khati Sha
		e.other:SummonItem(6184); -- Cloak of the Khati Sha Journeyman
		e.other:SummonItem(6185); -- Sonic Wolf Bane Claw
		e.other:QuestReward(e.self,0,0,0,0,6186,10000); -- Sonic Wolf Bane Claw
	end
