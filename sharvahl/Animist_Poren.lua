...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3665})) then --Shade Silk Scraps
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3673, item2 = 3674, item3 = 2878})) then --Primary Khati Sha Recruit Claw, Secondary Khati Sha Recruit Claw, Initiate's Cloak of Shar Vahl
