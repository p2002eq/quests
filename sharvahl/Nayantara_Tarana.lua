function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Emote("didn't notice you until you spoke,");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 16860})) then -- Reflective Shard
		e.self:Emote("inspects the shard,");
		e.self:Say("This is perfect, " .. e.other:GetName() .. ", thank you. I will fit this into my telescope as soon as I get home, here is the drop of moonlight that I promised you. Good luck, my friend' she says with a bow. ");
		e.other:QuestReward(e.self,0,0,0,0,5992); -- Drop of Moonlight
	end
