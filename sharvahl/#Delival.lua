...
function event_signal(e)
	...
	if(e.signal==2) then
		eq.set_timer("safe",700000);
	end
end

function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Hello there, " .. e.other:GetName() .. ". I do not suppose you have seen a little girl running around with a box of [" .. eq.say_link("buttons") .. "]? I sent [" .. eq.say_link("Shainai") .. "] over to Master Barkhem's place so I can finish these uniforms I am working on.");
	elseif(e.message:findi("Shainai")) then
		e.self:Say("Shainai is my little girl. While I am [" .. eq.say_link("inactive") .. "] I would like to see her as much as possible so I brought her with me here. I am starting to worry that she may have gotten lost near the palace. If you see her and have the time to escort her back here I would be indebted to you, friend.");
