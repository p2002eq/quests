...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 22154})) then
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 6157})) then
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 6158, item2 = 5966})) then
