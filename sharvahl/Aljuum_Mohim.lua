...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 5967})) then
		...
		e.other:SummonItem(17112);
		e.other:QuestReward(e.self,0,0,0,0,5967);
	end
	if(item_lib.check_turn_in(e.trade, {item1 = 22154})) then
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 6157})) then
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 6158, item2 = 5966})) then
		e.self:Say("Congratulations --name.  You have successful navigated to the status of Journeyman.  Take your dagger and this cloak, wear it with pride.");
		e.other:SummonItem(6158);
		e.other:QuestReward(e.self,0,0,0,0,6159,10000);
	end
