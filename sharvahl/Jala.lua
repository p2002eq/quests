...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 2789, item2 = 2789, item3 = 2789, item4 = 2789})) then -- 4x Shadeling Silk
		...
		e.other:QuestReward(e.self,0,0,0,0,0,1000); -- Just EXP
	end
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 2791, item2 = 2791, item3 = 2791, item4 = 2791})) then -- 4x Shade Silk Thread
		...
		-- Random -- Cloth Cap, Cloth Veil, Cloth Choker, Cloth Shirt, Cloth Shawl, Cloth Cape, Cloth Cord, Cloth Sleeves, Cloth Wristband, Cloth Gloves, Cloth Pants, Cloth Sandals
	end
