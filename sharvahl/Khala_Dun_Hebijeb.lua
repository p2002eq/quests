...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3443, item2 = 3443, item3 = 3443, item4 = 3443})) then
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3449})) then
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3451, item2 = 3445, item3 = 2878})) then
