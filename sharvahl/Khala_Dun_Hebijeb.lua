...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3443, item2 = 3443, item3 = 3443, item4 = 3443})) then -- 4x Skeletal Grimling Femur
		...
		e.other:QuestReward(e.self,0,0,0,0,3445,1000); -- Crude Bone Short Sword
	end
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3449})) then -- Pinch of Acrylia Dust
		...
		e.other:QuestReward(e.self,0,0,0,0,3450); -- Buckler Frame Mold
	end
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3451, item2 = 3445, item3 = 2878})) then -- Buckler Frame, Crude Bone Short Sword & Initiate's Cloak of Shar Vahl
		...
		e.other:Faction( 132,10 ); -- Guardians of Shar Vahl
		e.other:SummonItem(3453); -- Cloak of the Khala Dun Recruit
		e.other:SummonItem(3452); -- Buckler of the Recruit
		e.other:QuestReward(e.self,0,0,0,0,3454,2000); -- Skeletonbane Short Sword
	end
