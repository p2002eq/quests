...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 10391})) then
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 5559})) then
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 5562})) then
