...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 10390, item2 = 10390, item3 = 10390, item4 = 10390})) then -- 4x Worm Meat
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 5559})) then -- Meal Voucher
		...
		e.other:QuestReward(e.self,0,0,0,0,17608); -- Bloody Cloth Sack
	end
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 5562})) then -- Sack of Owlbear Meat
		...
		e.other:QuestReward(e.self,0,0,0,0,5563,1000); -- Bag of Food
	end
