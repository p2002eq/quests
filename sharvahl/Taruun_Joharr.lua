...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 3466})) then
		...
		e.other:SummonItem(5560);
		e.other:SummonItem(5561);
		e.other:QuestReward(e.self,0,0,0,0,5559);
	end
	if(item_lib.check_turn_in(e.trade, {item1 = 5563})) then
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 5568})) then
