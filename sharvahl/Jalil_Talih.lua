...
function event_say(e)
	...
	elseif(e.message:findi("aisha")) then
		e.self:Emote("Jalil Talih stares longingly into space at the sound of Aisha's name,");
	...
	elseif(e.message:findi("palace")) then
		e.self:Emote("Jalil Talih's chest swells with pride though his eyes reveal a hint of modest embarrassment at the attention,");
