...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 6274})) then -- Bag for Elam
		...
		e.other:SummonItem(6146); -- Taruun Hilt Piece
		e.other:QuestReward(e.self,0,0,0,0,17110); -- Acrylia Mortar and Pestle
	end
