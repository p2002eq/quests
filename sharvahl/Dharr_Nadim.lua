...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3648, item2 = 3648, item3 = 3648, item4 = 3648})) then -- 4x Shell of a Scorpion
		...
		e.other:QuestReward(e.self,0,0,0,0,30694,1000); -- Dharrs Lure
	end
