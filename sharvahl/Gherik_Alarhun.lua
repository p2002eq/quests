...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3648, item2 = 3648, item3 = 3648})) then -- 3x Shell of a Scorpion
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3653})) then -- Unfired Bowl of the Jharin
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3654, item2 = 2878, item3 = 3655, item4 = 3656})) then -- Bowl of the Jharin, Initiate's Cloak of Shar Vahl, Stretched Hopperhide & Leather Cord
