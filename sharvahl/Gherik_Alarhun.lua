...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 3648, item2 = 3648, item3 = 3648})) then -- 3x Shell of a Scorpion
		...
		e.other:SummonItem(17235); -- Claymixing Bowl
		e.other:QuestReward(e.self,0,0,0,0,3651); -- Reusable Jharin Bowl Sketch
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 3653})) then -- Unfired Bowl of the Jharin
		...
		e.other:QuestReward(e.self,0,0,0,0,3653); -- Unfired Bowl of the Jharin
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 3654, item2 = 2878, item3 = 3655, item4 = 3656})) then -- Bowl of the Jharin, Initiate's Cloak of Shar Vahl, Stretched Hopperhide & Leather Cord
		...
		e.other:SummonItem(3657); -- Drum of the Jharin Recruit
		e.other:SummonItem(3658); -- Cloak of the Jharin Recruit
		e.other:QuestReward(e.self,0,0,0,0,3659,1000); -- Buckler of the Jharin Recruit
	end
