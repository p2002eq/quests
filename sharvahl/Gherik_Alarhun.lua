...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3648, item2 = 3648, item3 = 3648})) then
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3653})) then
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3654, item2 = 2878, item3 = 3655, item4 = 3656})) then
