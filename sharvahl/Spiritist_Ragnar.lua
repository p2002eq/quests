...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 30665, item2 = 30665, item3 = 30665, item4 = 30665})) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 30665, item2 = 30665, item3 = 30665})) then
		e.self:Say("A blessing indeed! You have done well to bring this to me. With these glands I will be able to save many lives. Thank you friend. Shar Vahl And its people are in your debt. Please, accept these gifts to assist you in your endeavors. It Is the least I can do to return the favor!");
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 30665, item2 = 30665})) then
		e.self:Say("A blessing indeed! You have done well to bring this to me. With these glands I will be able to save many lives. Thank you friend. Shar Vahl And its people are in your debt. Please, accept these gifts to assist you in your endeavors. It Is the least I can do to return the favor!");
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 30665})) then
		e.self:Say("A blessing indeed! You have done well to bring this to me. With these glands I will be able to save many lives. Thank you friend. Shar Vahl and its people are in your debt. Please, accept these gifts to assist you in your endeavors. It Is the least I can do to return the favor!");
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 30602, item2 = 30964})) then
