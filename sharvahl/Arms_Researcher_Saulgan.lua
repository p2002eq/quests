...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 7182})) then -- Claw of the Horde
		e.self:Emote("places your weapon on the ground and hands you an identical weapon 'This should do it for you mate,' he says as he hands you the weapon. 'Kill one for me while you're at it!");
