...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 3455, item2 = 3455, item3 = 3455})) then -- 3x Soft Rhinobeetle Chitin
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 3459})) then -- Acrylia Flakes
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 3460, item2 = 3464, item3 = 2878, item4 = 3456})) then -- Initiate Seal of the Taruun, Seal of Rytan, Initiate's Cloak of Shar Vahl & Buckler of the Beetle
