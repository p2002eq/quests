...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 3452})) then
		...
		e.other:SummonItem(17604);
		e.other:QuestReward(e.self,0,0,0,0,3452);
	elseif(item_lib.check_turn_in(e.trade, {item1 = 5553, item2 = 3454})) then
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 5550, item2 = 5545, item3 = 3453})) then
		...
		e.other:Faction(132,10);
		e.other:SummonItem(5557);
		e.other:SummonItem(5550);
		e.other:QuestReward(e.self,0,0,0,0,5545,3000);
	end
