...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 5571})) then -- Worn Map of the Area
		...
		e.other:QuestReward(e.self,0,0,0,0,5572); -- Small Stone Blade
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 5581, item2 = 5581, item3 = 3673, item4 = 3674})) then -- 2x Thin Leather Strap, Primary Khati Sha Recruit Claw & Secondary Khati Sha Recruit Claw
		...
		e.other:SummonItem(5574); -- Reinforced Khati Sha Claw (Primary)
		e.other:SummonItem(5575); -- Reinforced Khati Sha Claw (Secondary)
		e.other:QuestReward(e.self,0,0,0,0,5573,2500); -- A Folded Note
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 5577})) then -- An Exaggerated Report
		...
		e.other:Faction(423,1); -- Khati Sha
		e.other:QuestReward(e.self,0,0,0,0,17610,1000); -- Carved Wooden Box
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 5579})) then -- Box for Kery
		...
		e.other:Faction(423,1); -- Khati Sha
		e.other:QuestReward(e.self,0,0,0,0,5580,10000); -- Cloak of the Khati Sha Apprentice
	end
