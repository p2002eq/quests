...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3918, item2 = 3918, item3 = 3918, item4 = 3918})) then -- 4x Grimling Finger Bones
		...
		-- Random -- Hopperhide Wristbands, Hopperhide Tunic, Hopperhide Skullcap, Hopperhide Sleeves, Hopperhide Shoulderpads, Hopperhide Mask
		-- Random -- Hopperhide Leggings, Hopperhide Gorget, Hopperhide Gloves, Hopperhide Cloak, Hopperhide Boots, Hopperhide Belt
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 3812, item2 = 3812, item3 = 3812, item4 = 3812})) then -- 4x Grimling Toes
		e.self:Say("Thanks, here is your reward!");
		e.other:QuestReward(e.self,0,0,0,0,eq.ChooseRandom(7079,7074,7071,7078,7075,7072,7081,7073,7080,7076,7082,7077),1000);
		-- Random -- Hopperhide Wristbands, Hopperhide Tunic, Hopperhide Skullcap, Hopperhide Sleeves, Hopperhide Shoulderpads, Hopperhide Mask
		-- Random -- Hopperhide Leggings, Hopperhide Gorget, Hopperhide Gloves, Hopperhide Cloak, Hopperhide Boots, Hopperhide Belt
