...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 18554})) then --Taruun Guild Summons
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 29828})) then --Shadowscream Steel Boots
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 29825})) then --Shadowscream Boot Case
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 2897})) then --Notorized Application
