...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Welcome to our fair city traveler. We have much in the way of fine food and entertainment. If you are planning to explore the crater, please beware of the [" .. eq.say_link("vermin") .. "] infesting the area.");
