...
function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Welcome to my shop. Please feel free to look around at the armor we have available. If you are [" .. eq.say_link("looking for work") .. "], just let me know.");
	elseif(e.message:findi("Looking for work")) then
		e.self:Say("That's great news! I could really use a hand. I have constructed some shield frames ideal for use with the carapaces found on [" .. eq.say_link("bloodlings") .. "]. Unfortunately I do not have the time to collect any of the shells. You can either purchase the frames and keep the shields for yourself, or you can return them to me and I will compensate you for your troubles.");
...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 29802, item2 = 29819})) then -- Vah Shir Apprentice Mallet and Box of Shadow Disks
		e.self:Say("Well done, " .. e.other:GetName() .. "! I trust you are beginning to see the power that shadow can grant you. Now it is time for you to learn to manipulate sound. Here is your very own mallet, use it to form the substance of sound into tangible matter. Pound yourself out a few [" .. eq.say_link("humming orbs") .. "] and I'll know you're ready to combine shadow and sound into a precarious balance of forces.");
		e.other:Faction(132,10); -- Guardians of Shar Vahl
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 29826})) then -- Rakutahs Seal
		e.self:Say("Back already, " .. e.other:GetName() .. "? I've only just sent you out and you've finished your very first professional job, well done! I'm very proud of your progression! My wife and I have made you a pair of greaves that I'm sure you'll love to wear. Take them as a reward on a job well done. I have pressing matters that require my attention right now, or else I'd teach you more about the powers of shadow and sound. Experiment with the [" .. eq.say_link("Shadowscream steel") .. "] until I can teach you more.");
		e.other:Faction(132,10); -- Guardians of Shar Vahl
