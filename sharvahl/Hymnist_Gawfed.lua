function event_say(e)
	if((e.message:findi("hail")) and e.other:HasItem( 3659)) then --Buckler of the Jharin Recruit
		...
		e.other:SummonItem(5954); --Gawfed's Receipt
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 3659})) then --Buckler of the Jharin Recruit
		e.self:Say("Very well met, young friend. I assume that Gherik has sent you to me for the purpose of training you. Unforunately, I will not be doing any formal training for the several days. I'm taking a bit of a holiday to celebrate my wife's birthday. If you could take this receipt to the [merchant] for me before my wife gets home, I'd appreciate it. I'll place you at the top of my training list as well.");
		e.other:SummonItem(3659); --Buckler of the Jharin Recruit
		e.other:QuestReward(e.self,0,0,0,0,5954); --Gawfed's Receipt
	elseif(item_lib.check_turn_in(e.trade, {item1 = 5958})) then --Finished Vase Replica
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 5959})) then --Bag of Feathers
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 5962})) then --Note from Jangle
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 5965})) then --Bag of Lute Strings
		e.self:Say("My dear friend, " .. e.other:GetName() .. ", you have been a wondrous help! Though we have not had an opportunity to work on the more refined Jharin teachings, you have definitely proven yourself to be an honorable citizen and worthy apprentice. My brother has returned with your cloak. Please take it along with the title of Jharin Apprentice. To further demonstrate my appreciation of your work for me, please take this lute.");
		e.other:Faction(132,10); --Guardians of Shar Vahl
		e.other:SummonItem(5966); --Cloak of the Jharin Apprentice
		e.other:QuestReward(e.self,0,0,0,0,5967,3000); --Lute of the Jharin Apprentice
		e.self:Shout("Everyone, please welcome my student and friend, " .. e.other:GetName() .. ", to the rank of Jharin Apprentice!");
