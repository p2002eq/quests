...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 4393})) then
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 9044})) then
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 9048})) then
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 9055, item2 = 9056})) then
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 9060})) then
