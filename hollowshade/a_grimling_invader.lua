-- a_grimling_invader (166281) for Hollowshade war
...
function event_waypoint_arrive(e)
    ...
    if (e.wp >= 14 and grid == 201) or (e.wp >= 16 and grid == 301) then
        e.signal(166257, 13) -- change camp 1 (north) to race 3 (grimling)
    elseif (e.wp >= 14 and grid == 102) or (e.wp >= 13 and grid == 302) then
        e.signal(166257, 23) -- change camp 2 (east) to race 3 (grimling)
    elseif (e.wp >= 15 and grid == 103) or (e.wp >= 12 and grid == 203) then
        e.signal(166257, 33) -- change camp 3 (east) to race 3 (grimling)
    end
end
