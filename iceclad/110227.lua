...
function event_waypoint_arrive(e)
    ...
    elseif (e.wp == 3) then     -- encounter3, spawn on top of general
    ...
    elseif (e.wp == 4) then     -- encounter4
        ...
        eq.signal(110230, 1, 600);  -- send signal to attack
    elseif (e.wp == 4) then     -- encounter5, spawn on top of general
