...
function event_waypoint_arrive(e)
    if (e.wp == 1) then
        eq.spawn2(110230, 0, 0, 7521, -3461, 163, 116);
    ...
    elseif (e.wp == 2) then
        eq.spawn2(110225, 0, 0, 7286, -2440, 139, 227);
    ...
    elseif (e.wp == 3) then
        eq.spawn2(110219, 0, 0, 5960, -1100, 161, 227);
        eq.spawn2(110225, 0, 0, 5940, -1100, 161, 227);
        eq.spawn2(110225, 0, 0, 5950, -1110, 161, 25);
        eq.spawn2(110225, 0, 0, 5950, -1090, 161, 109);
    elseif (e.wp == 4) then
        eq.spawn2(110230, 0, 0, 2193, 1614, 54, 112);
        ...
        eq.signal(110230, 1, 600);  -- send signal to attack
    elseif (e.wp == 4) then
        eq.spawn2(110109, 0, 0, 2253, 3703, 244, 227);
        eq.spawn2(110225, 0, 0, 2260, 3700, 244, 25);
