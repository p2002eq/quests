...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 6310,item2 = 30050, item3 = 30049})) then
		e.self:say("Yes, these good.");
		e.self:emote("forges the items into a finely crafted harpoon. Grizlin holds the weapon up and inspects it for a moment.");
		e.self:say("Yes, this fine weapon. This hero weapon! Groumshak have harpoon much like this. May it bring much food for your pack, furless one.");
		e.self:emote("hands you the harpoon with a nod of his head.");
