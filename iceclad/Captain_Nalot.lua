...
function event_say(e)
	...
	elseif(e.message:findi("mean")) then
	    e.self:Say("Thats right! We're mean, nasty, devious 'n cruel. We'll knock ya down, bite yer knees, and steal yer money. Arrr. We won't always say please and thank you either! Just remember that and don't be tryin' anyhin' [" .. eq.say_link("funny") .. "].");
	...
	elseif(e.message:findi("map")) then
	    e.self:Say("The map? What map? Oh wait, that thing I made ol' what's-his-name do ta get los... uh adventure. Uh, sure. If yer wantin' we've got a job for ya. If ya do it ya get ta be a [" .. eq.say_link("real member of your crew",false,"real member o' me crew") .. "].");
