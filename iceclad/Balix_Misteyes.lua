function event_say(e)
	...
	elseif(e.message:findi("dangerous creatures")) then
		...
		e.self:Say("Most dangerous is the Garou. Evil spirit of the land. It was made from long dead wolf spirits when the tower spread its dark magics through the islands. It preys on the Snowfang. We have tried to hunt it but always it is too strong.");
