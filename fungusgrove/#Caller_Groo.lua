-- #Caller_Groo (157006) in Fungus grove 'Calling beasties' east cavern event caller
...
function event_trade(e)
	...
	elseif started and item_lib.check_turn_in(e.self, e.trade, {item1 = 28704}) then -- South Caller Contract
...
function spawn_waves(caller)
	...
	for i=1,3 do
		...
		eq.spawn2(mob, 0, 0, locs[1], locs[2], locs[3], 0):CastToNPC():MoveTo(-1158, 382, -333, 0, true);
	end
...
function start_event(e)
	...
	e.other:SummonItem(28704); -- South Caller Contract
