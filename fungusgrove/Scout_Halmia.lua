-- Scout_Halmia (157130) in Fungus Grove for BST Epic
...
function event_trade(e)
	...
	if item_lib.check_turn_in(e.self, e.trade, {item1 = 9057}) or item_lib.check_turn_in(e.self, e.trade, {item1 = 9062}) then -- Khati Sha Seal of War (accept either to allow redo)
        ...
        eq.unique_spawn(157131,0,0,-14,640.5,-261,242.0); -- Draz_Nurakk
        eq.unique_spawn(157140,0,0,-111,597.5,-261,174.0); -- Draz_Nurakk`s_Warder
