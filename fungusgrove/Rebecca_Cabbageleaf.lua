...
function event_say(e)
	if e.message:findi("hail") then
		e.self:Emote(string.format("seems lost in thought and looks up only briefly from her work. 'Oh, hello %s, welcome to the New Thicket Inn! If you'll excuse me, I'm a bit busy copying this [" .. eq.say_link("scroll") .. "]. I'll be with you in a moment to chat, or to trade if you've come about the [" .. eq.say_link("earring") .. "]'", e.other:GetName()));
	elseif e.message:findi("scroll") then
		e.self:Emote("looks up again with a quiet smile, 'I'm making a copy of a new Protection spell, it's very exciting! The druids of Norrath have just completed an important ritual, and the gods have blessed us with this new spell! I'd be happy to scribe you a copy, if you were to fetch me the [" .. eq.say_link("ingredients") .. "].'");
