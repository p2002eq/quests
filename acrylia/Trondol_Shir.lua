...
function event_trade(e)
    ...
    if(not started and item_lib.check_turn_in(e.self, e.trade, {item1 = 6554})) then -- Grimling Shackle Key
		...
		started = true;
		eq.spawn2(guard,0,0,-211,-716,1,258); --#a_possessed_corpse (154354)
        eq.spawn2(guard,0,0,-205,-716,1,258); 
		eq.spawn2(guard,0,0,-196,-716,1,258);
		eq.spawn2(soulstealer,0,0,-205,-699,1,258); --#a_grimling_soulstealer(154106)
