...
function event_timer(e)
	-- [FLAG: Check target: eq.get_globals()] local qglobals = eq.get_qglobals();
	if(qglobals["nexus_tox"] ~= nil and qglobals["spire_tox"] and qglobals["spire_tox"] == 1 and e.other:HasItem( 19720)) then
	...
	elseif(qglobals["nexus_tox"] and qglobals["spire_tox"] and qglobals["spire_tox"] == 1 and qglobals["nexus_tox"] == nil and qglobals["spire_tox"] and qglobals["spire_tox"] == 1 and qglobals["message_tox"] and e.other:HasItem( 19720) == false) then
	...
	elseif(qglobals["nexus_tox"] ~= nil and qglobals["spire_tox"] and qglobals["spire_tox"] == 1 and qglobals["message_tox"] and e.other:HasItem( 19720) == false) then
		qglobals["nexus_tox"] = nil;
		qglobals["spire_tox"] = nil;
		qglobals["message_tox"] = nil;
	end
