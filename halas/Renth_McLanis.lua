...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 13246}) and e.other:GetFaction(e.self) < 6) then
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 13249, item2 = 13248, item3 = 13247, item4 = 13233}) and e.other:GetFaction(e.self) < 6) then
