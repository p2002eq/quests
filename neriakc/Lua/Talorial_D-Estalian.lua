function event_say(e)
	...
	if(e.message:findi("worthy")) then
	...
	if(e.message:findi("gather some items")) then
	...
	if(e.message:findi("slippers")) then
	...
	if(e.message:findi("skullcap")) then
