function event_say(e)
	...
	if(e.message:findi("hematite symbol of Innoruuk")) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 14550, item2 = 14550, item3 = 14550, item4 = 14550})) then--Woven Grass Amulets
		...
		e.other:SummonItem(1369);--Initiate Symbol of Innoruuk
		e.other:AddEXP(2000);
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 18756})) then --Tattered Note
		...
		e.other:Ding();
		e.other:SummonItem(13585); --Crimson Training Tunic*
