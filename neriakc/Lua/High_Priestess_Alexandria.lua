function event_say(e)
	...
	-- [FLAG: Possible incorrect client target: e.self:Race() ==] -- [FLAG: Possible incorrect client target: e.self:Class() ==] if((e.self:Class() == "Cleric") and (e.self:Race() == "Dark Elf")) then
		...
		if(e.message:findi("interested in proving myself")) then
		...
		if(e.message:findi("magical relic")) then
		...
		if(e.message:findi("important items")) then
		...
		if(e.message:findi("armor recipes")) then
		...
		if(e.message:findi("armguards")) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 22617, item2 = 22618, item3 = 22619})) then
		...
		e.other:SummonItem(22698); --Mace of the Darkpriest
	end
