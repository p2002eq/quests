...
function event_say(e)
	...
	if(e.other:HasItem( 1369)) then --Initiate Symbol of Innoruuk
		if(e.message:findi("initiate")) then
			e.self:Say("Well met, Initiate " .. e.other:GetName() .. ". If you desire to raise your station in this temple, I have a task for you. Are you willing to accept the task I am about to set before you?");
		end
		if(e.message:findi("willing")) then
	...
	if(e.other:HasItem( 1370)) then --Disciple Symbol of Innoruuk
		...
		if(e.message:findi("deliver the provisions")) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 12497, item2 = 1369})) then --Head of a Halfling Spy, Initiate Symbol of Innoruuk
		...
		e.other:SummonItem(1370); --Disciple Symbol of Innoruuk
		e.other:AddEXP(4000);
		e.other:Faction(177, 10);  --King Naythox Thex
		e.other:Faction(256, 10);  --Priests of Innoruuk
		e.other:Faction(43, -30);  --Clerics of Tunare
		e.other:Faction(257, -30); --Priests of Life
		e.other:Faction(258, -30); --Priests of Marr
		e.other:Faction(260, -30); --Primordial Malice
	end
	if(item_lib.check_turn_in(e.trade, {item1 = 12499, item2 = 12498, item3 = 19029, item4 = 1370})) then --Voucher of Service to Naythox, Swiftmoon's Head, Receipt for Provisions Crate, Disciple Symbol of Innoruuk
		...
		e.other:SummonItem(1371);--Regent Symbol of Innoruuk
		e.other:AddEXP(8000);
		e.other:Faction(177, 10);  --King Naythox Thex
		e.other:Faction(256, 10);  --Priests of Innoruuk
		e.other:Faction(43, -30);  --Clerics of Tunare
