function event_say(e)
	...
	--
	if(e.message:findi("denouncer ixtaz sent me")) then
	...
	if(e.message:findi("here for the ritual") or e.message:findi("blue flame")) then
	...
	if(e.message:findi("flayed")) then
	...
	if(e.message:findi("vengeance")) then
	...
	if(e.message:findi("summon")) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 18401, item2 = 10032})) then
		...
		e.other:SummonItem(18401); -- Scroll of Flayed Goblin Skin - Gives it back
		e.other:AddEXP(53110);   -- 1% @ level 30
	end
