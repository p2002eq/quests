function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("I am Draan N'Ryt, provider of the purest [" .. eq.say_link("adamantite ore") .. "] and master smith of [" .. eq.say_link("adamantite chainmail") .. "]!");
