...
function event_say(e)
	if(e.message:findi("scribe of dal")) then
		e.self:Say("The Scribes of Dal? All of them are long since [" .. eq.say_link("dead") .. "].. or at least most would say that.");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13030})) then--Red Wine
		e.self:Say("Ah, yes, let me pray to our god.. Yes, Innoruuk has given me wisdom. A Scribe of Dal still exists, disguised as a barkeep in the Blind Fish. This information will not help you though, for she has sworn a [" .. eq.say_link("vow") .. "] of silence and will not speak of the Dal.");
