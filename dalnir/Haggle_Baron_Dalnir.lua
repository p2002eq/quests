...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13051, item2 = 13063, item3 = 3888})) then -- A Quill, A Piece of Parchment and Rile's Shattered Blade
		...
		e.other:QuestReward(e.self,0,0,0,0,3890,1000); -- Greenmist Design Pattern
		eq.depop();
	end
