function event_say(e)
	if (e.other:GetFaction(e.self) <= 2) then -- Warmly or lower
		if (e.message:findi("hail")) then
			e.self:Say("Greetings ally of the Claws of Veeshan! Allow me to introduce myself. I am Evreth Menesez of the Draconic Loyalist Fellowship, scholar and researcher of draconic arcane knowledge and practitioner of magery. I am currently researching the whereabouts of an [" .. eq.say_link("ancient dragon tome") .. "] that my contain lost arcane knowledge that could prove useful to the Claws of Veeshan, particularly the dragons and dragon-kin of Skyshrine");
		elseif(e.message:findi("ancient dragon tome")) then
			e.self:Say("The dragon sorcerer, Xervolithax, according to dragon lore, had penned a tome of arcane knowledge that he guarded with his life. It is told that Xervolithax fell to the Kromzek centuries ago in the Great Divide in a great battle. The only surviving apprentice of Xervolithax that survived the fateful incident recovered the tome from the fallen dragon sorcerer and divided it into [" .. eq.say_link("sections") .. "], which he then hid for fear of the tome falling into the hands of the Kromzek magic-users.");
