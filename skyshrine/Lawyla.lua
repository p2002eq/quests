function event_say(e)
	...
	elseif(e.message:findi("I want to study the art of sorcery")) then
	...
	elseif(e.message:findi("I wish to avenge Hsagra")) then
	...
	elseif(e.message:findi("I wish to prove my allegiance")) then
