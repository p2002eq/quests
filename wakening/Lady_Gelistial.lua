...
function event_say(e)
    if(e.message:findi("hail")) then
        e.self:Emote("nods towards "..e.other:GetName().." and a soft gentle voice whispers in your mind as if carried by the breeze passing through the gentle grove. 'You tread upon the sacred ground of Tunare. I am the Lady Gelistial, baroness of the Tunarean Unicorns. Are you a [" .. eq.say_link("friend") .. "] of the Tunarean Court?'");
    elseif(e.message:findi("friend")) then
        e.self:Say("Be wary of the black unicorns then my friend. All unicorns once inspired dreams and fascination in mortals but the lineage of Lithiniath has been twisted and now inspire delusions and madness. If my duties here were not so pressing I would seek the wisdom of [" .. eq.say_link("Prince Thirneg") .. "] in finding a cure for the cursed bloodline of [" .. eq.say_link("Lithiniath") .. "].");
