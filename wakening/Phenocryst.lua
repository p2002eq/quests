...
function event_trade(e)
    ...
    elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 1693})) then
            ...
            eq.spawn2(119158,0,0,408.10, -690.21, -201.55,374.0); --# accolyte of Zek  A
            eq.spawn2(119158,0,0,-564.04, -985.80, -191.31,374.0); --# accolyte of Zek  B
            eq.spawn2(119164,0,0,303.02, 254.44, -201.54,374.0); --# Bloodpriest Ioukond  C
