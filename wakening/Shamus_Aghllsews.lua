function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Welcome to my fiefdom, wayward " .. e.other:GetRace() .. ". I am Duke Shamus Aghllsews of the Tunarean Court. Only those who pledge friendship or membership to the Court are allowed sanctuary in the Wakening Lands.");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 30220,item2 = 30220,item3 = 30220,item4 = 30220})) then -- 
        ...
        --e.other:SummonItem(17865);
        e.other:QuestReward(e.self,0,0,0,0,17865,35000,344,10);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 30222})) then -- 
        ...
        e.other:QuestReward(e.self,0,0,0,0,17862,35000,344,10);	
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 22855})) then -- 
        ...
        e.other:QuestReward(e.self,0,0,0,0,24865,35000,344,10);
    elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 1095})) then -- 
        ...
        e.other:QuestReward(e.self,0,0,0,0,8950,10000,344,50);
	end
