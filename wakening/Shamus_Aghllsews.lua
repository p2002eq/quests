...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 30220,item2 = 30220,item3 = 30220,item4 = 30220})) then -- 4x Kromrif Laborer Pick
        ...
        e.other:QuestReward(e.self,0,0,0,0,17865,35000); -- Empty Crest Case
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 30222})) then -- Kromzek Architect Blueprints
        ...
        e.other:Faction(344, 10); -- Tunarean Court faction
		e.other:SummonItem(24860); -- Bag of Crushed Herbs
        e.other:QuestReward(e.self,0,0,0,0,17862,35000); -- Empty Sulfur Collection Bag
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 22855})) then -- Pile of Rubble
		...
		e.other:Faction(344, 10); -- Tunarean Court faction
        e.other:QuestReward(e.self,0,0,0,0,24865,35000); -- Crest of the Fauns
    elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 1095})) then -- Case of Tunarean Crests
		e.self:Say("Thank you " .. e.other:GetName() .. ", here is your reward.  Welcome to full membership in the Tunarean Court.");
		e.other:Faction(344, 10); -- Tunarean Court faction
        e.other:QuestReward(e.self,0,0,0,0,8950,35000); -- Tunarean Signet Ring
	end
