...
function event_signal(e)
    ...
    if(e.signal == 2) then --vs died
        ...
        eq.spawn2(119174,0,0,-146,1703,-192,374);  --# a_sifaye_defender
        eq.spawn2(119174,0,0,-149,1731,-192,374);  --# a_sifaye_defender
        eq.spawn2(119174,0,0,-162,1738,-192,374);  --# a_sifaye_defender
        eq.spawn2(119174,0,0,-172,1758,-192,364);  --# a_sifaye_defender
    end
end
