...
function event_say(e)
    if(e.message:findi("hail")) then
        e.self:Say("A pleasure to speak with you! You appear to be a foreigner to Katta Castellum as well. I hope your reasons for visiting this noble city are more leisurely than my own. In addition to my normal duties as a Shar Vahl Emissary to Katta Castellum there is the issue of the [" .. eq.say_link("Tormented Vah Shir") .. "] in Tenebrous Mountains that must be dealt with.");
    elseif(e.message:findi("tormented vah shir")) then
        e.self:Say("Recently the skeletons of Vah Shir have been spotted wandering the Tenebrous Mountains ferociously and blindly attacking the living. There are legends among my people that speak of Vah Shir warriors that were murdered dishonorably in their sleep by a traitor allied with [" .. eq.say_link("dark spirits") .. "]. The spirits of these murdered warriors become trapped in their decaying mortal shells for often many years before they are driven mad by the despair, rage, and torturous experience. When this negative spirit energy becomes strong enough the corpses rise and attempt to slaughter all that crosses their path in their state of eternal rage. Spirits tormented in such a manner must be assisted so that they may finally find peace in death. Will you [" .. eq.say_link("help the souls") .. "] find peace?");
    elseif(e.message:findi("dark spirits")) then
        e.self:Say("Not all spirits that can be called upon by those who are in touch with the spirit realms are of good intentions. There are spirits who seek to destroy and corrupt.These dark spirits are best avoided and kept from manifesting their influence on the mortal realms.Unfortunately the foolish or the weak willed are tempted by their promises of power. Most who deal with the dark spirits are shortly driven mad by the spirits influence or destroyed by the very powers they were promised.  There are tales however of powerful shaman capable of harnessing and controlling the dark spirits and their evil powers of corruption. These wicked traitors to the Vah Shir teachings are called [" .. eq.say_link("Rakshasa") .. "].");
...
function event_signal(e)
    ...
    elseif(e.signal == 3) then
        eq.spawn2(160476,0,0,-4.00,-36.31,4.06,20);  -- a_reanimated_vah_shir -N
        eq.spawn2(160476,0,0,-4.00,32.89,4.06,250);  -- a_reanimated_vah_shir -S
        eq.spawn2(160476,0,0,-44.76,-0.14,4.06,120);  -- a_reanimated_vah_shir -E
        eq.spawn2(160476,0,0,25.63,-2.65,4.06,380);  -- a_reanimated_vah_shir -W
        eq.spawn2(160476,0,0,17.85,-25.35,4.06,450);  -- a_reanimated_vah_shir -NE
        eq.spawn2(160476,0,0,-35.98,28.26,4.06,180);  -- a_reanimated_vah_shir -SW
        eq.spawn2(160476,0,0,19.31,21.24,4.06,320);  -- a_reanimated_vah_shir -SE
        eq.spawn2(160476,0,0,-26.56,-24.31,4.06,60);  -- a_reanimated_vah_shir -NW
    end
end
