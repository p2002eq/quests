...
function event_say(e)
	...
	elseif e.message:findi("traitor to the Validus Custodus") and ready > 1 then
		...
		local condor = eq.unique_spawn(160494, 0, 0, -838, -401, -267, 12)
		local lego1 = eq.spawn2(160495, 0, 0, -816, -210, -267, 264)
		local lego2 = eq.spawn2(160496, 0, 0, -828, -185, -267, 254)
		local lego3 = eq.spawn2(160497, 0, 0, -842, -200, -267, 260)
...
function event_waypoint_arrive(e)
	if e.wp == 28 then
		eq.unique_spawn(160487, 0, 0, -822, -296, -267, 256)
		ready = 2
		eq.stop_timer('prox')
