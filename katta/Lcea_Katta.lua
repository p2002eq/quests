...
function event_trade(e)
	...
	if eq.get_qglobals(e.other)["EarringVeracity3"] ~= nil and item_lib.check_turn_in(e.self, e.trade, { item1 = 7000 }) then -- if player completed Runed Earring of Veracity... and Lcea's Jewel Box
