...
function event_say(e)
    if(e.message:findi("valdanov zefeer") and (eq.get_qglobals()["first_badge_nathyn"] == 1)) then
    ...
    elseif(e.message:findi("quite some time") and (eq.get_qglobals()["first_badge_nathyn"] == 1)) then
    ...
    elseif(e.message:findi("captured vampyres") and (eq.get_qglobals()["first_badge_nathyn"] == 1)) then
