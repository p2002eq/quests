---- Quest:The Acrylia Plans
function event_say(e)
    if(e.message:findi("Hail")) then
        e.self:Say("Well met " .. e.other:GetName() .. "! I am Rallic Aristos. Governor of trade and economy here in Katta Castellum. I know it sounds like a lot of parchment pushing and coin counting but maintaining good trade relations with the various Houses of Shadow Haven and the haggling Vah Shir of Shar Vahl is not as easy at it may sound. Then there is the issue of the [" .. eq.say_link("acrylia mines") .. "] in the Tenebrous Mountains.");
    elseif(e.message:findi("acrylia mines")) then
        e.self:Say("The Tenebrous Mountains are rich with veins of the valuable acrylia ore. Unfortunately the mines were dug and controlled by a tribe of savage grimlings from the forests to the south. Negotiations have been attempted with the grimlings but to no avail. Several of the other governors and I have been developing a [" .. eq.say_link("plan") .. "] to take the mines or establish mines of our own. In either case the mines will have to be defended from attacks by the grimlings unless when placed in that predicament they finally resort to trade negotiations.");
...
function event_trade(e)
    ...
    if(item_lib.check_turn_in(e.self, e.trade, {item1 = 31730})) then -- Grimling Runner Pouch
        e.self:Say("Excellent. The contents of the pouch shall be examined immediately. Take this pattern for a crafting a pack that will be sure to lighten the burden of its contents. I'm afraid I do not have the rest of the [" .. eq.say_link("required materials") .. "] at hand.");
        e.other:Faction(52,5); -- Concillium Universus
        e.other:Faction(284,-10); -- Seru
        e.other:Faction(142,-10); -- Heart of Seru
        e.other:QuestReward(e.self,0,0,0,0,31729,250); -- Rallic Pack Pattern
    end
