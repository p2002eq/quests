...
function event_trade(e)
    ...
    if(item_lib.check_turn_in(e.self, e.trade, {item1 = 4769})) then -- Seal of Beriol
        ...
        e.other:QuestReward(e.self,0,0,0,0,4770,1000); -- Book of Ancient Scribings
    end
