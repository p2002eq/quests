function event_say(e)
	...
	elseif e.message:findi("serve katta") and eq.get_qglobals(e.other)["EarringVeracity3"] ~= nil then -- if player did 3rd earring...
...
function event_trade(e)
	...
	if eq.get_qglobals(e.other)["EarringVeracity3"] ~= nil and item_lib.check_turn_in(e.self, e.trade, { item1 = 29881, item2 = 29882, item3 = 29883, item4 = 29884 }) then
