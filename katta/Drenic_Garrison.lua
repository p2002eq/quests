...
function event_say(e)
    if(e.message:findi("Hail")) then
        e.self:Say("Greetings! I am Drenic Garrison, Governor of Science here in Katta Castellum. I am currently involved in several scientific endeavors with the other governors and am in need of assistance supplying my researchers with the proper [" .. eq.say_link("materials and samples") .. "] for their studies.");
    elseif(e.message:findi("materials and samples")) then
        e.self:Say("The Magus Conlegium are assisting with some studies on the physiology of the Vampyres of the Coterie of the Eternal Night and are in need of [" .. eq.say_link("ash and blood") .. "] samples. Maralicis Dilsm our Governor of Health is assisting in research on [" .. eq.say_link("counteragents") .. "] to the venom and diseases native to Luclin. Finally, there have been reports from the agents of Erikal Wolfeye that there is a civilization of [" .. eq.say_link("snake people") .. "] that live on the furthest reaches of the light side of Luclin in a region devoid of atmosphere.");
