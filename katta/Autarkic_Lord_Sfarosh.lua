...
function event_signal(e)
    if(e.signal == 1) then
        ...
        eq.signal(160484,1,5000); -- #Incantator Jak Masric
    elseif(e.signal == 2) then
        ...
        eq.signal(160483,1,5000); -- #Praecantor Selis Dawneyes
    elseif(e.signal == 3) then
        ...
        eq.signal(160485,1,5000); -- #Theurgus Ajeea Polaja
    elseif(e.signal == 4) then
        ...
        eq.signal(160485,2,5000); -- #Theurgus Ajeea Polaja
    ...
    elseif(e.signal == 6) then
        ...
        eq.spawn2(160481,0,0,e.self:GetX(),e.self:GetY(),e.self:GetZ(),e.self:GetHeading()):AddToHateList(e.other,1); -- #Autarkic_Lord_Sfarosh
        eq.spawn2(160486,0,0,-25,-762,4,160); -- an autarkic umbrage shade
        eq.spawn2(160486,0,0,-164,-760,4,96); -- an autarkic umbrage shade
        eq.spawn2(160486,0,0,-30,-901,4,224); -- an autarkic umbrage shade
        eq:depop();
    end
end