function event_death_complete(e)
	...
	if(chance_spawn <= 50) then
		eq.spawn2(90201,0,0,e.self:GetX(),e.self:GetY(),e.self:GetZ(),e.self:GetHeading()); -- a black reaver
	...
	elseif (chance_spawn <= 100) then
		eq.unique_spawn(90194,0,0,e.self:GetX(),e.self:GetY(),e.self:GetZ(),e.self:GetHeading()); -- Lord Rak`Ashiir
	end
end
