...
function event_trade(e)
	...
	if(e.other:GetCharacterFactionLevel(342) >= 42) then -- True Spirit
		if(item_lib.check_turn_in(e.self, e.trade, {item1 = 14367, item2 = 14368, item3 = 14369, item4 = 14370})) then -- Corrupted Ghoulbane, Heart of the Innocent, Head of the Valiant and Will of Innoruuk
			...
			e.other:QuestReward(e.self,0,0,0,0,14384,100); -- Lhranc's Token
			eq.spawn2(90190, 0, 0, 85.1, 0.9, 7.8,384.0); -- Lhranc
			eq.depop_with_timer();
		end
	end
