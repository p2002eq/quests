...
function event_spawn(e)
	...
	eq.set_timer("depop",4800000); -- 80 Minutes
end

function event_say(e)
	if(e.message:findi("hail")) then--True Spirit
	    if(e.other:GetCharacterFactionLevel(342) < 7) then -- True Spirit
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 14384})) then -- Innoruuk's Curse
