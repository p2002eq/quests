function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("ARGH! Dangit, ya scared me! Tread cautiously, fri. This here place ain't as frily as it seems. There's a [" .. eq.say_link("beast") .. "] lurkin' in this here puddle.");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 20696})) then
		...
		eq.spawn2(96369,0,0,-2178,-11745,-0.63,126);
		eq.depop_with_timer();
	end
