...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18099})) then
		e.self:Say("Yes, most unfortunate. I was informed last week of the death of my most recent [" .. eq.say_link("apprentice") .. "]. A few months ago, I paid a substantial sum to a group of rogues sent from Neriak to collect on a gambling debt. He swore to me that was the end of it, but I suspected otherwise. My warnings of gambling with the rogues fell on deaf ears.");
