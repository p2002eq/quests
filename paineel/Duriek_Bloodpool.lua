...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 14365}) and charfaction <= 6) then
		...
		e.other:Faction(342,70);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 14382}) and charfaction <= 6) then
		...
		e.other:Faction(342,70);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 5403,item2 = 11609,item3 = 5430,item4 = 14366}) and charfaction <= 5) then
