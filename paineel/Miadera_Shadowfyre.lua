function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Ahhhahahaha! The terror that lays over this city like a blanket tingles my bones with vigor. I seek a fellow apostle of Cazic-Thule to assist me in the [" .. eq.say_link("summoning of Terror") .. "].");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 10523, item2 = 19032, item3 = 14110, item4 = 14109}) and e.other:GetFaction(e.self) < 5) then --Eye of Urd, Basalt Drake Scales, Lens of Lord Soptyvr, Widowmistress Hair
		...
		eq.unique_spawn(75195,0,0,421,1182,-37,256.0); -- spawn avatar of terror
	end
