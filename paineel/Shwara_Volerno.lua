function event_say(e)
	...
	elseif(e.message:findi("clothing")) then
		e.self:Say("You will require this Curing Kit that has been specially prepared for the crafting of a suit and robe of Abattoir Initiate Clothing. The components necessary to craft the clothing vary according to the article that  you desire to fabricate. Once you have been outfitted in the proper attire return to me and you may assist with some [" .. eq.say_link("important research") .. "]. Do you desire to fabricate an [" .. eq.say_link("abattoir initiate cap") .. "], [" .. eq.say_link("abattoir initiate wristband") .. "], [" .. eq.say_link("abattoir initiate gloves") .. "]");
		e.self:Say("[" .. eq.say_link("abattoir initiate boots") .. "], [" .. eq.say_link("abattoir initiate sleeves") .. "], [" .. eq.say_link("abattoir initiate pantaloons") .. "], or [" .. eq.say_link("abattoir initiate robe") .. "]?");
