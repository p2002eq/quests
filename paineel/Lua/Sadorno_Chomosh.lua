function event_say(e)
	...
	if(e.message:findi("pending task")) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 20419})) then
		...
		e.other:SummonItem(20414);
	end
	if(item_lib.check_turn_in(e.trade, {item1 = 20415, item2 = 20355, item3 = 20402})) then
		e.self:Say("Very good work. Here is the Cudgel, use it well!");
		e.other:SummonItem(20417);
