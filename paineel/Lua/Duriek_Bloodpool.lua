...
function event_trade(e)
	...
	-- [FLAG: Manual conversion needed: $itemcount{] if($itemcount{18099} == 1 && e.other:GetFaction(e.self) >= 7) then {
	...
	-- [FLAG: Manual conversion needed: $itemcount{] if($itemcount{14365} == 1 && e.other:GetFaction(e.self) >= 14) then {
	...
	-- [FLAG: Manual conversion needed: $itemcount{] if($itemcount{14382} == 1 && e.other:GetFaction(e.self) >= 21) then {
	...
	-- [FLAG: Manual conversion needed: $itemcount{] if(($itemcount{5403} == 1) && ($itemcount{11609} == 1) && ($itemcount{5430} ==1 ) && ($itemcount{14366} == 1) && e.other:GetFaction(e.self) >= 35) then {
...
function event_say(e)
	e.other:GetFaction(e.self) = e.self:GetCharacterFactionLevel(342);
	if(e.message:findi("apprentice") and e.other:GetFaction(e.self) >= 14) then
	...
	if(e.message:findi("replace him") and e.other:GetFaction(e.self) >= 14) then
	...
	if(e.message:findi("searching") and e.other:GetFaction(e.self) >= 21) then
	...
	if(e.message:findi("items") and e.other:GetFaction(e.self) >= 28) then
