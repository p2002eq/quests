function event_say(e)
	...
	if(e.message:findi("make myself useful")) then
	...
	if(e.message:findi("the high council")) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 12270})) then --sealed letter
		...
		e.other:Ding();
		e.other:SummonItem(eq.ChooseRandom(3040,3042,3043,3044,3046,3047,3048,3049,3050,3051)); --random blackened iron
