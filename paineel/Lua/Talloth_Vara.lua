function event_say(e)
	...
	if(e.message:findi("what rivals")) then
	...
	if(e.message:findi("who is dartain")) then
	...
	if(e.message:findi("what real truth")) then
		e.self:Say("The real truth is actually a theory of mine which I believe to be true.  You see. the Seekers believe that necromancy is all that can be gained from the Dark Truth. whereas I believe it is merely a by-product."); end
	end
end
