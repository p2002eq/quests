function event_say(e)
	...
	if((e.message:findi("speak elsewhere")) and (e.self:GetX()==924) and (e.self:GetY()==958)) then
		e.self:Say("Follow me and we shall discuss how you may assist me with my [current research].");
		eq.start(16);
	end
	if((e.message:findi("current research")) and (e.self:GetX()==820) and (e.self:GetY()==930)) then
	...
	if((e.message:findi("samples")) and (e.self:GetX()==820) and (e.self:GetY()==930)) then
