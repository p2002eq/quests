...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Well met wanderer. Pay heed to the road you chose to travel on, for there are many [" .. eq.say_link("hazards") .. "] you may come across no matter which direction you chose.");
	elseif(e.message:findi("hazards")) then
		e.self:Say("The western road passes through a dangerous part of the thickets. A rivalry between the strange Tegi clans is afoot. Pay close attention, for the darker ones seem much more hostile than the ones that came before them. The Northern road passes through to the [" .. eq.say_link("Paludal") .. "] caverns. Once it was a rather safe trade route to the city of Shadow Haven. It has since fallen to regular brigand attacks.. We still get traders coming to sell their wares, but the journey is far more treacherous these days.");
