...
function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Greetings adventure seeker. I have come from afar to study this strange thicket. The spirits are strong within this region, but they are secretive as well.  I am willing to impart my wisdom to those who will aid me in my exploration. Are you [" .. eq.say_link("interested") .. "]");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 30601})) then -- A Needle Thin Claw
		e.self:Say("Excellent! You have done well.  I can sense that you are in tune with the spirits around you. Take this, for you will need it in your next task. When you are [" .. eq.say_link("ready") .. "] for your next lesson let me know.");
