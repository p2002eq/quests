...
function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Have you noticed the vicious Saurek [" .. eq.say_link("Shredders") .. "] out in the thicket? I wouldn't want to hunt one of those nasty things.");
	elseif(e.message:findi("shredders")) then
