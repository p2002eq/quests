...
function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Well met " .. e.other:GetName() .. ". Pay close attention to Captain Tarief's words of advice. It takes a skillful hunter to kill a Saurek [" .. eq.say_link("Darkclaw") .. "]. His advice could mean the difference between life and death.");
