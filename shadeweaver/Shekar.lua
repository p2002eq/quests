...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 7811, item2 = 30579})) then -- Claw Beast Talon & Wooden Practice Flail
		...
		e.other:QuestReward(e.self,0,0,0,0,7812); -- Claw Beast Talon Club
	end
