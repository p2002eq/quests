...
function event_say(e)
	...
	elseif(e.message:findi("key")) then
		e.self:Say("In the Plane of Hate, where dwell Innoruuk and his minions, there is a tome. This tome is called the [" .. eq.say_link("Book of Souls") .. "].");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 28053})) then
		e.self:Say("I say, this is indeed a challenge. This is written in what I'm sure is the language of the High Priesthood of Innoruuk. I've often wished I could read this, but I have never had the [" .. eq.say_link("key") .. "] to unlock the language. Take this for now.");
