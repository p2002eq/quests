...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 22815, gold = 10000} or {item1 = 22815, platinum = 1000})) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 22815, gold ~= 10000} or {item1 = 22815, platinum ~= 1000})) then
