...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 22815, gold = checkGold or platinum = checkPlatinum})) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 22815, not (gold = checkGold or platinum = checkPlatinum)})) then
