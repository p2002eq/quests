...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 25107})) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 25109, item2 = 25109, item3 = 25109, item4 = 25109  })) then
