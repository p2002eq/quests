function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hello, strange one. I am Bloogy Shellcracker, the preparer of meals for my people. I am not familiar with the culinary tastes of your kind but you are welcome to purchase some of my supplies. I will also barter for [" .. eq.say_link("ingredients") .. "] to some of my exotic dishes.");
