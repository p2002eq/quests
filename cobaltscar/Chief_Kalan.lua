...
function event_trade(e)
    ...
    if(e.other:GetFaction(e.self) < 7) then
    	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 24874, item2 = 24874,item3 = 24874,item4 = 24874})) then -- 4x Ulthork Tusks
			...
			e.other:QuestReward(e.self,0,0,0,0,eq.ChooseRandom(10036, 22503, 16976, 10037, 10033, 10049, 10031, 10053, 10035, 10051, 10034, 10050, 10032, 10048),1000); -- Random Gem
    	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 30068})) then -- Bulthar Trunk
    	...
    	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 30067, item2 = 30067})) then -- 2x Bulthar Trunk
    		e.self:Say("Such wasteful creatures the Bulthar are. It is a shame they are not intelligent enough to realize the harm they do to the very oceans that sustain them.");
    		e.other:Faction(241, 30); -- Othmir
    		e.other:Faction(345, -60); -- Ulthork
    		e.other:QuestReward(e.self,0,0,0,0,eq.ChooseRandom(10036, 22503, 16976, 10037, 10033, 10049, 10031, 10053, 10035, 10051, 10034, 10050, 10032, 10048),1000); -- Random Gem
