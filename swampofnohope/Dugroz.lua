...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Fffrroaaak!!  Go away!  I don't want to [" .. eq.say_link("work for them") .. "] anymore! Go find another slave!");
	elseif(e.message:findi("work")) then
		e.self:Emote("looks relieved and eyes you, considering. Finally, he begins to recant his tale. 'I was once the slave of an important Iksar necromancer. I was his Dugroz, his head slave. One night, I heard two other slaves talking about me. I could barely hear them but what I did hear frightened me. My master was going to use me one last time. He was going to sacrifice me to craft a spell component for one of his most powerful spells. Hearing this, I used my privileges as his head slave and made my [" .. eq.say_link("escape") .. "].'");
	elseif(e.message:findi("escape")) then
		e.self:Say("After I escaped, I lost myself in the depths of the swamp. I discarded all the keys but one. I will gladly give it to you if you can do me a [" .. eq.say_link("small favor") .. "].");
