...
function event_say(e)
    if(e.message:findi("hail")) then
        e.self:Emote("shakes his body and his countless necklaces cause a loud rattle to echo off the stone walls. 'Hello Frostpipes. Have you come to [worship] or have you just come for a visit to view our wonderful architecture and to [pay your respects].");
