...
function event_say(e)
    if(e.message:findi("hail")) then
        e.self:Say("Don't be bothered by that crazy gnome. He won't hurt you. He's just a little out of it today. I'm sure if he had some [" .. eq.say_link("mushrooms") .. "] it'd calm him down.");
