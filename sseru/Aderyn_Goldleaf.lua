...
local item_lib = require('items');
	if (item_lib.check_turn_in(e.self, e.trade, {item1 = 29892})) then
		e.self:Say("You actually did it? You have done an invaluable service ridding us of that wretched little halfing. You deserve to be a soldier in Seru's army. Take this Quiver with my regard, ".. e.other:GetName() .. ".");
		e.other:SummonItem(17120);
	end
