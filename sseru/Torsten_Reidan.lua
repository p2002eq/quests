...
function event_say(e)
	if e.message:findi("hail") then
		e.self:Say("Oh, hello there. Sorry I didn't notice you before I was thinking of an [" .. eq.say_link("old friend") .. "]. This used to be his room. I guess no one else has been assigned to these quarters.");
