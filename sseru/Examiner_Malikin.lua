...
function event_say(e)
    ...
    elseif(e.message:findi("begin")) then
        e.self:Say("Very well, " .. e.other:GetName() .. ". Please, take this coin to Questioner Ontu. She will advise you on your next course of action. There is a decided lack of direction in this matter, for a member of the Eye should always be able to find people. This will be good practice for you. Take care. I hope to speak to you again soon.");
