...
function event_say(e)
    ...
    elseif(e.message:findi("simple task")) then
        e.self:Say("Simple tasks go a great distance to establish trust. I may know of someone who can help you establish yourself within the ranks of the Eye. If you are interested in performing a task of that nature I can get you started at this time. Would you like to [" .. eq.say_link("begin") .. "]?");
    ...
    elseif(e.message:findi("meaning of the task")) then
        e.self:Say("Very good, for I have another task to offer you if you would like to continue. This one is a bit more complicated. I'm sure that you can handle it, but I need you to be sure as well. I need this to be a suprise. Do you think that you are [" .. eq.say_link("prepared") .. "] to handle an issue that will require both stealth and secrecy?");
    ...
    elseif(e.message:findi("attacks")) then
        e.self:Say("We have found evidence that there is a traitor within the ranks of one of the other Praesurtum. We need you to help us remove this traitor and his contact in Katta Castellum. You will need to take this poison and pour it into our [" .. eq.say_link("target") .. "]'s ear while he sleeps.");
