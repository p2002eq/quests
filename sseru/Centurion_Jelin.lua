...
function event_trade(e)
    ...
    if(item_lib.check_turn_in(e.self, e.trade, {item1 = 6269})) then -- Tattered Letter
        ...
        e.other:Faction(37,2); -- Citizens of Seru
        ...
        e.other:Faction(168,-4); -- Katta Castellum Citizens
