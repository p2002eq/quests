function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Greetings, $race. You are welcome in [Kejek] so long as you do not offend the [spirits] of these lands.");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 6975  })) then --Full Gathering Satchel
		...
		e.other:QuestReward(e.self,0,0,0,0,6976,10000);  -- Vial of Healing Liquid
