...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 5103})) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 10529})) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 10538,item2 = 10031,item3 = 7331,item4 = 18944})) then -- A Fungus Eye, Fire Opal, Shadowed Knife, a note(VurgoHarv)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 10536,item2 = 10537,item3 = 18945,gold = 300})) then -- Book of Darkness, Book of Frost, a note(VurgoWord)
