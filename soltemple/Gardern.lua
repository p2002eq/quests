...
function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("I am Gardern, listed among the chosen of Solusek Ro.  I hold the lore to the [" .. eq.say_link("Staff of Temperate Flux") .. "] and the [" .. eq.say_link("Weeping Wand") .. "] - items coveted by my Wizardly brethren.");
	elseif(e.message:findi("staff of temperate flux")) then
		e.self:Say("The Staff of Temperate Flux is a boon to those who dabble in the elemental arts, for it can increase the susceptibility of a creature to both fire and cold.  Are you [" .. eq.say_link("interested in the staff") .. "]?");
	...
	elseif(e.message:findi("weeping wand")) then
		e.self:Say("The Weeping Wand is a fine item for a Wizard - it can aid as a focus for concentration, and, if needed, be used to parry as well.  Are you [" .. eq.say_link("interested in the wand") .. "]?");
