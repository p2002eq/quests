...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("I am Joyce of the Temple of Solusek Ro. I am the guardian of four of the items of the elementalist. If you are a magician, ask me about the [" .. eq.say_link("Robe of the Elements") .. "], the [" .. eq.say_link("Clay Bracelet") .. "], the [" .. eq.say_link("Earthen Boots") .. "] or the [" .. eq.say_link("Circlet of Mist") .. "]");
	elseif(e.message:findi("mist")) then
		e.self:Say("The Circlet of Mist is a beautiful hoop that would look good atop your head. It produces a fine gleam, and is known to increase your mental power. Are you [" .. eq.say_link("interested in the circlet") .. "]?");
	...
	elseif(e.message:findi("clay")) then
		e.self:Say("The clay bracelet is a wonderful piece of jewelry to wear on your wrist. It provides fine protection, enhances your resistance to magic, and lets you call forth a mystic eye to help you in your travels. Are you [" .. eq.say_link("interested in the bracelet") .. "]?");
	...
	elseif(e.message:findi("earthen")) then
		e.self:Say("Earthen Boots are a fine adornment for the feet of any Magician. They have a wonderful brown color, and are known to enhance the stamina of any Magician who wears them. As an added bonus, animals do not tend to notice those who wear Earthen Boots. Are you [" .. eq.say_link("interested in the boots") .. "]?");
	...
	elseif(e.message:findi("elements")) then
		e.self:Say("The Robe of the Elements is a fine cloak for a Magician. It provides protection from the elements, protection from melee attacks and aids the Magician with her focus. Are you [" .. eq.say_link("interested in the robe") .. "]?");
