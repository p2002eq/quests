function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Ah, I see you have found my study.  This is where I study and scribe the [" .. eq.say_link("history") .. "] of magic in Norrath.");
