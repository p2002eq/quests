...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 16544,item2 = 16543,item3 = 16538,item4 = 10032})) then
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 16540, item2 = 16542, item3 = 10034, item4 = 16547})) then 
