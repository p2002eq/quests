...
function event_say(e)
	...
	elseif(e.message:findi("yes")) then --Part of Shaman Epic 1.0
		e.self:Say("Why have you taken this person's life, " .. e.other:GetName() .. "? Did he [" .. eq.say_link("threaten your life") .. "]? Did you dislike him? Or was his death a profit to you in some way?");
