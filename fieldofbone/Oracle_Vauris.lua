...
function event_say(e)
	...
	elseif(e.message:findi("What Rile?") then
	...
	elseif(e.message:findi("What emperor?") then
	...
	elseif(e.message:findi("What others?") then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 30989}) then
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 30991, item2 = 30990, item3 = 30993, item4 = 30992}) then
