...
function event_say(e)
	...
	elseif(e.message:findi("emperor")) then
		e.self:Say("At last you see Cradossk. The one you speak of is indeed a servant of Rile's father. His presence on this world has disrupted the spirits of the ancients. This disruption must be put to an end. Slaying him will do little good unfortunately. We will have to make use of other powers to truly banish him from this world. If we are to do this we shall need a true relic of Rile, and the soul of his father. Only with these items can we hope to free Rile's soul from the void between death and life. But first there are [" .. eq.say_link("others") .. "] that serve the risen emperor that must be destroyed.");
