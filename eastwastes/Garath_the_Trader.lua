function event_say(e)
    ...
    if(e.message:findi("hail")) then
            e.self:Say("Hail to ya, Traveller, and well met! My Name's Garath, a warrior by trade, though I do dabble in some merchanting on the side. My exploring brought me here, and I saw some wonderous things. I ventured inside this ancient tomb with some friends, and oh! The horrors we encountered! I barely made it out alive, but I did manage to pick up some [" .. eq.say_link("weapons to trade") .. "].");
        elseif(e.message:findi("weapons")) then
            e.self:Say("Interested in a trade, are ya? Well, let me tell ya.. I headed into this tomb in hopes of getting a sword I could use, maybe a warhammer.. Humm, yeah a hammer woulda been good also.. Anyhow, I was unlucky in finding those, but I did manage to get a couple weapons... Sadly, they're really more suited to a [" .. eq.say_link("Monk") .. "] or a [" .. eq.say_link("Knight") .. "], not really much use to a warrior like myself at all.");
