...
function event_waypoint_depart(e)
	if (corbin == 10) then
	    ...
	    eq.spawn2(116569, 0, 0, -2067, 189, 146, 57):AddToHateList(e.self,1);
	    eq.spawn2(116569, 0, 0, -2067, 199, 146, 57):AddToHateList(e.self,1);
	    eq.spawn2(116569, 0, 0, -2077, 199, 146, 57):AddToHateList(e.self,1);
	    eq.spawn2(116569, 0, 0, -2077, 189, 146, 57):AddToHateList(e.self,1);
