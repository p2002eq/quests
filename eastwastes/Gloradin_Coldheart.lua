...
function event_timer(e)
    ...
    --   royal wolven guard  
        ...
        eq.spawn2(116563,240,0,808.4,-2485.8,169.6,40); -- 3
        eq.spawn2(116563,241,0,817,-2480.1,170.1,40); -- 4
        eq.spawn2(116563,242,0,779.6,-2480.4,168,40); -- 5
        eq.spawn2(116563,243,0,788,-2474.8,168.5,40); -- 6
        eq.spawn2(116563,244,0,796.7,-2469,169,40); -- 7
        eq.spawn2(116563,245,0,805.6,-2463,169.4,40); -- 8
        
    --   priest of brell  
        eq.spawn2(116541,246,0,796.2,-2506.7,168.9,40);
        eq.spawn2(116541,247,0,805.1,-2500.8,169.4,40);
        eq.spawn2(116541,248,0,814,-2494.9,169.9,40);
        eq.spawn2(116541,249,0,822.9,-2489,170.4,40);
        eq.spawn2(116541,250,0,773.4,-2471.7,167.7,40);
        eq.spawn2(116541,251,0,782.2,-2465.9,168.2,40);
        eq.spawn2(116541,252,0,791.2,-2459.8,168.6,40);
        eq.spawn2(116541,253,0,799.7,-2454.2,169.1,40);
        
    -- royal archer
        eq.spawn2(116555,254,0,801.8,-2515.1,169.2,40);
        eq.spawn2(116555,255,0,810.8,-2509.1,169.7,40);
        eq.spawn2(116555,256,0,819.6,-2503.3,170.2,40);
        eq.spawn2(116555,257,0,828.5,-2497.3,170.7,40);
        eq.spawn2(116555,258,0,767.5,-2462.8,167.4,40);
        eq.spawn2(116555,259,0,775.9,-2457.2,167.8,40);
        eq.spawn2(116555,260,0,784.9,-2451.2,168.3,40);
        eq.spawn2(116555,261,0,793.7,-2445.3,169.2,40);
    
    -- paladin of brell
        eq.spawn2(116549,262,0,808.4,-2523.6,169.6,40);
        eq.spawn2(116549,263,0,817.1,-2517.8,170.1,40);
        eq.spawn2(116549,264,0,825.8,-2512,170.5,40);
        eq.spawn2(116549,265,0,834.4,-2506.3,171.0,40);
        eq.spawn2(116549,266,0,761.7,-2453.8,167,40);
        eq.spawn2(116549,267,0,770.6,-2447.8,167.7,40);
        eq.spawn2(116549,268,0,779.4,-2442,168.8,40);
        eq.spawn2(116549,269,0,787.8,-2436.4,169.8,40);
