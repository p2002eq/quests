...
function event_say(e)
    ...
    elseif e.message:findi("help") and not started then
		...
		eq.spawn2(116604, 0, 0, -2991, -4837, 229,130.0, 1);
		eq.spawn2(116532, 0, 0, -2991, -4815, 229,130.0, 1);
		eq.spawn2(116532, 0, 0, -2991, -4793, 229,130.0, 1);
		eq.spawn2(116532, 0, 0, -2991, -4859, 229,130.0, 1);
		eq.spawn2(116532, 0, 0, -2991, -4881, 229,130.0, 1);
