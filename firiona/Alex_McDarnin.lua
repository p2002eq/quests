function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Hail! Do you by chance bring news from the North? I sure do miss the cold. It is just a bit too warm for me down here. Well, I wish you the best of luck in your travels. Tomorrow is a new day and I am off in search of [" .. eq.say_link("new writings") .. "] to take back to the Tribunal.");
	elseif(e.message:findi("new writings")) then
		e.self:Say("There have been tales of new writings being found in some of the ancient ruins that abound outside of this outpost. These writings will be very valuable to my church. The sooner I can return with the writings, the sooner the Tribunal can put the teachings to work. I am always in need of aides so if [" .. eq.say_link("I want to help",false,"you want to help") .. "], just say so.");
