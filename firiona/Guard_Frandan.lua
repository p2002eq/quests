function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Glad to see you made it to the outpost in one piece!  Now you can test your mettle against the giants of Kunark.  They sometimes carry [" .. eq.say_link("odd items") .. "] which can fetch a coin or two on the market.");
