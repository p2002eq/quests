function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Bah!! It's not been a good day! Reports from the Outlands are even worse than I was led to believe. Many would-be adventurers have turned up missing of late. One of them was one of my messenger. He was out collecting some of the various new and [" .. eq.say_link("interesting scrolls") .. "] that have been surfacing in the farthest reaches of this land. I fear for his safety and that of the others searching for the lost travelers. I wish there was more I could do.");
	elseif(e.message:findi("interesting scrolls")) then
		e.self:Emote("reaches into his pouch. 'Well, let's see what I have in here. Ah, yes. The scrolls are definitely worth finding. Possibly even dangerous if they should fall into the wrong hands. But that is why the Collective sent me here. To procure all of the scrolls so that they may be studied at the Library of Mechanimagica. Bah!! But my messenger is missing! I can't fail them. Would you be willing to [" .. eq.say_link("help locate") .. "] some of the scrolls I am missing?");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 19351}) or item_lib.check_turn_in(e.self, e.trade, {item1 = 19347}) or item_lib.check_turn_in(e.self, e.trade, {item1 = 19354}) or item_lib.check_turn_in(e.self, e.trade, {item1 = 19358})) then
