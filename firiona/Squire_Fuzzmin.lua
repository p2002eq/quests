...
function event_say(e)
	if(e.message:findi("hail")) then
		...
		e.self:Say("Yawn.. Oh!! Hello. Don't mind the rusty old tin can. Sir Hobble is on a [" .. eq.say_link("quest") .. "] of sorts. I tell you, I would leave if he did not pay good wages to carry his equipment.");
	elseif(e.message:findi("quest")) then
		e.self:Say("Sir Hobble is searching for [" .. eq.say_link("three special dragons") .. "]. For all I know they are not even dragons. He can't see or hear very well. He still thinks I am the only troll squire around.");
	elseif(e.message:findi("three special dragons")) then
		e.self:Say("Apparently he is after three dragons which are supposedly named Azdalin, Gylton, and Xyfl. He will not rest until he holds their scales. I wish you could [" .. eq.say_link("find the dragons") .. "].");
