function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings friend, it is good to be freed from the clutches of those evil creatures. Tell me are you willing to help me bring some [" .. eq.say_link("justice") .. "] to them?");
