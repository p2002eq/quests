function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Emote("has large scars on the right side of his face.  He is missing one eye and wears no patch.  'Another adventurer?  If you think you will find fame and fortune in this land, you are sadly mistaken.  Only death awaits you out there in the wilds of Kunark.  Just when you think you are raiding a [" .. eq.say_link("tomb") .. "], you will find it becomes your own final resting place.'");
	elseif(e.message:findi("tomb")) then
		e.self:Say("Do not contemplate raiding tombs.  I was once sent with a unit to find a relative of a human noble lost in Kunark.  With the help of the Fier'Dal trackers, we found them in a hidden tomb.  It was filled with great evil and [" .. eq.say_link("great deceit") .. "].");
