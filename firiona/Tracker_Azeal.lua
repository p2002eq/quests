...
function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Emote("test1234test looks over at you and gives you an awkward smile, then quickly looks away. You notice he isn't like most of the elves you've seen. You can't quite put your finger on it, but for one thing he smells like he hasn't bathed in weeks.");
	end
end
