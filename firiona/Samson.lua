function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Emote("begins to stroke the nearby brew barrel.  'What will it be?   Me and Old Gertie here make the finest brew this side of the Timorous Deep.  Afraid I am the only one who is allowed to touch her - she's very special to me.  If you want to brew yourself, you can start looking for that [" .. eq.say_link("jungle city") .. "].'");
		e.self:DoAnim(59);
