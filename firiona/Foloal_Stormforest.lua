...
function event_say(e)
	if(e.message:findi("are you one such as myself")) then
		e.self:Emote("stares at you and whispers. 'You must be the one that has been spoken of. Yes, yes I am one of the circle. There are many of us in the lands right now, all seeking [" .. eq.say_link("answers") .. "] to the ills that have befallen our homes.'");
	elseif(e.message:findi("answers")) then
		e.self:Say("I have heard whispers of new Iksar movements in the land. The name of [" .. eq.say_link("Venril Sathir") .. "] is on the scaled lips and sharp tongues of every cold blooded lizard in this place.");
